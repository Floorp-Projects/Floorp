...
// Widen and append length characters starting at chars to the end of str.
    void
    appendChars(String &str, const char *chars, size_t length)
    {
...
// Widen and insert length characters starting at chars into the given position
// of str.
    void
    insertChars(String &str, String::size_type pos, const char *chars,
                size_t length)
    {
...
// Widen and insert the null-terminated string cstr into the given position of
// str.
    void
    insertChars(String &str, String::size_type pos, const char *cstr)
    {
...
// return c unchanged.
    ...
    toUpper(char16 c)
    {
        ...
        if (ci.info & 0x00100000)
            c = static_cast<char16>(static_cast<int32>(c) -
                                    (static_cast<int32>(ci.info) >> 22));
        return c;
    }
...
// digit's numeric value in d.
    bool
    isASCIIHexDigit(char16 c, uint &digit)
    {
        uint cv = c;
...
// Return str advanced past white space characters, but no further than strEnd.
    const char16 *
    skipWhiteSpace(const char16 *str, const char16 *strEnd)
    {
...
// DO NOT CALL DELETE ON THE RESULT!
    ...
    String &
    newArenaString(Arena &arena, const String &str)
    {
