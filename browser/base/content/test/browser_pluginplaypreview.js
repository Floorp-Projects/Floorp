...
function test() {
  ...
  prepareTest(test1a, gTestRoot + "plugin_test.html");
}
...
function pageLoad() {
  ...
  // XXX overlay iframe might trigger load event as well, making sure we call the next test once
  if (!gNextTest)
    return;
...
function test3() {
  ...
  prepareTest(test4a, gTestRoot + "plugin_test.html");
}
...
function test4b() {
  ...
  prepareTest(test5a, gTestRoot + "plugin_test.html");
}
