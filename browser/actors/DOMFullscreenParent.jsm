...
class DOMFullscreenParent extends JSWindowActorParent {
  ...
  // Cache the next message recipient actor that is computed by
  // _getNextMsgRecipientActor() of browser-fullScreenAndPointerLock.js, this is
  // used to ensure the fullscreen cleanup messages goes the same route as
  // fullscreen request, especially for the cleanup that happens when actor is
  // destroyed.
  // TODO: Bug 1743703 - Consider moving the messaging component of
  //       browser-fullScreenAndPointerLock.js into the actor
