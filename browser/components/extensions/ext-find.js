  ...
  getAPI(context) {
    ...
    return {
      find: {
         ...
         *
         * @returns {Promise} a promise that will be resolved when search is completed, that includes:
        ...
        find(queryphrase, params) {
          ...
          return this.runFindOperation(params, "CollectResults");
        },
         ...
         *
         * @returns {Promise} a promise that will be resolved when highlighting is completed.
         */
        highlightResults(params) {
          params = params || {};
          return this.runFindOperation(params, "HighlightResults");
        },
