...
add_task(function* () {
  ...
  for (let resolution of [2, 1]) {
    ...
    is(dims.width, gBrowser.selectedBrowser.clientWidth, "tab reports expected width");
    is(dims.height, gBrowser.selectedBrowser.clientHeight, "tab reports expected height");
  }
