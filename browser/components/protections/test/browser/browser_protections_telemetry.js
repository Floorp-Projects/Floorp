...
add_task(async function checkTelemetryClickEventsVPN() {
  ...
  await SpecialPowers.spawn(tab.linkedBrowser, [], async function() {
    ...
    await EventUtils.synthesizeMouseAtCenter(getVPNLink, {}, content);
  });
  ...
  await SpecialPowers.spawn(tab.linkedBrowser, [], async function() {
    ...
    await EventUtils.synthesizeMouseAtCenter(androidVPNLink, {}, content);
  });
  ...
  await SpecialPowers.spawn(tab.linkedBrowser, [], async function() {
    ...
    await EventUtils.synthesizeMouseAtCenter(iosVPNLink, {}, content);
  });
...
add_task(async function checkTelemetryEventsVPNBanner() {
  ...
  await SpecialPowers.spawn(tab.linkedBrowser, [], async function() {
    ...
    await EventUtils.synthesizeMouseAtCenter(bannerVPNLink, {}, content);
  });
  ...
  await SpecialPowers.spawn(tab.linkedBrowser, [], async function() {
    ...
    await EventUtils.synthesizeMouseAtCenter(bannerExitLink, {}, content);
  });
