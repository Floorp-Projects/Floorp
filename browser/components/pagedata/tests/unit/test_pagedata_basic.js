...
XPCOMUtils.defineLazyModuleGetters(this, {
  ...
  PageDataService: "resource:///modules/PageDataService.jsm",
});

add_task(async function notifies() {
  let url = Services.io.newURI("https://www.mozilla.org/");
  ...
  Assert.equal(pageData.url.spec, "https://www.mozilla.org/");
