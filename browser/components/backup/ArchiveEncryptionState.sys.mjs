...
export class ArchiveEncryptionState {
   ...
   *
   * @see ArchiveEncryptionState.enable()
   * @type {number}
   */
  ...
  /**
   * @see ArchiveEncryptionState.#isInternalConstructing
   */
  constructor() {
   ...
   *
   * @see ArchiveEncryptionState.deserialize()
   ...
   *
   * @see ArchiveEncryptionState.serialize()
