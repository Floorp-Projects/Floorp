...
class TestSessionRestoreClosedTabs(SessionStoreTestCase):
    ...
    def test_restore(self):
        ...
        self.marionette.execute_script(
            """
            Services.prefs.setBoolPref("browser.sessionstore.persist_closed_tabs_between_sessions", false);
            """
        )
