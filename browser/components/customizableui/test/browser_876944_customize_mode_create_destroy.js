...
add_task(function testPanelPlaceholders() {
  ...
  is(panel.querySelectorAll(".panel-customization-placeholder").length,
     (isInWin8() ? 1 : 2) + (isInDevEdition() ? 1 : 0),
     "The number of placeholders should be correct.");
  ...
  is(panel.querySelectorAll(".panel-customization-placeholder").length,
     (isInWin8() ? 3 : 1) + (isInDevEdition() ? 1 : 0),
     "The number of placeholders should be correct.");
