    ...
    extends nsIDocShellTreeItem,
      Enums<
        typeof nsIDocShell.DocShellEnumeratorDirection &
          ...
          typeof nsIDocShell.MetaViewportOverride
      > {
...
declare global {
  ...
  interface nsILoginAutoCompleteSearch extends nsISupports {
    startSearch(
      ...
      aListener: nsIFormAutoCompleteObserver,
    ): void;
    stopSearch(): void;
  }
...
declare global {
  interface nsIContentAnalysisResponse
    extends nsISupports,
      Enums<typeof nsIContentAnalysisResponse.Action> {
...
declare global {
  ...
  type DOMRequest = {};
  type FrameLoader = {};
  type JSProcessActorChild = {};
  type JSProcessActorParent = {};
  type TreeColumn = {};
  type WebExtensionContentScript = {};
  type WebExtensionPolicy = {};
  type WindowGlobalParent = {};
  type WindowContext = {};
  type XULTreeElement = {};
}
