...
#ifndef nsCapiLocal_h___
#define nsCapiLocal_h___
...
typedef struct {
  ...
  LogonCurl               logon_curl;
} capi_local_funcs ;

class nsCapiLocal : public nsICapi,
                    public nsICapiLocal
{
public:
  nsCapiLocal(nsISupports* outer);
...
private:
  PRLibrary * mLibrary;
  capi_local_funcs  mFunctions;
};

#endif /* nsCapiLocal_h___ */
