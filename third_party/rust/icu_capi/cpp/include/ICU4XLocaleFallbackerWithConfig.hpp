 ...
 * 
 * See the [Rust documentation for `LocaleFallbackerWithConfig`](https://docs.rs/icu_provider_adapters/latest/icu_provider_adapters/fallback/struct.LocaleFallbackerWithConfig.html) for more information.
 */
class ICU4XLocaleFallbackerWithConfig {
 public:
   ...
   * 
   * See the [Rust documentation for `fallback_for`](https://docs.rs/icu_provider_adapters/latest/icu_provider_adapters/fallback/struct.LocaleFallbackerWithConfig.html#method.fallback_for) for more information.
   * 
