  ...
  return (
    <GridItem display="flex" justifyContent="center">
      <VStack align="stretch" alignItems="center" maxW={"900px"} spacing={6}>
        ...
        <Text>
          Noraneko
          を便利に、安全にご利用いただけるよう、アカウント、プライバシー、セキュリティを管理できます。
        </Text>
        ...
        >
          ...
          >
            <Text fontSize="sm" mb={2}>
              Noraneko
              を最大限にご利用いただくために、セットアップを完了しましょう。
            </Text>
          ...
          >
            <Text fontSize="sm">
              Noraneko
              は既定の状態であなたのデータとプライバシーを適切に保護するよう動作しますが、手動で管理することもできます。
            </Text>
          ...
          >
            <Text fontSize="sm">Ablaze アカウントの設定を行います。</Text>
            <Link
              color="blue.500"
              fontSize="sm"
              mt={2}
              href="https://security.google.com/settings/security/checkup"
            >
              セキュリティ診断
            </Link>
          </Card>
          ...
          >
            <Text fontSize="sm">
              Noraneko
              のコントリビューターによって書かれたサポートをご利用いただけます
            </Text>
            <Link color="blue.500" fontSize="sm" mt={2}>
              Noraneko のサポート記事を閲覧
            </Link>
