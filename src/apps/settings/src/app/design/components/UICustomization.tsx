      ...
      {showRestartModal
        ? (
          <RestartModal
            ...
            label={t(
              "design.uiCustomization.needRestartDescriptionForEnableAndDisable",
            )}
          />
        )
        : null}
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setValue("navbarPosition", e.target.value);
                      }}
                    />
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-2">
                <label htmlFor="disable-fullscreen-notification">
                  {t(
                    "design.uiCustomization.display.disableFullscreenNotification",
                  )}
                </label>
                <Switch
                  ...
                  onChange={(e) =>
                    setValue("disableFullscreenNotification", e.target.checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onChange={(e) =>
                    setValue("deleteBrowserBorder", e.target.checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  checked={!!getValues("disableQRCodeButton")}
                  onChange={(e) =>
                    setValue("disableQRCodeButton", e.target.checked)}
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onChange={(e) =>
                    setValue("optimizeForTreeStyleTab", e.target.checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                <label htmlFor="hide-forward-backward-button">
                  {t(
                    "design.uiCustomization.special.hideForwardBackwardButton",
                  )}
                </label>
                <Switch
                  ...
                  onChange={(e) =>
                    setValue("hideForwardBackwardButton", e.target.checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  onChange={(e) =>
                    setValue("stgLikeWorkspaces", e.target.checked)}
                />
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  <label htmlFor="multirow-tab-newtab-inside">
                    {t(
                      "design.uiCustomization.multirowTab.newtabInsideEnabled",
                    )}
                  </label>
                  <Switch
                    ...
                    onChange={(e) =>
                      setValue("multirowTabNewtabInside", e.target.checked)}
                  />
                </div>
              </div>
            </div>
