 ...
 * Account_Server.java
 *
 * Created on 09 August 2005, 22:33
 *
 * ***** BEGIN LICENSE BLOCK *****
 ...
 * @author hash9
 */
public abstract class Account__Server extends AbstractAccount {
    
    /**
     * Creates a new instance of AbstractAccount
     */
    public Account__Server() {
        super();
    }
     ...
     * Creates a new instance of AbstractAccount
     */
    public Account__Server(String name) {
        super(name);
    }
    ...
    public int getPort() {
        return this.getPropertyInt("port");
    }
    
    public String getUsername() {
        return this.getPropertyString("username");
    }
