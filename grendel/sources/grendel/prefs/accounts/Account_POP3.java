 ...
 * @author hash9
 */
public class Account_POP3 extends Account__Server implements Account__Receive {
    /**
     * Creates a new instance of Account_POP3
     */
    public Account_POP3() {
        super();
    }
     ...
     * Creates a new instance of Account_POP3
     */
    public Account_POP3(String name) {
        super(name);
    }
    
    public boolean leaveMailOnServer() {
        return getPropertyBoolean("leave_mail_on_server");
    }
    
    public boolean showAsIMAP() {
        return getPropertyBoolean("show_as_imap");
    }
    
    public void setLeaveMailOnServer(boolean b) {
        setProperty("leave_mail_on_server",b);
    }
    
    public void setShowAsIMAP(boolean b) {
        setProperty("show_as_imap",b);
    }
