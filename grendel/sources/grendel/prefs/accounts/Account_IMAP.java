 ...
 * @author hash9
 */
public class Account_IMAP extends Account__Server implements Account__Receive {
    
    /** Creates a new instance of Account_IMAP */
    public Account_IMAP() {
        super();
    }
    
    /** Creates a new instance of Account_IMAP */
    public Account_IMAP(String name) {
        super(name);
    }
    ...
    public void setSendAccount(Account__Send a) {
        if (a instanceof AbstractAccount) {
            ...
            throw new IllegalArgumentException("Account__Send object "+a.getClass().toString()+" is not an instance of "+AbstractAccount.class.toString());
        }
    }
