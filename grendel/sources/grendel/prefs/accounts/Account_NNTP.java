 ...
 * @author hash9
 */
public class Account_NNTP extends Account__Server implements Account__Receive, Account__Send {
  /**
   ...
   * Creates a new instance of Account_NNTP
   */
  public Account_NNTP(String name) {
    super(name);
  }
  ...
  /**
   * For NNTP this means the place to send <strong>non-nntp</strong> messages.
   */
