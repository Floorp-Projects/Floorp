...
NAMED_CHARACTER_REFERENCE(1108,
                          /* g e */ 's' _ 'd' _ 'o' _ 't' _ 'o' _ ';',
                          6,
                          0,
                          0x2a82 _ 0)
NAMED_CHARACTER_REFERENCE(1109,
                          /* g e */ 's' _ 'd' _ 'o' _ 't' _ 'o' _ 'l' _ ';',
                          7,
                          0,
                          0x2a84 _ 0)
...
NAMED_CHARACTER_REFERENCE(1140,
                          /* g t */ 'q' _ 'u' _ 'e' _ 's' _ 't' _ ';',
                          6,
                          0,
                          0x2a7c _ 0)
NAMED_CHARACTER_REFERENCE(
  1141,
  /* g t */ 'r' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  8,
  0,
  0x2a86 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1144,
  /* g t */ 'r' _ 'e' _ 'q' _ 'l' _ 'e' _ 's' _ 's' _ ';',
  8,
  0,
  0x22db _ 0)
NAMED_CHARACTER_REFERENCE(
  1145,
  /* g t */ 'r' _ 'e' _ 'q' _ 'q' _ 'l' _ 'e' _ 's' _ 's' _ ';',
  9,
  0,
  0x2a8c _ 0)
NAMED_CHARACTER_REFERENCE(1146,
                          /* g t */ 'r' _ 'l' _ 'e' _ 's' _ 's' _ ';',
                          6,
                          0,
                          0x2277 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1148,
  /* g v */ 'e' _ 'r' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
  8,
  0,
  0x2269 _ 0xfe00)
...
NAMED_CHARACTER_REFERENCE(
  1161,
  /* h e */ 'a' _ 'r' _ 't' _ 's' _ 'u' _ 'i' _ 't' _ ';',
  8,
  0,
  0x2665 _ 0)
...
NAMED_CHARACTER_REFERENCE(1165,
                          /* h k */ 's' _ 'e' _ 'a' _ 'r' _ 'o' _ 'w' _ ';',
                          7,
                          0,
                          0x2925 _ 0)
NAMED_CHARACTER_REFERENCE(1166,
                          /* h k */ 's' _ 'w' _ 'a' _ 'r' _ 'o' _ 'w' _ ';',
                          7,
                          0,
                          0x2926 _ 0)
...
NAMED_CHARACTER_REFERENCE(1199,
                          /* i m */ 'a' _ 'g' _ 'l' _ 'i' _ 'n' _ 'e' _ ';',
                          7,
                          0,
                          0x2110 _ 0)
NAMED_CHARACTER_REFERENCE(1200,
                          /* i m */ 'a' _ 'g' _ 'p' _ 'a' _ 'r' _ 't' _ ';',
                          7,
                          0,
                          0x2111 _ 0)
...
NAMED_CHARACTER_REFERENCE(1211,
                          /* i n */ 't' _ 'e' _ 'g' _ 'e' _ 'r' _ 's' _ ';',
                          7,
                          0,
                          0x2124 _ 0)
NAMED_CHARACTER_REFERENCE(1212,
                          /* i n */ 't' _ 'e' _ 'r' _ 'c' _ 'a' _ 'l' _ ';',
                          7,
                          0,
                          0x22ba _ 0)
NAMED_CHARACTER_REFERENCE(1213,
                          /* i n */ 't' _ 'l' _ 'a' _ 'r' _ 'h' _ 'k' _ ';',
                          7,
                          0,
                          0x2a17 _ 0)
NAMED_CHARACTER_REFERENCE(1214,
                          /* i n */ 't' _ 'p' _ 'r' _ 'o' _ 'd' _ ';',
                          6,
                          0,
                          0x2a3c _ 0)
...
NAMED_CHARACTER_REFERENCE(1287,
                          /* l b */ 'r' _ 'k' _ 's' _ 'l' _ 'd' _ ';',
                          6,
                          0,
                          0x298f _ 0)
NAMED_CHARACTER_REFERENCE(1288,
                          /* l b */ 'r' _ 'k' _ 's' _ 'l' _ 'u' _ ';',
                          6,
                          0,
                          0x298d _ 0)
...
NAMED_CHARACTER_REFERENCE(1297,
                          /* l d */ 'r' _ 'd' _ 'h' _ 'a' _ 'r' _ ';',
                          6,
                          0,
                          0x2967 _ 0)
NAMED_CHARACTER_REFERENCE(1298,
                          /* l d */ 'r' _ 'u' _ 's' _ 'h' _ 'a' _ 'r' _ ';',
                          7,
                          0,
                          0x294b _ 0)
...
NAMED_CHARACTER_REFERENCE(1318,
                          /* l e */ 's' _ 'd' _ 'o' _ 't' _ 'o' _ ';',
                          6,
                          0,
                          0x2a81 _ 0)
NAMED_CHARACTER_REFERENCE(1319,
                          /* l e */ 's' _ 'd' _ 'o' _ 't' _ 'o' _ 'r' _ ';',
                          7,
                          0,
                          0x2a83 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1322,
  /* l e */ 's' _ 's' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  9,
  0,
  0x2a85 _ 0)
NAMED_CHARACTER_REFERENCE(1323,
                          /* l e */ 's' _ 's' _ 'd' _ 'o' _ 't' _ ';',
                          6,
                          0,
                          0x22d6 _ 0)
NAMED_CHARACTER_REFERENCE(
  1324,
  /* l e */ 's' _ 's' _ 'e' _ 'q' _ 'g' _ 't' _ 'r' _ ';',
  8,
  0,
  0x22da _ 0)
NAMED_CHARACTER_REFERENCE(
  1325,
  /* l e */ 's' _ 's' _ 'e' _ 'q' _ 'q' _ 'g' _ 't' _ 'r' _ ';',
  9,
  0,
  0x2a8b _ 0)
NAMED_CHARACTER_REFERENCE(1326,
                          /* l e */ 's' _ 's' _ 'g' _ 't' _ 'r' _ ';',
                          6,
                          0,
                          0x2276 _ 0)
NAMED_CHARACTER_REFERENCE(1327,
                          /* l e */ 's' _ 's' _ 's' _ 'i' _ 'm' _ ';',
                          6,
                          0,
                          0x2272 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1345,
  /* l m */ 'o' _ 'u' _ 's' _ 't' _ 'a' _ 'c' _ 'h' _ 'e' _ ';',
  9,
  0,
  0x23b0 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1358,
  /* l o */ 'n' _ 'g' _ 'm' _ 'a' _ 'p' _ 's' _ 't' _ 'o' _ ';',
  9,
  0,
  0x27fc _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(1402,
                          /* l u */ 'r' _ 'd' _ 's' _ 'h' _ 'a' _ 'r' _ ';',
                          7,
                          0,
                          0x294a _ 0)
NAMED_CHARACTER_REFERENCE(1403,
                          /* l u */ 'r' _ 'u' _ 'h' _ 'a' _ 'r' _ ';',
                          6,
                          0,
                          0x2966 _ 0)
NAMED_CHARACTER_REFERENCE(
  1404,
  /* l v */ 'e' _ 'r' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
  8,
  0,
  0x2268 _ 0xfe00)
...
NAMED_CHARACTER_REFERENCE(
  1414,
  /* m a */ 'p' _ 's' _ 't' _ 'o' _ 'd' _ 'o' _ 'w' _ 'n' _ ';',
  9,
  0,
  0x21a7 _ 0)
NAMED_CHARACTER_REFERENCE(
  1415,
  /* m a */ 'p' _ 's' _ 't' _ 'o' _ 'l' _ 'e' _ 'f' _ 't' _ ';',
  9,
  0,
  0x21a4 _ 0)
NAMED_CHARACTER_REFERENCE(1416,
                          /* m a */ 'p' _ 's' _ 't' _ 'o' _ 'u' _ 'p' _ ';',
                          7,
                          0,
                          0x21a5 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1449,
  /* n L */ 'e' _ 'f' _ 't' _ 'a' _ 'r' _ 'r' _ 'o' _ 'w' _ ';',
  9,
  0,
  0x21cd _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(
  1454,
  /* n R */ 'i' _ 'g' _ 'h' _ 't' _ 'a' _ 'r' _ 'r' _ 'o' _ 'w' _ ';',
  10,
  0,
  0x21cf _ 0)
...
NAMED_CHARACTER_REFERENCE(1466,
                          /* n a */ 't' _ 'u' _ 'r' _ 'a' _ 'l' _ ';',
                          6,
                          0,
                          0x266e _ 0)
NAMED_CHARACTER_REFERENCE(1467,
                          /* n a */ 't' _ 'u' _ 'r' _ 'a' _ 'l' _ 's' _ ';',
                          7,
                          0,
                          0x2115 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1496,
  /* n g */ 'e' _ 'q' _ 's' _ 'l' _ 'a' _ 'n' _ 't' _ ';',
  8,
  0,
  0x2a7e _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(
  1518,
  /* n l */ 'e' _ 'q' _ 's' _ 'l' _ 'a' _ 'n' _ 't' _ ';',
  8,
  0,
  0x2a7d _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(1531,
                          /* n o */ 't' _ 'i' _ 'n' _ 'd' _ 'o' _ 't' _ ';',
                          7,
                          0,
                          0x22f5 _ 0x0338)
NAMED_CHARACTER_REFERENCE(1532,
                          /* n o */ 't' _ 'i' _ 'n' _ 'v' _ 'a' _ ';',
                          6,
                          0,
                          0x2209 _ 0)
NAMED_CHARACTER_REFERENCE(1533,
                          /* n o */ 't' _ 'i' _ 'n' _ 'v' _ 'b' _ ';',
                          6,
                          0,
                          0x22f7 _ 0)
NAMED_CHARACTER_REFERENCE(1534,
                          /* n o */ 't' _ 'i' _ 'n' _ 'v' _ 'c' _ ';',
                          6,
                          0,
                          0x22f6 _ 0)
...
NAMED_CHARACTER_REFERENCE(1536,
                          /* n o */ 't' _ 'n' _ 'i' _ 'v' _ 'a' _ ';',
                          6,
                          0,
                          0x220c _ 0)
NAMED_CHARACTER_REFERENCE(1537,
                          /* n o */ 't' _ 'n' _ 'i' _ 'v' _ 'b' _ ';',
                          6,
                          0,
                          0x22fe _ 0)
NAMED_CHARACTER_REFERENCE(1538,
                          /* n o */ 't' _ 'n' _ 'i' _ 'v' _ 'c' _ ';',
                          6,
                          0,
                          0x22fd _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1540,
  /* n p */ 'a' _ 'r' _ 'a' _ 'l' _ 'l' _ 'e' _ 'l' _ ';',
  8,
  0,
  0x2226 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1560,
  /* n s */ 'h' _ 'o' _ 'r' _ 't' _ 'm' _ 'i' _ 'd' _ ';',
  8,
  0,
  0x2224 _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(1567,
                          /* n s */ 'q' _ 's' _ 'u' _ 'b' _ 'e' _ ';',
                          6,
                          0,
                          0x22e2 _ 0)
NAMED_CHARACTER_REFERENCE(1568,
                          /* n s */ 'q' _ 's' _ 'u' _ 'p' _ 'e' _ ';',
                          6,
                          0,
                          0x22e3 _ 0)
...
NAMED_CHARACTER_REFERENCE(1572,
                          /* n s */ 'u' _ 'b' _ 's' _ 'e' _ 't' _ ';',
                          6,
                          0,
                          0x2282 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
  1573,
  /* n s */ 'u' _ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
  8,
  0,
  0x2288 _ 0)
NAMED_CHARACTER_REFERENCE(
  1574,
  /* n s */ 'u' _ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';',
  9,
  0,
  0x2ac5 _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(1580,
                          /* n s */ 'u' _ 'p' _ 's' _ 'e' _ 't' _ ';',
                          6,
                          0,
                          0x2283 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
  1581,
  /* n s */ 'u' _ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
  8,
  0,
  0x2289 _ 0)
NAMED_CHARACTER_REFERENCE(
  1582,
  /* n s */ 'u' _ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';',
  9,
  0,
  0x2ac6 _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(
  1694,
  /* p i */ 't' _ 'c' _ 'h' _ 'f' _ 'o' _ 'r' _ 'k' _ ';',
  8,
  0,
  0x22d4 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1721,
  /* p r */ 'e' _ 'c' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  9,
  0,
  0x2ab7 _ 0)
NAMED_CHARACTER_REFERENCE(
  1722,
  /* p r */ 'e' _ 'c' _ 'c' _ 'u' _ 'r' _ 'l' _ 'y' _ 'e' _ 'q' _ ';',
  10,
  0,
  0x227c _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1724,
  /* p r */ 'e' _ 'c' _ 'n' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  10,
  0,
  0x2ab9 _ 0)
NAMED_CHARACTER_REFERENCE(1725,
                          /* p r */ 'e' _ 'c' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
                          7,
                          0,
                          0x2ab5 _ 0)
NAMED_CHARACTER_REFERENCE(1726,
                          /* p r */ 'e' _ 'c' _ 'n' _ 's' _ 'i' _ 'm' _ ';',
                          7,
                          0,
                          0x22e8 _ 0)
NAMED_CHARACTER_REFERENCE(1727,
                          /* p r */ 'e' _ 'c' _ 's' _ 'i' _ 'm' _ ';',
                          6,
                          0,
                          0x227e _ 0)
...
NAMED_CHARACTER_REFERENCE(1734,
                          /* p r */ 'o' _ 'f' _ 'a' _ 'l' _ 'a' _ 'r' _ ';',
                          7,
                          0,
                          0x232e _ 0)
NAMED_CHARACTER_REFERENCE(1735,
                          /* p r */ 'o' _ 'f' _ 'l' _ 'i' _ 'n' _ 'e' _ ';',
                          7,
                          0,
                          0x2312 _ 0)
NAMED_CHARACTER_REFERENCE(1736,
                          /* p r */ 'o' _ 'f' _ 's' _ 'u' _ 'r' _ 'f' _ ';',
                          7,
                          0,
                          0x2313 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1749,
  /* q u */ 'a' _ 't' _ 'e' _ 'r' _ 'n' _ 'i' _ 'o' _ 'n' _ 's' _ ';',
  10,
  0,
  0x210d _ 0)
NAMED_CHARACTER_REFERENCE(1750,
                          /* q u */ 'a' _ 't' _ 'i' _ 'n' _ 't' _ ';',
                          6,
                          0,
                          0x2a16 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1784,
  /* r a */ 't' _ 'i' _ 'o' _ 'n' _ 'a' _ 'l' _ 's' _ ';',
  8,
  0,
  0x211a _ 0)
...
NAMED_CHARACTER_REFERENCE(1790,
                          /* r b */ 'r' _ 'k' _ 's' _ 'l' _ 'd' _ ';',
                          6,
                          0,
                          0x298e _ 0)
NAMED_CHARACTER_REFERENCE(1791,
                          /* r b */ 'r' _ 'k' _ 's' _ 'l' _ 'u' _ ';',
                          6,
                          0,
                          0x2990 _ 0)
...
NAMED_CHARACTER_REFERENCE(1803,
                          /* r e */ 'a' _ 'l' _ 'i' _ 'n' _ 'e' _ ';',
                          6,
                          0,
                          0x211b _ 0)
NAMED_CHARACTER_REFERENCE(1804,
                          /* r e */ 'a' _ 'l' _ 'p' _ 'a' _ 'r' _ 't' _ ';',
                          7,
                          0,
                          0x211c _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1832,
  /* r m */ 'o' _ 'u' _ 's' _ 't' _ 'a' _ 'c' _ 'h' _ 'e' _ ';',
  9,
  0,
  0x23b1 _ 0)
...
NAMED_CHARACTER_REFERENCE(1856,
                          /* r t */ 'r' _ 'i' _ 'l' _ 't' _ 'r' _ 'i' _ ';',
                          7,
                          0,
                          0x29ce _ 0)
NAMED_CHARACTER_REFERENCE(1857,
                          /* r u */ 'l' _ 'u' _ 'h' _ 'a' _ 'r' _ ';',
                          6,
                          0,
                          0x2968 _ 0)
...
NAMED_CHARACTER_REFERENCE(1910,
                          /* s i */ 'm' _ 'p' _ 'l' _ 'u' _ 's' _ ';',
                          6,
                          0,
                          0x2a24 _ 0)
NAMED_CHARACTER_REFERENCE(1911,
                          /* s i */ 'm' _ 'r' _ 'a' _ 'r' _ 'r' _ ';',
                          6,
                          0,
                          0x2972 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1927,
  /* s p */ 'a' _ 'd' _ 'e' _ 's' _ 'u' _ 'i' _ 't' _ ';',
  8,
  0,
  0x2660 _ 0)
...
NAMED_CHARACTER_REFERENCE(1935,
                          /* s q */ 's' _ 'u' _ 'b' _ 's' _ 'e' _ 't' _ ';',
                          7,
                          0,
                          0x228f _ 0)
NAMED_CHARACTER_REFERENCE(
  1936,
  /* s q */ 's' _ 'u' _ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
  9,
  0,
  0x2291 _ 0)
...
NAMED_CHARACTER_REFERENCE(1939,
                          /* s q */ 's' _ 'u' _ 'p' _ 's' _ 'e' _ 't' _ ';',
                          7,
                          0,
                          0x2290 _ 0)
NAMED_CHARACTER_REFERENCE(
  1940,
  /* s q */ 's' _ 'u' _ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
  9,
  0,
  0x2292 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1953,
  /* s t */ 'r' _ 'a' _ 'i' _ 'g' _ 'h' _ 't' _ 'p' _ 'h' _ 'i' _ ';',
  10,
  0,
  0x03d5 _ 0)
...
NAMED_CHARACTER_REFERENCE(1959,
                          /* s u */ 'b' _ 'e' _ 'd' _ 'o' _ 't' _ ';',
                          6,
                          0,
                          0x2ac3 _ 0)
NAMED_CHARACTER_REFERENCE(1960,
                          /* s u */ 'b' _ 'm' _ 'u' _ 'l' _ 't' _ ';',
                          6,
                          0,
                          0x2ac1 _ 0)
...
NAMED_CHARACTER_REFERENCE(1963,
                          /* s u */ 'b' _ 'p' _ 'l' _ 'u' _ 's' _ ';',
                          6,
                          0,
                          0x2abf _ 0)
NAMED_CHARACTER_REFERENCE(1964,
                          /* s u */ 'b' _ 'r' _ 'a' _ 'r' _ 'r' _ ';',
                          6,
                          0,
                          0x2979 _ 0)
...
NAMED_CHARACTER_REFERENCE(1966,
                          /* s u */ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
                          7,
                          0,
                          0x2286 _ 0)
NAMED_CHARACTER_REFERENCE(
  1967,
  /* s u */ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';',
  8,
  0,
  0x2ac5 _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(
  1969,
  /* s u */ 'b' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
  9,
  0,
  0x2acb _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1974,
  /* s u */ 'c' _ 'c' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  9,
  0,
  0x2ab8 _ 0)
NAMED_CHARACTER_REFERENCE(
  1975,
  /* s u */ 'c' _ 'c' _ 'c' _ 'u' _ 'r' _ 'l' _ 'y' _ 'e' _ 'q' _ ';',
  10,
  0,
  0x227d _ 0)
...
NAMED_CHARACTER_REFERENCE(
  1977,
  /* s u */ 'c' _ 'c' _ 'n' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  10,
  0,
  0x2aba _ 0)
NAMED_CHARACTER_REFERENCE(1978,
                          /* s u */ 'c' _ 'c' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
                          7,
                          0,
                          0x2ab6 _ 0)
NAMED_CHARACTER_REFERENCE(1979,
                          /* s u */ 'c' _ 'c' _ 'n' _ 's' _ 'i' _ 'm' _ ';',
                          7,
                          0,
                          0x22e9 _ 0)
NAMED_CHARACTER_REFERENCE(1980,
                          /* s u */ 'c' _ 'c' _ 's' _ 'i' _ 'm' _ ';',
                          6,
                          0,
                          0x227f _ 0)
...
NAMED_CHARACTER_REFERENCE(2003,
                          /* s u */ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';',
                          7,
                          0,
                          0x2287 _ 0)
NAMED_CHARACTER_REFERENCE(
  2004,
  /* s u */ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';',
  8,
  0,
  0x2ac6 _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(
  2006,
  /* s u */ 'p' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';',
  9,
  0,
  0x2acc _ 0)
...
NAMED_CHARACTER_REFERENCE(
  2031,
  /* t h */ 'i' _ 'c' _ 'k' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';',
  10,
  0,
  0x2248 _ 0)
NAMED_CHARACTER_REFERENCE(2032,
                          /* t h */ 'i' _ 'c' _ 'k' _ 's' _ 'i' _ 'm' _ ';',
                          7,
                          0,
                          0x223c _ 0)
...
NAMED_CHARACTER_REFERENCE(
  2058,
  /* t r */ 'i' _ 'a' _ 'n' _ 'g' _ 'l' _ 'e' _ 'q' _ ';',
  8,
  0,
  0x225c _ 0)
NAMED_CHARACTER_REFERENCE(
...
NAMED_CHARACTER_REFERENCE(2063,
                          /* t r */ 'i' _ 'm' _ 'i' _ 'n' _ 'u' _ 's' _ ';',
                          7,
                          0,
                          0x2a3a _ 0)
NAMED_CHARACTER_REFERENCE(2064,
                          /* t r */ 'i' _ 'p' _ 'l' _ 'u' _ 's' _ ';',
                          6,
                          0,
                          0x2a39 _ 0)
...
NAMED_CHARACTER_REFERENCE(2066,
                          /* t r */ 'i' _ 't' _ 'i' _ 'm' _ 'e' _ ';',
                          6,
                          0,
                          0x2a3b _ 0)
NAMED_CHARACTER_REFERENCE(2067,
                          /* t r */ 'p' _ 'e' _ 'z' _ 'i' _ 'u' _ 'm' _ ';',
                          7,
                          0,
                          0x23e2 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  2112,
  /* u p */ 'u' _ 'p' _ 'a' _ 'r' _ 'r' _ 'o' _ 'w' _ 's' _ ';',
  9,
  0,
  0x21c8 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  2132,
  /* v a */ 'r' _ 'e' _ 'p' _ 's' _ 'i' _ 'l' _ 'o' _ 'n' _ ';',
  9,
  0,
  0x03f5 _ 0)
NAMED_CHARACTER_REFERENCE(2133,
                          /* v a */ 'r' _ 'k' _ 'a' _ 'p' _ 'p' _ 'a' _ ';',
                          7,
                          0,
                          0x03f0 _ 0)
NAMED_CHARACTER_REFERENCE(
  2134,
  /* v a */ 'r' _ 'n' _ 'o' _ 't' _ 'h' _ 'i' _ 'n' _ 'g' _ ';',
  9,
  0,
  0x2205 _ 0)
...
NAMED_CHARACTER_REFERENCE(
  2137,
  /* v a */ 'r' _ 'p' _ 'r' _ 'o' _ 'p' _ 't' _ 'o' _ ';',
  8,
  0,
  0x221d _ 0)
