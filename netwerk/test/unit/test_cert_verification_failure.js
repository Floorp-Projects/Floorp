...
async function test_cert_vailure(server_or_proxy, server_cert) {
...
add_task(async function test_https() {
  await test_cert_vailure(NodeHTTPSServer, true);
});

add_task(async function test_http2() {
  await test_cert_vailure(NodeHTTP2Server, true);
});
...
add_task(async function test_https_proxy() {
  ...
  await test_cert_vailure(NodeHTTPSServer, false);
});
