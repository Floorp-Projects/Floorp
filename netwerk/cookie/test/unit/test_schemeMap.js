...
[
  {
    prefValue: true,
    consoleMessage: `Cookie “a” has been treated as cross-site again “http://example.org/” because the scheme does not match.`,
  },
  {
    prefValue: false,
    consoleMessage: `Cookie “a” will be soon treated as cross-site cookie again “http://example.org/” because the scheme does not match.`,
  },
].forEach(test => {
  add_task(async () => {
    do_get_profile();
