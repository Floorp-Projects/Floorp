...
const ExtFind = {
   ...
   *
   * Upon resolution sends a message with a payload that includes:
   ...
   *
   * Upon resolution sends a message with a payload that includes an integer value
   *   describing the resulting status of the highlighting, which will be used
   *   as criteria for resolving or rejecting the promise.  This will be one of:
   *   1 - success.
