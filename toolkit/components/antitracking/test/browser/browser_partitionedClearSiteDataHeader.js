 ...
 */
function createFrame(browser, src, id) {
 ...
 */
async function createTabWithFrame(firstPartyUrl, thirdPartyUrl, frameId) {
  ...
  await createFrame(tab.linkedBrowser, thirdPartyUrl, frameId);
 ...
 * third party.
 */
async function runClearSiteDataTest(cbPreClear, cbPostClear, clearDataContext) {
  ...
  let [
    ...
    createTabWithFrame(ORIGIN_A, ORIGIN_B, THIRD_PARTY_FRAME_ID_ORIGIN_B),
    createTabWithFrame(ORIGIN_B, ORIGIN_A, THIRD_PARTY_FRAME_ID_ORIGIN_A),
  ]);
