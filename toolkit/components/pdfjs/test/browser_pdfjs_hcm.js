...
add_task(async function test() {
  ...
  await BrowserTestUtils.withNewTab(
    ...
    async function(browser) {
      ...
      Assert.deepEqual(first, [0, 255, 0, 255]);

      // The last pixel must be red.
      Assert.deepEqual(last, [255, 0, 0, 255]);
    }
  );
});
