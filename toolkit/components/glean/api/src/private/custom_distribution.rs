...
mod test {
    ...
    fn custom_distribution_child() {
        ...
        parent_metric.accumulate_samples_signed(vec![1, 2, 3]);

        {
            ...
            child_metric.accumulate_samples_signed(vec![4, 5, 6]);
        }
        ...
        for i in 1..=6 {
            assert_eq!(1, data.values[&i], "Bucket {} should have one value", i);
        }
        assert_eq!(21, data.sum, "Sum over 1..6");
    }
}
