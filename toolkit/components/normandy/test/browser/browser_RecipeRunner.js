...
decorate_task(
  withStub(RecipeRunner, "getCapabilities"),
  withSpy(RecipeRunner, "loadRecipes"),
  async function test_run_includesCapabilities(
    getCapabilitiesStub,
    loadRecipesSpy
  ) {
    ...
    ok(
      loadRecipesSpy.calledWith(capabilities),
      "capabilities should be passed to loadRecipes"
    );
  }
);
