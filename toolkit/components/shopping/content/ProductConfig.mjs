...
const Environments = {
  prod: {
    ...
    ANALYSIS_STATUS_API: "https://trustwerty.com/api/v2/fx/analysis_status",
    ANALYZE_API:         "https://trustwerty.com/api/v2/fx/analyze",
    ATTRIBUTION_API:     "https://pe.fakespot.com/api/v2/fx/events",
    RECOMMENDATIONS_API: "https://a.fakespot.com/v2/fx/sp_search",
    REPORTING_API:       "https://trustwerty.com/api/v2/fx/report",
  },
  stage: {
    ANALYSIS_API:        "https://staging.trustwerty.com/api/v2/fx/analysis",
    ANALYSIS_STATUS_API: "https://staging.trustwerty.com/api/v2/fx/analysis_status",
    ANALYZE_API:         "https://staging.trustwerty.com/api/v2/fx/analyze",
    ATTRIBUTION_API:     "https://staging-partner-ads.fakespot.io/api/v2/fx/events",
    RECOMMENDATIONS_API: "https://staging-affiliates.fakespot.io/v2/fx/sp_search",
    REPORTING_API:       "https://staging.trustwerty.com/api/v2/fx/report",
  },
  test: {
