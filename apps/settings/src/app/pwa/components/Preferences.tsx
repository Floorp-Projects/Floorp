    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-6">
                <div>
                    <h3 className="text-base font-medium mb-2">{t("progressiveWebApp.enableDisable")}</h3>
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <label>{t("progressiveWebApp.enablePwa")}</label>
                            <p className="text-sm text-muted-foreground">{t("progressiveWebApp.enablePwaDescription")}</p>
                        </div>
                        <input
                            type="checkbox"
                ...
                <div className="border-t pt-6">
                    <h3 className="text-base font-medium mb-2">{t("progressiveWebApp.otherSettings")}</h3>
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <label>{t("progressiveWebApp.showToolbar")}</label>
                            <p className="text-sm text-muted-foreground">{t("progressiveWebApp.showToolbarDescription")}</p>
                        </div>
                        <input
                            type="checkbox"
