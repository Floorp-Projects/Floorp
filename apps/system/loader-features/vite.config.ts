  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: {
        ...
        "about-preferences": r("../../features-about/preferences/index.ts"),
        "about-newtab": r("../../features-about/newtab/index.ts"),
      ...
      transform(code, id, options) {
        if (
          ...
          code += [
            ...
            " * PLEASE CHECK /apps/system/loader-features/vite.config.ts",
            " */",
            "if (import.meta.hot) {",
