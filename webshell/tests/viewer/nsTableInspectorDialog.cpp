...
//-------------------------------------------------------------------------
//
// nsTableInspectorDialog constructor
//
//-------------------------------------------------------------------------
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
nsTableInspectorDialog::~nsTableInspectorDialog()
{
}

//---------------------------------------------------------------
void nsTableInspectorDialog::Initialize(nsIXPBaseWindow * aWindow) 
{
...
#if 0
//-----------------------------------------------------------------
void nsTableInspectorDialog::GetSetupInfo(PrintSetupInfo & aPSI)
{
...
//-----------------------------------------------------------------
void nsTableInspectorDialog::SetSetupInfo(const PrintSetupInfo & aPSI)
{
  if (nsnull == mWindow) {
...
//-----------------------------------------------------------------
void nsTableInspectorDialog::SetSetupInfoInternal(const PrintSetupInfo & aPSI)
{
...
//-----------------------------------------------------------------
void nsTableInspectorDialog::MouseClick(nsIDOMEvent* aMouseEvent, nsIXPBaseWindow * aWindow, PRBool &aStatus)
{
...
//-----------------------------------------------------------------
void nsTableInspectorDialog::Destroy(nsIXPBaseWindow * aWindow)
{
...
void
nsTableInspectorDialog::DoClose()
{
