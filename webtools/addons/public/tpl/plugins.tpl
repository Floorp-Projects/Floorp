...
<div class="item">
    ...
    <p><img src="{$config.webpath}/images/faq_small.png" style="float: left;" height=16 width=16 alt="">&nbsp;Visit the <a href="http://www.adobe.com/products/acrobat/readstep2.html">Adobe Reader download page</a> to select the latest version for your operating system.</p>
    <h3><img src="{$config.webpath}/images/install.png" height="24" width="24" alt="">&nbsp;Download</h3>
    <div style="margin-top: 5px; height: 50px">
        <div class="iconbar"><img src="{$config.webpath}/images/windows_icon.png" height="34" width="34" alt="">&nbsp;For Windows:<br>&nbsp;&nbsp;<a href="http://www.adobe.com/products/acrobat/readstep2.html">Latest Version</a></div>
        <div class="iconbar"><img src="{$config.webpath}/images/linux_icon.png" height="34" width="34" alt="">&nbsp;For Linux:<br>&nbsp;&nbsp;<a href="http://www.adobe.com/products/acrobat/readstep2.html">Latest Version</a></div>
...
<div class="item">
    ...
    <p><img src="{$config.webpath}/images/faq_small.png" style="float: left;" height=16 width=16 alt="">&nbsp;Visit the <a href="http://www.adobe.com/products/acrobat/readstep2.html">Flash Player download page</a> to select the latest version for your operating system.</p>
    <h3><img src="{$config.webpath}/images/install.png" height="24" width="24" alt="">&nbsp;Download</h3>
    <div style="margin-top: 5px; height: 50px">
        ...
        <div class="iconbar"><img src="{$config.webpath}/images/linux_icon.png" height="34" width="34" alt="">&nbsp;For Linux:<br>&nbsp;&nbsp;<a href="http://www.macromedia.com/go/getflashplayer">Version 9</a></div>
...
<div class="item">
    ...
    <div style="margin-top: 5px; height: 38px">
        ...
        <div class="iconbar"><img src="{$config.webpath}/images/macosx_icon.png" height="34" width="34" alt="">&nbsp;For MacOSX:<br>&nbsp;&nbsp;<a href="http://www.apple.com/quicktime/download/standalone.html">Version 7.1.2</a></div>
    </div>
...
<div class="item">
    ...
    <h3><img src="{$config.webpath}/images/install.png" height="24" width="24" alt="">&nbsp;Download</h3>
    <div style="margin-top: 5px; height: 38px">
        <div class="iconbar"><img src="{$config.webpath}/images/windows_icon.png" height="34" width="34" alt="">&nbsp;For Windows:<br>&nbsp;&nbsp;<a href="http://www.adobe.com/shockwave/download/">Version 10</a></div>
        <div class="iconbar"><img src="{$config.webpath}/images/linux_icon.png" height="34" width="34" alt="">&nbsp;For Linux:<br>&nbsp;&nbsp;Unavailable</div>
        <div class="iconbar"><img src="{$config.webpath}/images/macosx_icon.png" height="34" width="34" alt="">&nbsp;For MacOSX:<br>&nbsp;&nbsp;<a href="http://www.adobe.com/shockwave/download/">Version 10</a></div>
    </div>
