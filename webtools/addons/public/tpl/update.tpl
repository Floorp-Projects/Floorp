...
{if $update}
<RDF:Description about="urn:mozilla:{$update.exttype}:{$reqItemGuid|escape:html:"UTF-8"}">
    <em:updates>
        <RDF:Seq>
            <RDF:li resource="urn:mozilla:{$update.exttype}:{$reqItemGuid|escape:html:"UTF-8"}:{$update.extversion|escape:html:"UTF-8"}"/>
        </RDF:Seq>
    </em:updates>
</RDF:Description>
