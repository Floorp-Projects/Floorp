...
<p>Showing comments <b>{$page.leftDisplay}-{$page.right}</b> out of <b>{$page.resultCount}</b>.</p>
...
{else}
<p>There are no comments yet for this add-on.  <a href="{$config.webpath}/addcomment.php?aid={$addon->ID}&amp;app={$app}">Add your own comment</a></p>
{/if}
