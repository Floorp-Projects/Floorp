...
<div id="key-menu"> 
    <dl id="menu-firefox">
    <dt>Firefox:</dt>
    <dd><a href="/extensions/?application=firefox" title="Get Extensions for the Firefox Browser">Extensions</a>, <a href="/themes/?application=firefox" title="Get Themes for the Firefox Browser">Themes</a>, <a href="/plugins/" title="Get Plugins for Firefox">Plugins</a></dd>

    </dl>
    <dl id="menu-thunderbird">
    <dt>Thunderbird:</dt>
    <dd><a href="/extensions/?application=thunderbird" title="Get Extensions for Thunderbird Email">Extensions</a>, <a href="/themes/?application=thunderbird" title="Get Themes for Thunderbird Email">Themes</a></dd>
    </dl>
    <dl id="menu-mozillasuite">
    <dt>Mozilla Suite:</dt>

    <dd><a href="/extensions/?application=mozilla" title="Get Extensions for the Mozilla Suite">Extensions</a>, <a href="/themes/?application=mozilla" title="Get Themes for the Mozilla Suite">Themes</a>, <a href="/plugins/" title="Get Plugins for Mozilla Suite">Plugins</a></dd>
    </dl>
