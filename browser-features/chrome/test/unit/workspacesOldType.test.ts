...
} from "../../common/workspaces/data/migrate/old_type.ts";
...
function testWorkspacePreferenceEmpty(): void {
  ...
  assertEquals(result._tag, "Right", "empty object should decode (all optional)");
}
...
export async function runAllTests(): Promise<void> {
  const tests: TestCase[] = [
    ...
    { name: "workspace detail with optional", fn: testWorkspaceDetailWithOptional },
    { name: "workspace detail missing name", fn: testWorkspaceDetailMissingName },
