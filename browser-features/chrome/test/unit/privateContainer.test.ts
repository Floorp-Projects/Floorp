...
import { PrivateContainer } from "../../common/private-container/PrivateContainer.ts";
...
function testStartupCreatePrivateContainer(): void {
  ...
  const container = PrivateContainer.getPrivateContainer();
  assert(container !== undefined, "private container should exist after startup");
  assert(
    container.floorpPrivateContainer === true,
...
export async function runAllTests(): Promise<void> {
  const tests: TestCase[] = [
    ...
    { name: "getPrivateContainerUserContextId", fn: testGetPrivateContainerUserContextId },
    { name: "consistency check", fn: testPrivateContainerConsistency },
    { name: "startup creates container", fn: testStartupCreatePrivateContainer },
