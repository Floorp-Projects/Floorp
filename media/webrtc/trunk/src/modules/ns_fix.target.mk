...
$(obj).target/src/modules/libns_fix.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libns_fix.a: LIBS := $(LIBS)
$(obj).target/src/modules/libns_fix.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libns_fix.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libns_fix.a
# Add target alias
.PHONY: ns_fix
