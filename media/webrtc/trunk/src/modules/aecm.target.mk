...
OBJS := $(obj).target/$(TARGET)/src/modules/audio_processing/aecm/echo_control_mobile.o \
	$(obj).target/$(TARGET)/src/modules/audio_processing/aecm/aecm_core.o
...
$(obj).target/src/modules/libaecm.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libaecm.a: LIBS := $(LIBS)
$(obj).target/src/modules/libaecm.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libaecm.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libaecm.a
# Add target alias
.PHONY: aecm
aecm: $(obj).target/src/modules/libaecm.a
