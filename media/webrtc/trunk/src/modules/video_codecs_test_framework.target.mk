...
TOOLSET := target
TARGET := video_codecs_test_framework
...
$(obj).target/src/modules/libvideo_codecs_test_framework.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libvideo_codecs_test_framework.a: LIBS := $(LIBS)
$(obj).target/src/modules/libvideo_codecs_test_framework.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libvideo_codecs_test_framework.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libvideo_codecs_test_framework.a
# Add target alias
