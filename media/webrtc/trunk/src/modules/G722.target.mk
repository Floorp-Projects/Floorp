...
$(obj).target/src/modules/libG722.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/src/modules/libG722.a: LIBS := $(LIBS)
$(obj).target/src/modules/libG722.a: TOOLSET := $(TOOLSET)
$(obj).target/src/modules/libG722.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/src/modules/libG722.a
# Add target alias
.PHONY: G722
G722: $(obj).target/src/modules/libG722.a
