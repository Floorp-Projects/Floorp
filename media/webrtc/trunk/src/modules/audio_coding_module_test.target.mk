...
OBJS := $(obj).target/$(TARGET)/src/modules/audio_coding/main/test/ACMTest.o \
	...
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/SpatialAudio.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TestAllCodecs.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/Tester.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TestFEC.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TestStereo.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TestVADDTX.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TimedTrace.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/TwoWayCommunication.o \
	$(obj).target/$(TARGET)/src/modules/audio_coding/main/test/utility.o
