 ...
 *
 * Define CPR calls to standard memory calls using either
 * CPR's local version of memory management from Doug Lea's
 * malloc implementation or through what is provided via
 * Linux, i.e. the JVM's implementation of the same algorithm.
 *
 */
