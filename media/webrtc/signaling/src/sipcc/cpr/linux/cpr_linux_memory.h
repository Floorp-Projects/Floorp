...
/** @todo 
 * We can get rid of this whole buffer logic as well since we don't have the
 * pools or regions. Ask at Review time. But it might be a good idea to have one
 * field that identifies a good buffer.
 */
