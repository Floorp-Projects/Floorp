...
void aom_fdct8x8_1_neon(const int16_t *input, tran_low_t *output, int stride);
...
void aom_hadamard_8x8_neon(const int16_t *src_diff, int src_stride, int16_t *coeff);
...
void aom_idct16x16_10_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct16x16_1_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct16x16_256_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct32x32_1024_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct32x32_1_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct4x4_16_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct4x4_1_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct8x8_12_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct8x8_1_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
void aom_idct8x8_64_add_neon(const tran_low_t *input, uint8_t *dest, int dest_stride);
...
int16_t aom_int_pro_col_neon(const uint8_t *ref, int width);
...
void aom_int_pro_row_neon(int16_t *hbuf, const uint8_t *ref, int ref_stride, int height);
...
unsigned int aom_mse16x16_media(const uint8_t *src_ptr, int  source_stride, const uint8_t *ref_ptr, int  recon_stride, unsigned int *sse);
...
unsigned int aom_sad16x16_media(const uint8_t *src_ptr, int src_stride, const uint8_t *ref_ptr, int ref_stride);
...
void aom_sad16x16x4d_neon(const uint8_t *src_ptr, int src_stride, const uint8_t * const ref_ptr[], int ref_stride, uint32_t *sad_array);
...
void aom_sad32x32x4d_neon(const uint8_t *src_ptr, int src_stride, const uint8_t * const ref_ptr[], int ref_stride, uint32_t *sad_array);
...
void aom_sad64x64x4d_neon(const uint8_t *src_ptr, int src_stride, const uint8_t * const ref_ptr[], int ref_stride, uint32_t *sad_array);
...
uint32_t aom_sub_pixel_variance16x16_media(const uint8_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse);
...
uint32_t aom_sub_pixel_variance8x8_media(const uint8_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse);
...
unsigned int aom_variance16x16_media(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
unsigned int aom_variance8x8_media(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
uint32_t aom_variance_halfpixvar16x16_h_media(const unsigned char *src_ptr, int source_stride, const unsigned char *ref_ptr, int  ref_stride, uint32_t *sse);
#define aom_variance_halfpixvar16x16_h aom_variance_halfpixvar16x16_h_media
...
uint32_t aom_variance_halfpixvar16x16_hv_media(const unsigned char *src_ptr, int source_stride, const unsigned char *ref_ptr, int  ref_stride, uint32_t *sse);
#define aom_variance_halfpixvar16x16_hv aom_variance_halfpixvar16x16_hv_media
...
uint32_t aom_variance_halfpixvar16x16_v_media(const unsigned char *src_ptr, int source_stride, const unsigned char *ref_ptr, int  ref_stride, uint32_t *sse);
#define aom_variance_halfpixvar16x16_v aom_variance_halfpixvar16x16_v_media
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_NEON) aom_avg_4x4 = aom_avg_4x4_neon;
    aom_avg_8x8 = aom_avg_8x8_c;
    if (flags & HAS_NEON) aom_avg_8x8 = aom_avg_8x8_neon;
    aom_convolve8 = aom_convolve8_c;
    if (flags & HAS_NEON) aom_convolve8 = aom_convolve8_neon;
    aom_convolve8_avg = aom_convolve8_avg_c;
    if (flags & HAS_NEON) aom_convolve8_avg = aom_convolve8_avg_neon;
    aom_convolve8_avg_horiz = aom_convolve8_avg_horiz_c;
    if (flags & HAS_NEON) aom_convolve8_avg_horiz = aom_convolve8_avg_horiz_neon;
    aom_convolve8_avg_vert = aom_convolve8_avg_vert_c;
    if (flags & HAS_NEON) aom_convolve8_avg_vert = aom_convolve8_avg_vert_neon;
    ...
    if (flags & HAS_NEON) aom_convolve_avg = aom_convolve_avg_neon;
    aom_convolve_copy = aom_convolve_copy_c;
    if (flags & HAS_NEON) aom_convolve_copy = aom_convolve_copy_neon;
    aom_d135_predictor_4x4 = aom_d135_predictor_4x4_c;
    if (flags & HAS_NEON) aom_d135_predictor_4x4 = aom_d135_predictor_4x4_neon;
    ...
    if (flags & HAS_NEON) aom_fdct8x8 = aom_fdct8x8_neon;
    aom_fdct8x8_1 = aom_fdct8x8_1_c;
    if (flags & HAS_NEON) aom_fdct8x8_1 = aom_fdct8x8_1_neon;
    aom_get16x16var = aom_get16x16var_c;
    if (flags & HAS_NEON) aom_get16x16var = aom_get16x16var_neon;
    aom_get4x4sse_cs = aom_get4x4sse_cs_c;
    if (flags & HAS_NEON) aom_get4x4sse_cs = aom_get4x4sse_cs_neon;
    aom_get8x8var = aom_get8x8var_c;
    if (flags & HAS_NEON) aom_get8x8var = aom_get8x8var_neon;
    ...
    if (flags & HAS_NEON) aom_hadamard_16x16 = aom_hadamard_16x16_neon;
    aom_hadamard_8x8 = aom_hadamard_8x8_c;
    if (flags & HAS_NEON) aom_hadamard_8x8 = aom_hadamard_8x8_neon;
    aom_idct16x16_10_add = aom_idct16x16_10_add_c;
    if (flags & HAS_NEON) aom_idct16x16_10_add = aom_idct16x16_10_add_neon;
    aom_idct16x16_1_add = aom_idct16x16_1_add_c;
    if (flags & HAS_NEON) aom_idct16x16_1_add = aom_idct16x16_1_add_neon;
    aom_idct16x16_256_add = aom_idct16x16_256_add_c;
    if (flags & HAS_NEON) aom_idct16x16_256_add = aom_idct16x16_256_add_neon;
    aom_idct32x32_1024_add = aom_idct32x32_1024_add_c;
    if (flags & HAS_NEON) aom_idct32x32_1024_add = aom_idct32x32_1024_add_neon;
    aom_idct32x32_135_add = aom_idct32x32_135_add_c;
    if (flags & HAS_NEON) aom_idct32x32_135_add = aom_idct32x32_1024_add_neon;
    aom_idct32x32_1_add = aom_idct32x32_1_add_c;
    if (flags & HAS_NEON) aom_idct32x32_1_add = aom_idct32x32_1_add_neon;
    aom_idct32x32_34_add = aom_idct32x32_34_add_c;
    if (flags & HAS_NEON) aom_idct32x32_34_add = aom_idct32x32_1024_add_neon;
    aom_idct4x4_16_add = aom_idct4x4_16_add_c;
    if (flags & HAS_NEON) aom_idct4x4_16_add = aom_idct4x4_16_add_neon;
    aom_idct4x4_1_add = aom_idct4x4_1_add_c;
    if (flags & HAS_NEON) aom_idct4x4_1_add = aom_idct4x4_1_add_neon;
    aom_idct8x8_12_add = aom_idct8x8_12_add_c;
    if (flags & HAS_NEON) aom_idct8x8_12_add = aom_idct8x8_12_add_neon;
    aom_idct8x8_1_add = aom_idct8x8_1_add_c;
    if (flags & HAS_NEON) aom_idct8x8_1_add = aom_idct8x8_1_add_neon;
    aom_idct8x8_64_add = aom_idct8x8_64_add_c;
    if (flags & HAS_NEON) aom_idct8x8_64_add = aom_idct8x8_64_add_neon;
    ...
    aom_mse16x16 = aom_mse16x16_media;
    if (flags & HAS_NEON) aom_mse16x16 = aom_mse16x16_neon;
    aom_sad16x16 = aom_sad16x16_media;
    if (flags & HAS_NEON) aom_sad16x16 = aom_sad16x16_neon;
    aom_sad16x16x4d = aom_sad16x16x4d_c;
    if (flags & HAS_NEON) aom_sad16x16x4d = aom_sad16x16x4d_neon;
    aom_sad16x8 = aom_sad16x8_c;
    if (flags & HAS_NEON) aom_sad16x8 = aom_sad16x8_neon;
    aom_sad32x32 = aom_sad32x32_c;
    if (flags & HAS_NEON) aom_sad32x32 = aom_sad32x32_neon;
    aom_sad32x32x4d = aom_sad32x32x4d_c;
    if (flags & HAS_NEON) aom_sad32x32x4d = aom_sad32x32x4d_neon;
    aom_sad4x4 = aom_sad4x4_c;
    if (flags & HAS_NEON) aom_sad4x4 = aom_sad4x4_neon;
    aom_sad64x64 = aom_sad64x64_c;
    if (flags & HAS_NEON) aom_sad64x64 = aom_sad64x64_neon;
    aom_sad64x64x4d = aom_sad64x64x4d_c;
    if (flags & HAS_NEON) aom_sad64x64x4d = aom_sad64x64x4d_neon;
    aom_sad8x16 = aom_sad8x16_c;
    if (flags & HAS_NEON) aom_sad8x16 = aom_sad8x16_neon;
    aom_sad8x8 = aom_sad8x8_c;
    if (flags & HAS_NEON) aom_sad8x8 = aom_sad8x8_neon;
    aom_satd = aom_satd_c;
    if (flags & HAS_NEON) aom_satd = aom_satd_neon;
    aom_sub_pixel_variance16x16 = aom_sub_pixel_variance16x16_media;
    if (flags & HAS_NEON) aom_sub_pixel_variance16x16 = aom_sub_pixel_variance16x16_neon;
    ...
    if (flags & HAS_NEON) aom_sub_pixel_variance64x64 = aom_sub_pixel_variance64x64_neon;
    aom_sub_pixel_variance8x8 = aom_sub_pixel_variance8x8_media;
    if (flags & HAS_NEON) aom_sub_pixel_variance8x8 = aom_sub_pixel_variance8x8_neon;
    ...
    aom_variance16x16 = aom_variance16x16_media;
    if (flags & HAS_NEON) aom_variance16x16 = aom_variance16x16_neon;
    aom_variance16x8 = aom_variance16x8_c;
    if (flags & HAS_NEON) aom_variance16x8 = aom_variance16x8_neon;
    aom_variance32x32 = aom_variance32x32_c;
    if (flags & HAS_NEON) aom_variance32x32 = aom_variance32x32_neon;
    aom_variance32x64 = aom_variance32x64_c;
    if (flags & HAS_NEON) aom_variance32x64 = aom_variance32x64_neon;
    aom_variance64x32 = aom_variance64x32_c;
    if (flags & HAS_NEON) aom_variance64x32 = aom_variance64x32_neon;
    aom_variance64x64 = aom_variance64x64_c;
    if (flags & HAS_NEON) aom_variance64x64 = aom_variance64x64_neon;
    aom_variance8x16 = aom_variance8x16_c;
    if (flags & HAS_NEON) aom_variance8x16 = aom_variance8x16_neon;
    aom_variance8x8 = aom_variance8x8_media;
    if (flags & HAS_NEON) aom_variance8x8 = aom_variance8x8_neon;
    aom_vector_var = aom_vector_var_c;
    if (flags & HAS_NEON) aom_vector_var = aom_vector_var_neon;
}
#endif
