...
RTCD_EXTERN void (*av1_highbd_convolve_2d_sr_intrabc)(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams *filter_params_x, const InterpFilterParams *filter_params_y, const int subpel_x_qn, const int subpel_y_qn, ConvolveParams *conv_params, int bd);
...
RTCD_EXTERN void (*av1_highbd_convolve_x_sr_intrabc)(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams *filter_params_x, const int subpel_x_qn, ConvolveParams *conv_params, int bd);
...
RTCD_EXTERN void (*av1_highbd_convolve_y_sr_intrabc)(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const InterpFilterParams *filter_params_y, const int subpel_y_qn, int bd);
...
RTCD_EXTERN double (*av1_highbd_estimate_noise_from_single_plane)(const uint16_t *src, int height, int width, int stride, int bit_depth, int edge_thresh);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_NEON) aom_dist_wtd_comp_avg_upsampled_pred = aom_dist_wtd_comp_avg_upsampled_pred_neon;
    aom_highbd_comp_avg_upsampled_pred = aom_highbd_comp_avg_upsampled_pred_c;
    if (flags & HAS_NEON) aom_highbd_comp_avg_upsampled_pred = aom_highbd_comp_avg_upsampled_pred_neon;
    aom_highbd_dist_wtd_comp_avg_upsampled_pred = aom_highbd_dist_wtd_comp_avg_upsampled_pred_c;
    if (flags & HAS_NEON) aom_highbd_dist_wtd_comp_avg_upsampled_pred = aom_highbd_dist_wtd_comp_avg_upsampled_pred_neon;
    aom_highbd_upsampled_pred = aom_highbd_upsampled_pred_c;
    if (flags & HAS_NEON) aom_highbd_upsampled_pred = aom_highbd_upsampled_pred_neon;
    ...
    if (flags & HAS_NEON) av1_apply_temporal_filter = av1_apply_temporal_filter_neon;
    ...
    if (flags & HAS_NEON) av1_build_compound_diffwtd_mask_highbd = av1_build_compound_diffwtd_mask_highbd_neon;
    ...
    if (flags & HAS_NEON) av1_calc_proj_params = av1_calc_proj_params_neon;
    av1_calc_proj_params_high_bd = av1_calc_proj_params_high_bd_c;
    if (flags & HAS_NEON) av1_calc_proj_params_high_bd = av1_calc_proj_params_high_bd_neon;
    av1_cnn_convolve_no_maxpool_padding_valid = av1_cnn_convolve_no_maxpool_padding_valid_c;
    if (flags & HAS_NEON) av1_cnn_convolve_no_maxpool_padding_valid = av1_cnn_convolve_no_maxpool_padding_valid_neon;
    ...
    if (flags & HAS_NEON) av1_estimate_noise_from_single_plane = av1_estimate_noise_from_single_plane_neon;
    ...
    if (flags & HAS_NEON) av1_fwd_txfm2d_16x64 = av1_fwd_txfm2d_16x64_neon;
    ...
    if (flags & HAS_NEON) av1_fwd_txfm2d_32x8 = av1_fwd_txfm2d_32x8_neon;
    av1_fwd_txfm2d_4x16 = av1_fwd_txfm2d_4x16_c;
    if (flags & HAS_NEON) av1_fwd_txfm2d_4x16 = av1_fwd_txfm2d_4x16_neon;
    ...
    if (flags & HAS_NEON) av1_fwd_txfm2d_64x16 = av1_fwd_txfm2d_64x16_neon;
    ...
    if (flags & HAS_NEON) av1_fwd_txfm2d_8x32 = av1_fwd_txfm2d_8x32_neon;
    ...
    if (flags & HAS_NEON) av1_highbd_apply_temporal_filter = av1_highbd_apply_temporal_filter_neon;
    av1_highbd_block_error = av1_highbd_block_error_c;
    if (flags & HAS_NEON) av1_highbd_block_error = av1_highbd_block_error_neon;
    av1_highbd_convolve_2d_scale = av1_highbd_convolve_2d_scale_c;
    if (flags & HAS_NEON) av1_highbd_convolve_2d_scale = av1_highbd_convolve_2d_scale_neon;
    av1_highbd_convolve_2d_sr = av1_highbd_convolve_2d_sr_c;
    if (flags & HAS_NEON) av1_highbd_convolve_2d_sr = av1_highbd_convolve_2d_sr_neon;
    av1_highbd_convolve_2d_sr_intrabc = av1_highbd_convolve_2d_sr_intrabc_c;
    if (flags & HAS_NEON) av1_highbd_convolve_2d_sr_intrabc = av1_highbd_convolve_2d_sr_intrabc_neon;
    av1_highbd_convolve_horiz_rs = av1_highbd_convolve_horiz_rs_c;
    if (flags & HAS_NEON) av1_highbd_convolve_horiz_rs = av1_highbd_convolve_horiz_rs_neon;
    av1_highbd_convolve_x_sr = av1_highbd_convolve_x_sr_c;
    if (flags & HAS_NEON) av1_highbd_convolve_x_sr = av1_highbd_convolve_x_sr_neon;
    av1_highbd_convolve_x_sr_intrabc = av1_highbd_convolve_x_sr_intrabc_c;
    if (flags & HAS_NEON) av1_highbd_convolve_x_sr_intrabc = av1_highbd_convolve_x_sr_intrabc_neon;
    av1_highbd_convolve_y_sr = av1_highbd_convolve_y_sr_c;
    if (flags & HAS_NEON) av1_highbd_convolve_y_sr = av1_highbd_convolve_y_sr_neon;
    av1_highbd_convolve_y_sr_intrabc = av1_highbd_convolve_y_sr_intrabc_c;
    if (flags & HAS_NEON) av1_highbd_convolve_y_sr_intrabc = av1_highbd_convolve_y_sr_intrabc_neon;
    av1_highbd_dist_wtd_convolve_2d = av1_highbd_dist_wtd_convolve_2d_c;
    if (flags & HAS_NEON) av1_highbd_dist_wtd_convolve_2d = av1_highbd_dist_wtd_convolve_2d_neon;
    av1_highbd_dist_wtd_convolve_2d_copy = av1_highbd_dist_wtd_convolve_2d_copy_c;
    if (flags & HAS_NEON) av1_highbd_dist_wtd_convolve_2d_copy = av1_highbd_dist_wtd_convolve_2d_copy_neon;
    av1_highbd_dist_wtd_convolve_x = av1_highbd_dist_wtd_convolve_x_c;
    if (flags & HAS_NEON) av1_highbd_dist_wtd_convolve_x = av1_highbd_dist_wtd_convolve_x_neon;
    av1_highbd_dist_wtd_convolve_y = av1_highbd_dist_wtd_convolve_y_c;
    if (flags & HAS_NEON) av1_highbd_dist_wtd_convolve_y = av1_highbd_dist_wtd_convolve_y_neon;
    av1_highbd_dr_prediction_z1 = av1_highbd_dr_prediction_z1_c;
    if (flags & HAS_NEON) av1_highbd_dr_prediction_z1 = av1_highbd_dr_prediction_z1_neon;
    av1_highbd_dr_prediction_z2 = av1_highbd_dr_prediction_z2_c;
    if (flags & HAS_NEON) av1_highbd_dr_prediction_z2 = av1_highbd_dr_prediction_z2_neon;
    av1_highbd_dr_prediction_z3 = av1_highbd_dr_prediction_z3_c;
    if (flags & HAS_NEON) av1_highbd_dr_prediction_z3 = av1_highbd_dr_prediction_z3_neon;
    av1_highbd_estimate_noise_from_single_plane = av1_highbd_estimate_noise_from_single_plane_c;
    if (flags & HAS_NEON) av1_highbd_estimate_noise_from_single_plane = av1_highbd_estimate_noise_from_single_plane_neon;
    av1_highbd_filter_intra_edge = av1_highbd_filter_intra_edge_c;
    if (flags & HAS_NEON) av1_highbd_filter_intra_edge = av1_highbd_filter_intra_edge_neon;
    ...
    if (flags & HAS_NEON) av1_highbd_pixel_proj_error = av1_highbd_pixel_proj_error_neon;
    av1_highbd_quantize_fp = av1_highbd_quantize_fp_c;
    if (flags & HAS_NEON) av1_highbd_quantize_fp = av1_highbd_quantize_fp_neon;
    av1_highbd_upsample_intra_edge = av1_highbd_upsample_intra_edge_c;
    if (flags & HAS_NEON) av1_highbd_upsample_intra_edge = av1_highbd_upsample_intra_edge_neon;
    av1_highbd_warp_affine = av1_highbd_warp_affine_c;
    if (flags & HAS_NEON) av1_highbd_warp_affine = av1_highbd_warp_affine_neon;
    av1_highbd_wiener_convolve_add_src = av1_highbd_wiener_convolve_add_src_c;
    if (flags & HAS_NEON) av1_highbd_wiener_convolve_add_src = av1_highbd_wiener_convolve_add_src_neon;
    ...
    if (flags & HAS_NEON) av1_lowbd_pixel_proj_error = av1_lowbd_pixel_proj_error_neon;
