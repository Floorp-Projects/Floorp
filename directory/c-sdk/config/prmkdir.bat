...
REM Version: NPL 1.1/GPL 2.0/LGPL 2.1
REM 
...
REM use your version of this file under the terms of the NPL, indicate your
...
REM the terms of any one of the NPL, the GPL or the LGPL.
REM 
