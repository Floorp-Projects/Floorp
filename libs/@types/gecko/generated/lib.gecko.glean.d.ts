...
interface GleanImpl {
  ...
  networking: {
    ...
    fetchKeepaliveDiscardCount: Record<
      "per_origin_limit" | "total_keepalive_limit",
      GleanCounter
    >;
    ...
    httpIpAddrAnyCount: Record<
      "blocked_requests" | "not_blocked_requests",
      GleanCounter
    >;
  ...
  genaiChatbot: {
    ...
    onboardingContinue: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    ...
    onboardingProviderLearn: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    ...
    onboardingTextHighlightDisplayed: GleanEventWithExtras<{
      provider?: string;
      step?: string;
    }>;
    page: GleanBoolean;
  ...
  newtab: {
    ...
    fakespotCategory: GleanEventWithExtras<{
      category?: string;
  ...
  suggest: {
    ...
    >;
    queryTime: Record<
      "amo" | "amp" | "fakespot" | "mdn" | "weather" | "wikipedia" | "yelp",
      GleanTimingDistribution
    >;
  };
  ...
  urlbar: {
    ...
    fakespotEngagement: GleanEventWithExtras<{
      grade?: string;
      provider?: string;
      rating?: string;
    }>;
  ...
  htmleditors: {
    ...
    withMutationListenersWithoutBeforeinputListeners: Record<
      "false" | "true",
      GleanCounter
    >;
  ...
  dns: {
    ...
    gracePeriodRenewal: Record<
      "different_record" | "same_record",
      GleanCounter
    >;
  ...
  formautofillMl: {
    fieldInferResult: GleanEventWithExtras<{
      fathom_infer_label?: string;
      fathom_infer_score?: string;
      infer_field_name?: string;
      infer_reason?: string;
      is_valid_section?: string;
      ml_infer_label?: string;
      ml_infer_score?: string;
      ml_revision?: string;
    }>;
  };
  ...
  system: {
    ...
    memory: GleanQuantity;
    specialDirectoryAppdataFallback: Record<
