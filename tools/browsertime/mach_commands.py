...
def setup(command_context, should_clobber=False, new_upstream_url=""):
...
def browsertime(
    ...
    if update_upstream_url:
        return setup(command_context, new_upstream_url=update_upstream_url)
    elif setup:
        return setup(command_context, should_clobber=clobber)
    else:
