...
//? Build-related paths (relative to project root)
export const buildid2Path = "../../_dist/buildid2";
export const profileTestPath = "../../_dist/profile/test";
export const loaderFeaturesPath = "../../src/core/glue/loader-features";
export const featuresChromePath = "../../chrome/browser";
export const i18nFeaturesChromePath = "../../i18n/features-chrome";
export const loaderModulesPath = "../../src/core/glue/loader-modules";
export const modulesPath = "../../modules";
export const actualModulesPath = "../../src/core/modules";
