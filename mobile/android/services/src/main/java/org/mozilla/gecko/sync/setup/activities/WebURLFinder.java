...
public class WebURLFinder {
  ...
  /* package-private */ WebURLFinder(List<String> strings) {
    if (strings == null) {
   ...
   */
  private static boolean isWebURL(String string) {
    try {
      new URI(string);
    } catch (Exception e) {
      return false;
    ...
    return !(android.webkit.URLUtil.isFileUrl(string)
  ...
  private static List<String> candidateWebURLs(Collection<String> strings) {
  ...
  private static List<String> candidateWebURLs(String string) {
    Matcher matcher = AUTOLINK_WEB_URL.matcher(string);
  ...
  private String firstWebURLWithoutScheme() {
