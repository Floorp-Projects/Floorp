...
public final class StorageController {
   ...
   */
  @AnyThread
  public void setCookieBannerModeForDomain(
    ...
    EventDispatcher.getInstance().dispatch("GeckoView:SetCookieBannerModeForDomain", data);
  }
   ...
   */
  @AnyThread
  public void removeCookieBannerModeForDomain(
      final @NonNull String uri, final boolean isPrivateBrowsing) {

    final GeckoBundle data = new GeckoBundle(3);
    data.putString("uri", uri);
    data.putBoolean("isPrivateBrowsing", isPrivateBrowsing);
    EventDispatcher.getInstance().dispatch("GeckoView:RemoveCookieBannerModeForDomain", data);
  }
