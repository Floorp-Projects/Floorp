...
public class TrackingPermissionService extends TestRuntimeService {
    ...
    protected GeckoResult<GeckoBundle> handleMessage(final int messageId, final GeckoBundle data) {
        ...
        switch (messageId) {
            case MESSAGE_SET_TRACKING_PERMISSION: {
                ...
                mRuntime.getStorageController().setPermission(
                        mContentPermission, permission);
                break;
            }
            case MESSAGE_SET_PRIVATE_BROWSING_TRACKING_PERMISSION: {
                final int permission = data.getInt("trackingPermission");
                mRuntime.getStorageController().setPrivateBrowsingPermanentPermission(
                        mContentPermission, permission);
                break;
            }
    ...
    public static class TrackingPermissionInstance extends
            RuntimeInstance<TrackingPermissionService> {
        ...
        private TrackingPermissionInstance(final Context context,
        ...
        public static TrackingPermissionInstance start(final Context context,
                                 final File profileFolder,
                                 final boolean privateMode) {
