...
abstract class MediaPlaybackTest extends BaseTest {
     ...
     * been changed.
     */
    protected void waitUntilNotificationUIChanged() {
     ...
     * been changed.
     */
    protected void waitUntilTabAudioPlayingStateChanged() {
        waitForCondition(new Condition() {
            @Override
            public boolean isSatisfied() {
     ...
     */
    protected void notifyMediaControlService(String action) {
     ...
     */
    protected void checkIfMediaPlayingSuccess(boolean isTabPlaying) {
     ...
     */
    protected void checkMediaNotificationStatesAfterChanged(boolean isTabPlaying,
                                                            boolean clearNotification) {
    ...
    protected void checkIfMediaNotificationBeCleared() {
        NotificationManager notificationManager = (NotificationManager)
            getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        StatusBarNotification[] sbns = notificationManager.getActiveNotifications();
     ...
     */
    protected void checkAudioFocusStateAfterChanged(boolean isTabPlaying) {
    ...
    protected AudioFocusAgent getAudioFocusAgent() {
     ...
     * the correct version.
     */
    protected void checkAndroidVersionForMediaControlTest() {
        mAsserter.ok(Build.VERSION.SDK_INT >= 23,
