...
interface WebPushDelegate {
     ...
     */
    fun onGetSubscription(scope: String): WebPushSubscription

    /**
     * Create a WebPush subscription for the given Service Worker scope.
     */
    fun onSubscribe(scope: String, serverKey: ByteArray?): WebPushSubscription
     ...
     */
    fun onUnsubscribe(scope: String): Boolean
}
