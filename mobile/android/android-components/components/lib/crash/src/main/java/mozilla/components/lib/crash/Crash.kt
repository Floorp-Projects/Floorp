...
/**
 * Used to build crash objects with the required meta data attached
 */
class CrashBuilder(
    private val runtimeTagProviders: List<RuntimeTagProvider> = listOf(),
) {
    fun uncaughtExceptionCrash(
        throwable: Throwable,
