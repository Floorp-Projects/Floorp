...
| Name | Summary |
|---|---|
| [broadcastChannel](../../mozilla.components.lib.state.ext/broadcast-channel.md) | `fun <S : `[`State`](../../mozilla.components.lib.state/-state.md)`, A : `[`Action`](../../mozilla.components.lib.state/-action.md)`> `[`Store`](../../mozilla.components.lib.state/-store/index.md)`<`[`S`](../../mozilla.components.lib.state.ext/broadcast-channel.md#S)`, `[`A`](../../mozilla.components.lib.state.ext/broadcast-channel.md#A)`>.broadcastChannel(owner: LifecycleOwner = ProcessLifecycleOwner.get()): BroadcastChannel<`[`S`](../../mozilla.components.lib.state.ext/broadcast-channel.md#S)`>`<br>Creates a conflated [BroadcastChannel](#) for observing [State](../../mozilla.components.lib.state/-state.md) changes in the [Store](../../mozilla.components.lib.state/-store/index.md). |
