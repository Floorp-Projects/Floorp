...
| Name | Summary |
|---|---|
| [broadcastChannel](../../mozilla.components.lib.state.ext/broadcast-channel.md) | `fun <S : `[`State`](../-state.md)`, A : `[`Action`](../-action.md)`> `[`Store`](./index.md)`<`[`S`](../../mozilla.components.lib.state.ext/broadcast-channel.md#S)`, `[`A`](../../mozilla.components.lib.state.ext/broadcast-channel.md#A)`>.broadcastChannel(owner: LifecycleOwner = ProcessLifecycleOwner.get()): BroadcastChannel<`[`S`](../../mozilla.components.lib.state.ext/broadcast-channel.md#S)`>`<br>Creates a conflated [BroadcastChannel](#) for observing [State](../-state.md) changes in the [Store](./index.md). |
