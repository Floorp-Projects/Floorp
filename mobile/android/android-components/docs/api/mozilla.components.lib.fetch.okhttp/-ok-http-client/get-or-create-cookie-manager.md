[android-components](../../index.md) / [mozilla.components.lib.fetch.okhttp](../index.md) / [OkHttpClient](index.md) / [getOrCreateCookieManager](./get-or-create-cookie-manager.md)
