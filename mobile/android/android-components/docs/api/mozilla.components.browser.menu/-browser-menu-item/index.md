...
| [WebExtensionBrowserMenuItem](../../mozilla.components.browser.menu.item/-web-extension-browser-menu-item/index.md) | `class WebExtensionBrowserMenuItem : `[`BrowserMenuItem`](./index.md)<br>A browser menu item displaying web extension. |
