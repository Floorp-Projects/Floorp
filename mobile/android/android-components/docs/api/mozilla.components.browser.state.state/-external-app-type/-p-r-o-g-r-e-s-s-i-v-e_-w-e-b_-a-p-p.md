[android-components](../../index.md) / [mozilla.components.browser.state.state](../index.md) / [ExternalAppType](index.md) / [PROGRESSIVE_WEB_APP](./-p-r-o-g-r-e-s-s-i-v-e_-w-e-b_-a-p-p.md)
