[android-components](../../index.md) / [mozilla.components.browser.search.provider](../index.md) / [SearchEngineProvider](index.md) / [loadSearchEngines](./load-search-engines.md)
