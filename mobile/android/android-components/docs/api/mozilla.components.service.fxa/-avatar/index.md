[android-components](../../index.md) / [mozilla.components.service.fxa](../index.md) / [Avatar](./index.md)

# Avatar

`data class Avatar` [(source)](https://github.com/mozilla-mobile/android-components/blob/master/components/service/firefox-accounts/src/main/java/mozilla/components/service/fxa/Profile.kt#L9)
