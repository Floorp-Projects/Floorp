[android-components](../../index.md) / [mozilla.components.feature.contextmenu](../index.md) / [ContextMenuCandidate](index.md) / [createCopyEmailAddressCandidate](./create-copy-email-address-candidate.md)
