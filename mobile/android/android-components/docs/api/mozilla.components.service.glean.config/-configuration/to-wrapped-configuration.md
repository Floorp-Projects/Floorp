[android-components](../../index.md) / [mozilla.components.service.glean.config](../index.md) / [Configuration](index.md) / [toWrappedConfiguration](./to-wrapped-configuration.md)
