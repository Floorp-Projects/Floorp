[android-components](../../index.md) / [mozilla.components.support.locale](../index.md) / [LocaleAwareAppCompatActivity](index.md) / [setLayoutDirectionIfNeeded](./set-layout-direction-if-needed.md)
