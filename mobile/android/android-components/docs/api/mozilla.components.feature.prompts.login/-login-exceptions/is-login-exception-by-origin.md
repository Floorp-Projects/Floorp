[android-components](../../index.md) / [mozilla.components.feature.prompts.login](../index.md) / [LoginExceptions](index.md) / [isLoginExceptionByOrigin](./is-login-exception-by-origin.md)
