...
| [installed](installed.md) | `val installed: `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)<br>Indicates if this [Addon](./index.md) is installed or not, defaults to false. |
