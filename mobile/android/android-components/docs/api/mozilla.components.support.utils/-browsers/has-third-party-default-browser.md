[android-components](../../index.md) / [mozilla.components.support.utils](../index.md) / [Browsers](index.md) / [hasThirdPartyDefaultBrowser](./has-third-party-default-browser.md)
