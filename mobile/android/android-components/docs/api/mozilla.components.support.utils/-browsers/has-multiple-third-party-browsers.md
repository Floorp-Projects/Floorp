[android-components](../../index.md) / [mozilla.components.support.utils](../index.md) / [Browsers](index.md) / [hasMultipleThirdPartyBrowsers](./has-multiple-third-party-browsers.md)
