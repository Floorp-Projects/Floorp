[android-components](../../index.md) / [mozilla.components.support.utils](../index.md) / [Browsers](index.md) / [hasFirefoxBrandedBrowserInstalled](./has-firefox-branded-browser-installed.md)
