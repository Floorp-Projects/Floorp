[android-components](../../../index.md) / [mozilla.components.browser.icons.loader](../../index.md) / [DiskIconLoader](../index.md) / [LoaderDiskCache](index.md) / [getIconData](./get-icon-data.md)
