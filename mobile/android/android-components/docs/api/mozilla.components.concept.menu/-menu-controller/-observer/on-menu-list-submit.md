[android-components](../../../index.md) / [mozilla.components.concept.menu](../../index.md) / [MenuController](../index.md) / [Observer](index.md) / [onMenuListSubmit](./on-menu-list-submit.md)
