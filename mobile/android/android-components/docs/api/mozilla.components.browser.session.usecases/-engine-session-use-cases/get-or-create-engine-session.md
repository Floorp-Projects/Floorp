[android-components](../../index.md) / [mozilla.components.browser.session.usecases](../index.md) / [EngineSessionUseCases](index.md) / [getOrCreateEngineSession](./get-or-create-engine-session.md)
