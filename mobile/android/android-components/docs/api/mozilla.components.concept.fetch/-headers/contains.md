[android-components](../../index.md) / [mozilla.components.concept.fetch](../index.md) / [Headers](index.md) / [contains](./contains.md)
...
Returns true if a [Header](../-header/index.md) with the given [name](contains.md#mozilla.components.concept.fetch.Headers$contains(kotlin.String)/name) exists.
