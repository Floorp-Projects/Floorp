[android-components](../../index.md) / [mozilla.components.service.fxa.manager](../index.md) / [AccountState](index.md) / [CanAutoRetryAuthenticationViaTokenReuse](./-can-auto-retry-authentication-via-token-reuse.md)
