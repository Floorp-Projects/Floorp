[android-components](../../index.md) / [mozilla.components.service.glean.debug](../index.md) / [GleanDebugActivity](index.md) / [SEND_PING_EXTRA_KEY](./-s-e-n-d_-p-i-n-g_-e-x-t-r-a_-k-e-y.md)
