...
| [registerWebExtensionTabDelegate](register-web-extension-tab-delegate.md) | `fun registerWebExtensionTabDelegate(webExtensionTabDelegate: `[`WebExtensionTabDelegate`](../../mozilla.components.concept.engine.webextension/-web-extension-tab-delegate/index.md)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>See [Engine.registerWebExtensionTabDelegate](../../mozilla.components.concept.engine/-engine/register-web-extension-tab-delegate.md). |
