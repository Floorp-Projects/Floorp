[android-components](../../index.md) / [mozilla.components.feature.addons.ui](../index.md) / [AddonPermissionsAdapter](index.md) / [onCreateViewHolder](./on-create-view-holder.md)
