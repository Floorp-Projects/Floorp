[android-components](../../index.md) / [mozilla.components.feature.addons.ui](../index.md) / [AddonsManagerAdapterDelegate](index.md) / [onNotYetSupportedSectionClicked](./on-not-yet-supported-section-clicked.md)
