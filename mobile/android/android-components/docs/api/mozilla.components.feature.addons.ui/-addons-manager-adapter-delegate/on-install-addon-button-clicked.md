[android-components](../../index.md) / [mozilla.components.feature.addons.ui](../index.md) / [AddonsManagerAdapterDelegate](index.md) / [onInstallAddonButtonClicked](./on-install-addon-button-clicked.md)
