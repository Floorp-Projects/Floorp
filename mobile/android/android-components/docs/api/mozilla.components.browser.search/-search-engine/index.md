...
| [getSearchTemplate](get-search-template.md) | `fun getSearchTemplate(): `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>Gets the user-entered search url template |
