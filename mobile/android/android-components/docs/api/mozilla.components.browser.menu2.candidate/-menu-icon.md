[android-components](../index.md) / [mozilla.components.browser.menu2.candidate](index.md) / [MenuIcon](./-menu-icon.md)

# MenuIcon

`sealed class MenuIcon` [(source)](https://github.com/mozilla-mobile/android-components/blob/master/components/browser/menu2/src/main/java/mozilla/components/browser/menu2/candidate/MenuIcon.kt#L16)
