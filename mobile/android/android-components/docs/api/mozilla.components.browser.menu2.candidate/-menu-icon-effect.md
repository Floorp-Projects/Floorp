[android-components](../index.md) / [mozilla.components.browser.menu2.candidate](index.md) / [MenuIconEffect](./-menu-icon-effect.md)

# MenuIconEffect

`sealed class MenuIconEffect : `[`MenuEffect`](-menu-effect.md) [(source)](https://github.com/mozilla-mobile/android-components/blob/master/components/browser/menu2/src/main/java/mozilla/components/browser/menu2/candidate/MenuEffect.kt#L25)
