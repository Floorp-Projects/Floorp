[android-components](../../index.md) / [mozilla.components.lib.push.firebase](../index.md) / [AbstractFirebasePushService](index.md) / [MESSAGE_KEY_CHANNEL_ID](./-m-e-s-s-a-g-e_-k-e-y_-c-h-a-n-n-e-l_-i-d.md)
