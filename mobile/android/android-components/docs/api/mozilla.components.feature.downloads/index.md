...
| [DownloadManager](-download-manager/index.md) | `class DownloadManager`<br>Handles the interactions with the [AndroidDownloadManager](-android-download-manager.md). |
...
| Name | Summary |
|---|---|
| [AndroidDownloadManager](-android-download-manager.md) | `typealias AndroidDownloadManager = `[`DownloadManager`](https://developer.android.com/reference/android/app/DownloadManager.html) |
