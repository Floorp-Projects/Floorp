[android-components](../../index.md) / [mozilla.components.support.ktx.android.view](../index.md) / [android.app.Activity](index.md) / [exitImmersiveModeIfNeeded](./exit-immersive-mode-if-needed.md)
