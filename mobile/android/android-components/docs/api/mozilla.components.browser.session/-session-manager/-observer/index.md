...
`interface Observer` [(source)](https://github.com/mozilla-mobile/android-components/blob/master/components/browser/session/src/main/java/mozilla/components/browser/session/SessionManager.kt#L337)
...
| [TabsTrayPresenter](../../../mozilla.components.feature.tabs.tabstray/-tabs-tray-presenter/index.md) | `class TabsTrayPresenter : `[`Observer`](./index.md)<br>Presenter implementation for a tabs tray implementation in order to update the tabs tray whenever the state of the session manager changes. |
