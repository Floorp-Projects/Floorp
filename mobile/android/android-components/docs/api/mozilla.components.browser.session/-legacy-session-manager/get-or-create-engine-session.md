[android-components](../../index.md) / [mozilla.components.browser.session](../index.md) / [LegacySessionManager](index.md) / [getOrCreateEngineSession](./get-or-create-engine-session.md)
