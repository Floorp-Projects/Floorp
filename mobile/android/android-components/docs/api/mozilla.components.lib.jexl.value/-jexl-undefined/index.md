[android-components](../../index.md) / [mozilla.components.lib.jexl.value](../index.md) / [JexlUndefined](./index.md)

# JexlUndefined

`class JexlUndefined : `[`JexlValue`](../-jexl-value/index.md) [(source)](https://github.com/mozilla-mobile/android-components/blob/master/components/lib/jexl/src/main/java/mozilla/components/lib/jexl/value/JexlValue.kt#L287)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `JexlUndefined()`<br>JEXL undefined type. |
