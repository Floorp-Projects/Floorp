[android-components](../../index.md) / [mozilla.components.concept.engine](../index.md) / [DefaultSettings](index.md) / [forceUserScalableContent](./force-user-scalable-content.md)
