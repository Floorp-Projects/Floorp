[android-components](../../index.md) / [mozilla.components.support.ktx.android.net](../index.md) / [android.net.Uri](index.md) / [hostWithoutCommonPrefixes](./host-without-common-prefixes.md)
