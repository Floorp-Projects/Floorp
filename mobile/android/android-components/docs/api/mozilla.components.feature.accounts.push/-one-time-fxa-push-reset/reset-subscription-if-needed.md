[android-components](../../index.md) / [mozilla.components.feature.accounts.push](../index.md) / [OneTimeFxaPushReset](index.md) / [resetSubscriptionIfNeeded](./reset-subscription-if-needed.md)
