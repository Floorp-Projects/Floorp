[android-components](../../../index.md) / [mozilla.components.feature.syncedtabs.view](../../index.md) / [SyncedTabsView](../index.md) / [ErrorType](index.md) / [SYNC_NEEDS_REAUTHENTICATION](./-s-y-n-c_-n-e-e-d-s_-r-e-a-u-t-h-e-n-t-i-c-a-t-i-o-n.md)
