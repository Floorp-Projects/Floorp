...
| Name | Summary |
|---|---|
| [SitePermissions](-site-permissions/index.md) | `data class SitePermissions : `[`Parcelable`](https://developer.android.com/reference/android/os/Parcelable.html)<br>A site permissions and its state. |
