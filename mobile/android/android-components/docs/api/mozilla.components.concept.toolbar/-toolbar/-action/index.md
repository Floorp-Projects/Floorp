...
| [ContainerToolbarAction](../../../mozilla.components.feature.toolbar/-container-toolbar-action/index.md) | `class ContainerToolbarAction : `[`Action`](./index.md)<br>An action button that represents a container to be added to the toolbar. |
