...
| [&lt;init&gt;](-init-.html) | `GeckoEngineSession(runtime: GeckoRuntime, privateMode: `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)` = false, defaultSettings: Settings? = null)`<br>Gecko-based EngineSession implementation. |
