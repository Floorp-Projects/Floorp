[android-components](../../index.md) / [mozilla.components.concept.engine.webextension](../index.md) / [WebExtension](index.md) / [isAllowedInPrivateBrowsing](./is-allowed-in-private-browsing.md)
