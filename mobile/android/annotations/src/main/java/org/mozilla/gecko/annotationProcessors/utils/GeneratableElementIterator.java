...
public class GeneratableElementIterator implements Iterator<AnnotatableEntity> {
     ...
     * likely to be one of the enumerated values: We look for public, static, final fields that
     * share the same class as the declaring enum's class.
     *
     * Note that any additional members that should be wrapped may be explicitly annotated on a
     * case-by-case basis.
     */
