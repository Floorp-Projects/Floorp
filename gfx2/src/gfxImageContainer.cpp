...
NS_IMPL_ISUPPORTS2(gfxImageContainer, gfxIImageContainer, nsITimerCallback)

gfxImageContainer::gfxImageContainer()
{
  NS_INIT_ISUPPORTS();
...
NS_IMETHODIMP gfxImageContainer::Init(nscoord aWidth, nscoord aHeight, gfxIImageContainerObserver *aObserver)
{
...
NS_IMETHODIMP gfxImageContainer::GetPreferredAlphaChannelFormat(gfx_format *aFormat)
{
...
NS_IMETHODIMP gfxImageContainer::GetWidth(nscoord *aWidth)
{
  *aWidth = mSize.width;
  return NS_OK;
}
...
NS_IMETHODIMP gfxImageContainer::GetHeight(nscoord *aHeight)
{
...
NS_IMETHODIMP gfxImageContainer::GetCurrentFrame(gfxIImageFrame * *aCurrentFrame)
{
  return this->GetFrameAt(mCurrentFrame, aCurrentFrame);
}

/* readonly attribute unsigned long numFrames; */
NS_IMETHODIMP gfxImageContainer::GetNumFrames(PRUint32 *aNumFrames)
{
...
NS_IMETHODIMP gfxImageContainer::AppendFrame(gfxIImageFrame *item)
{
...
NS_IMETHODIMP gfxImageContainer::DecodingComplete(void)
{
