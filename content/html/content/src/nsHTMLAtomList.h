...
HTML_ATOM(buttonContentPseudo, ":-moz-button-content")
HTML_ATOM(caption, "caption")
HTML_ATOM(cellContentPseudo, ":-moz-cell-content")
...
HTML_ATOM(fieldsetContentPseudo, ":-moz-fieldset-content")
...
HTML_ATOM(framesetBlankPseudo, ":-moz-frameset-blank")
...
HTML_ATOM(horizontalFramesetBorderPseudo, ":-moz-hframeset-border")
HTML_ATOM(hr, "hr")
HTML_ATOM(href, "href")
...
HTML_ATOM(tablePseudo, ":-moz-table")
HTML_ATOM(tableCellPseudo, ":-moz-table-cell")
HTML_ATOM(tableColGroupPseudo, ":-moz-table-column-group")
HTML_ATOM(tableColPseudo, ":-moz-table-column")
HTML_ATOM(tableOuterPseudo, ":-moz-table-outer")
HTML_ATOM(tableRowGroupPseudo, ":-moz-table-row-group")
HTML_ATOM(tableRowPseudo, ":-moz-table-row")
...
HTML_ATOM(verticalFramesetBorderPseudo, ":-moz-vframeset-border")
