...
public:
   ...
   */
  const static PRUint32 IME_STATUS_NONE    = 0x0000,
                        IME_STATUS_ENABLE  = 0x0001,
                        IME_STATUS_DISABLE = 0x0002,
                        IME_STATUS_OPEN    = 0x0004,
                        IME_STATUS_CLOSE   = 0x0008;
  const static PRUint32 IME_STATUS_MASK_ENABLED =
                          IME_STATUS_ENABLE | IME_STATUS_DISABLE;
  const static PRUint32 IME_STATUS_MASK_OPENED =
                          IME_STATUS_OPEN | IME_STATUS_CLOSE;
