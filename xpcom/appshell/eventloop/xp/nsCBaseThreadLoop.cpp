...
//*****************************************************************************
// nsCBaseThreadLoop:: App Loop Runs
//*****************************************************************************   

nsresult nsCBaseThreadLoop::RunWithNoListener(nsIEvent* event,
...
nsresult nsCBaseThreadLoop::RunWithTranslateListener(nsIEvent* event,
...
nsresult nsCBaseThreadLoop::RunWithDispatchListener(nsIEvent* event,
...
nsresult nsCBaseThreadLoop::RunWithTranslateAndDispatchListener(nsIEvent* event,
	nsIEventFilter* filter,	nsITranslateListener* translateListener, 
