...
struct TestMove
{
  ...
  TestMove(TestMove&& a) : mMoveCounter(a.mMoveCounter) { ++mMoveCounter; }
  void operator()() {}
  int& mMoveCounter;
};
struct TestCopyMove
{
  ...
  TestCopyMove(TestCopyMove&& a) : mCopyCounter(a.mCopyCounter), mMoveCounter(a.mMoveCounter) { ++mMoveCounter; }
  void operator()() {}
  int& mCopyCounter;
  int& mMoveCounter;
};
