...
const PRInt32 nsCSSProps::kHintTable[PROP_MAX] = {
  ...
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_BOTTOM_STYLE - reflow for on/off case
  ...
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_LEFT_STYLE - reflow for on/off case
  ...
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_RIGHT_STYLE - reflow for on/off case 
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_RIGHT_WIDTH
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_SPACING
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_STYLE - turing on/off can impact reflow, would be nice to detect that case
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_TOP 
  NS_STYLE_HINT_VISUAL, // PROP_BORDER_TOP_COLOR 
  NS_STYLE_HINT_REFLOW, // PROP_BORDER_TOP_STYLE - reflow for on/off case
