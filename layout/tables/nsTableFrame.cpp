...
struct BCPropertyData {
  ...
  nscoord mBStartBorderWidth;
  nscoord mIEndBorderWidth;
  nscoord mBEndBorderWidth;
  nscoord mIStartBorderWidth;
  nscoord mIStartCellBorderWidth;
  nscoord mIEndCellBorderWidth;
};
...
void BCMapCellInfo::SetTableBStartBorderWidth(nscoord aWidth) {
  mTableBCData->mBStartBorderWidth =
      std::max(mTableBCData->mBStartBorderWidth, aWidth);
}

void BCMapCellInfo::SetTableIStartBorderWidth(int32_t aRowB, nscoord aWidth) {
...
void BCMapCellInfo::SetTableIEndBorderWidth(int32_t aRowB, nscoord aWidth) {
...
void BCMapCellInfo::SetTableBEndBorderWidth(nscoord aWidth) {
