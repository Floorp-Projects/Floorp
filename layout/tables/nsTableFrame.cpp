...
struct BCMapCellInfo {
  ...
  // Functions to set the border widths on the table related cell frames,
  ...
  // width seen is stored. This is controlled by `aPickMax` flag set after
  // the first span value is set.
