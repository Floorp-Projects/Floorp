...
function handleRequest(request, response) {
  ...
  if (action === 'resetState') {
    ...
    return;
  } else if (action === 'generate-img-policy-test') {
    ...
    return;
  } else if (action === 'generate-img-policy-test2') {
    ...
    return;
  } else if (action === 'generate-img-policy-test3') {
    ...
    return;
  } else if (action === 'generate-img-policy-test4') {
    ...
    return;
  } else if (action === 'generate-img-policy-test5') {
