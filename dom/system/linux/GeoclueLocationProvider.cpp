...
class GCLocProviderPriv final : public nsIGeolocationProvider,
 ...
 private:
  ...
  void DBusProxyError(const GError* aGError, bool aResetManager = false);

  static void GetClientResponse(GDBusProxy* aProxy, GAsyncResult* aResult,
                                gpointer aUserData);
  void ConnectClient(const gchar* aClientPath);
  static void ConnectClientResponse(GObject* aObject, GAsyncResult* aResult,
                                    gpointer aUserData);
  void SetDesktopID();
  static void SetDesktopIDResponse(GDBusProxy* aProxy, GAsyncResult* aResult,
                                   gpointer aUserData);
  void SetAccuracy();
  static void SetAccuracyResponse(GDBusProxy* aProxy, GAsyncResult* aResult,
                                  gpointer aUserData);
  void StartClient();
  static void StartClientResponse(GDBusProxy* aProxy, GAsyncResult* aResult,
                                  gpointer aUserData);
  void StopClient(bool aForRestart);
  static void StopClientResponse(GDBusProxy* aProxy, GAsyncResult* aResult,
                                 gpointer aUserData);
  void StopClientNoWait();
  void MaybeRestartForAccuracy();

  static void GCManagerOwnerNotify(GObject* aObject, GParamSpec* aPSpec,
                                   gpointer aUserData);
...
void GCLocProviderPriv::GetClientResponse(GDBusProxy* aProxy,
                                          ...
                                          gpointer aUserData) {
  auto* self = static_cast<GCLocProviderPriv*>(aUserData);
  ...
  auto signalError =
      MakeScopeExit([&] { self->DBusProxyError(nullptr, true); });
