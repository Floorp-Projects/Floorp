...
add_task(function test_unsubscribe_success() {
  do_test_pending();
  service.unsubscribe(
...
add_test(function test_unsubscribe_nonexistent() {
  ...
  service.unsubscribe(
    ...
    (result, success) => {
      ...
      strictEqual(success, true, 'Nonexistent subscriptions should return true');
...
add_task(function test_unsubscribe_error() {
  do_test_pending();
  service.unsubscribe(
