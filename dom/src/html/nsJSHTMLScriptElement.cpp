...
enum HTMLScriptElement_slots {
  HTMLSCRIPTELEMENT_TEXT = -11,
  HTMLSCRIPTELEMENT_HTMLFOR = -12,
  HTMLSCRIPTELEMENT_EVENT = -13,
  HTMLSCRIPTELEMENT_CHARSET = -14,
  HTMLSCRIPTELEMENT_DEFER = -15,
  HTMLSCRIPTELEMENT_SRC = -16,
  HTMLSCRIPTELEMENT_TYPE = -17
};
