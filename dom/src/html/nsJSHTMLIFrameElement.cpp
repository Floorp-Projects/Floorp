...
enum HTMLIFrameElement_slots {
  HTMLIFRAMEELEMENT_ALIGN = -11,
  HTMLIFRAMEELEMENT_FRAMEBORDER = -12,
  HTMLIFRAMEELEMENT_HEIGHT = -13,
  HTMLIFRAMEELEMENT_LONGDESC = -14,
  HTMLIFRAMEELEMENT_MARGINHEIGHT = -15,
  HTMLIFRAMEELEMENT_MARGINWIDTH = -16,
  HTMLIFRAMEELEMENT_NAME = -17,
  HTMLIFRAMEELEMENT_SCROLLING = -18,
  HTMLIFRAMEELEMENT_SRC = -19,
  HTMLIFRAMEELEMENT_WIDTH = -110
};
