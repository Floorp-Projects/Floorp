...
enum HTMLOListElement_slots {
  HTMLOLISTELEMENT_COMPACT = -11,
  HTMLOLISTELEMENT_START = -12,
  HTMLOLISTELEMENT_TYPE = -13
};
...
//
nsresult NS_InitHTMLOListElementClass(nsIScriptContext *aContext, void **aPrototype)
{
