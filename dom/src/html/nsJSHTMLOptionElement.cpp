...
enum HTMLOptionElement_slots {
  HTMLOPTIONELEMENT_FORM = -11,
  HTMLOPTIONELEMENT_DEFAULTSELECTED = -12,
  HTMLOPTIONELEMENT_TEXT = -13,
  HTMLOPTIONELEMENT_INDEX = -14,
  HTMLOPTIONELEMENT_DISABLED = -15,
  HTMLOPTIONELEMENT_LABEL = -16,
  HTMLOPTIONELEMENT_SELECTED = -17,
  HTMLOPTIONELEMENT_VALUE = -18
};
