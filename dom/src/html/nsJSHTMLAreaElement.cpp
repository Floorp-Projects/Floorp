...
enum HTMLAreaElement_slots {
  ...
  HTMLAREAELEMENT_ALT = -12,
  HTMLAREAELEMENT_COORDS = -13,
  HTMLAREAELEMENT_HREF = -14,
  HTMLAREAELEMENT_NOHREF = -15,
  HTMLAREAELEMENT_SHAPE = -16,
  HTMLAREAELEMENT_TABINDEX = -17,
  HTMLAREAELEMENT_TARGET = -18
};
