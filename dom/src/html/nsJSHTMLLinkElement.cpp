...
enum HTMLLinkElement_slots {
  HTMLLINKELEMENT_DISABLED = -11,
  HTMLLINKELEMENT_CHARSET = -12,
  HTMLLINKELEMENT_HREF = -13,
  HTMLLINKELEMENT_HREFLANG = -14,
  HTMLLINKELEMENT_MEDIA = -15,
  HTMLLINKELEMENT_REL = -16,
  HTMLLINKELEMENT_REV = -17,
  HTMLLINKELEMENT_TARGET = -18,
  HTMLLINKELEMENT_TYPE = -19
};
