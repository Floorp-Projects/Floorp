...
enum HTMLObjectElement_slots {
  HTMLOBJECTELEMENT_FORM = -11,
  HTMLOBJECTELEMENT_CODE = -12,
  HTMLOBJECTELEMENT_ALIGN = -13,
  HTMLOBJECTELEMENT_ARCHIVE = -14,
  HTMLOBJECTELEMENT_BORDER = -15,
  HTMLOBJECTELEMENT_CODEBASE = -16,
  HTMLOBJECTELEMENT_CODETYPE = -17,
  HTMLOBJECTELEMENT_DATA = -18,
  HTMLOBJECTELEMENT_DECLARE = -19,
  HTMLOBJECTELEMENT_HEIGHT = -110,
  HTMLOBJECTELEMENT_HSPACE = -111,
  HTMLOBJECTELEMENT_NAME = -112,
  HTMLOBJECTELEMENT_STANDBY = -113,
  HTMLOBJECTELEMENT_TABINDEX = -114,
  HTMLOBJECTELEMENT_TYPE = -115,
  HTMLOBJECTELEMENT_USEMAP = -116,
  HTMLOBJECTELEMENT_VSPACE = -117,
  HTMLOBJECTELEMENT_WIDTH = -118
};
...
//
nsresult NS_InitHTMLObjectElementClass(nsIScriptContext *aContext, void **aPrototype)
{
