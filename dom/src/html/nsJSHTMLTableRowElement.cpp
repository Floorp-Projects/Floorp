...
enum HTMLTableRowElement_slots {
  HTMLTABLEROWELEMENT_ROWINDEX = -11,
  HTMLTABLEROWELEMENT_SECTIONROWINDEX = -12,
  HTMLTABLEROWELEMENT_CELLS = -13,
  HTMLTABLEROWELEMENT_ALIGN = -14,
  HTMLTABLEROWELEMENT_BGCOLOR = -15,
  HTMLTABLEROWELEMENT_CH = -16,
  HTMLTABLEROWELEMENT_CHOFF = -17,
  HTMLTABLEROWELEMENT_VALIGN = -18
};
