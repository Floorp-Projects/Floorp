...
enum HTMLFrameElement_slots {
  HTMLFRAMEELEMENT_FRAMEBORDER = -11,
  HTMLFRAMEELEMENT_LONGDESC = -12,
  HTMLFRAMEELEMENT_MARGINHEIGHT = -13,
  HTMLFRAMEELEMENT_MARGINWIDTH = -14,
  HTMLFRAMEELEMENT_NAME = -15,
  HTMLFRAMEELEMENT_NORESIZE = -16,
  HTMLFRAMEELEMENT_SCROLLING = -17,
  HTMLFRAMEELEMENT_SRC = -18
};
