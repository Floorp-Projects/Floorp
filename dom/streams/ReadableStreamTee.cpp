...
void ForwardReaderError(TeeState* aTeeState,
                        ReadableStreamGenericReader* aThisReader) {
  aThisReader->ClosedPromise()->AppendNativeHandler(new NativeThenHandler(
      nullptr,
      [](JSContext* aCx, JS::Handle<JS::Value> aValue, ErrorResult& aRv,
         TeeState* aTeeState, ReadableStreamGenericReader* aThisReader)
          -> already_AddRefed<Promise> { return nullptr; },
      [](JSContext* aCx, JS::Handle<JS::Value> aValue, ErrorResult& aRv,
         TeeState* aTeeState,
         ReadableStreamGenericReader* aReader) -> already_AddRefed<Promise> {
        // Step 14.1.1
