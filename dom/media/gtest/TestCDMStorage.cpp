...
{
  RefPtr<CDMStorageTest> runner = new CDMStorageTest();
  runner->DoTest(&CDMStorageTest::TestMatchBaseDomain_MatchOrigin);
}

TEST(GeckoMediaPlugins, MatchBaseDomain_MatchTLD)
{
  RefPtr<CDMStorageTest> runner = new CDMStorageTest();
  runner->DoTest(&CDMStorageTest::TestMatchBaseDomain_MatchTLD);
}

TEST(GeckoMediaPlugins, MatchBaseDomain_NoMatch)
{
  RefPtr<CDMStorageTest> runner = new CDMStorageTest();
  runner->DoTest(&CDMStorageTest::TestMatchBaseDomain_NoMatch);
}
