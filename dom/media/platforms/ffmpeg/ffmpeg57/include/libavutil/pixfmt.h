...
#define AV_PIX_FMT_XVMC AV_PIX_FMT_XVMC_MPEG2_IDCT
  ...
  AV_PIX_FMT_YUVA420P,  ///< planar YUV 4:2:0, 20bpp, (1 Cr & Cb sample per 2x2
                        ///< Y & A samples)
#if FF_API_VDPAU
  AV_PIX_FMT_VDPAU_H264,  ///< H.264 HW decoding with VDPAU, data[0] contains a
                          ///< vdpau_render_state struct which contains the
                          ///< bitstream of the slices as well as various fields
                          ///< extracted from headers
  AV_PIX_FMT_VDPAU_MPEG1,  ///< MPEG-1 HW decoding with VDPAU, data[0] contains
                           ///< a vdpau_render_state struct which contains the
                           ///< bitstream of the slices as well as various
                           ///< fields extracted from headers
  AV_PIX_FMT_VDPAU_MPEG2,  ///< MPEG-2 HW decoding with VDPAU, data[0] contains
                           ///< a vdpau_render_state struct which contains the
                           ///< bitstream of the slices as well as various
                           ///< fields extracted from headers
  ...
  AV_PIX_FMT_VAAPI_MOCO,  ///< HW acceleration through VA API at motion
                          ...
                          ///< contains macroblocks as well as various fields
                          ///< extracted from headers
  ...
  AV_PIX_FMT_VAAPI_VLD,   ///< HW decoding through VA API, Picture.data[3]
                          ///< contains a vaapi_render_state struct which
                          ///< contains the bitstream of the slices as well as
...
#if FF_API_VDPAU
  AV_PIX_FMT_VDPAU_MPEG4,  ///< MPEG4 HW decoding with VDPAU, data[0] contains a
                           ///< vdpau_render_state struct which contains the
                           ///< bitstream of the slices as well as various
                           ///< fields extracted from headers
#endif
  ...
  AV_PIX_FMT_VDA,  ///< HW acceleration through VDA, data[3] contains a
                   ///< CVPixelBufferRef
  ...
  AV_PIX_FMT_D3D11VA_VLD,  ///< HW decoding through Direct3D11, Picture.data[3]
                           ///< contains a ID3D11VideoDecoderOutputView pointer

  AV_PIX_FMT_0RGB =
      0x123 + 4,  ///< packed RGB 8:8:8, 32bpp, XRGBXRGB...   X=unused/undefined
