...
class VideoSessionConduit : public MediaSessionConduit {
 public:
  ...
  virtual Maybe<webrtc::VideoReceiveStreamInterface::Stats> GetReceiverStats() const = 0;
...
class AudioSessionConduit : public MediaSessionConduit {
 public:
  ...
  virtual Maybe<webrtc::AudioReceiveStreamInterface::Stats> GetReceiverStats() const = 0;
