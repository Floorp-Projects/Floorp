...
/*
  ...
  Invokes the addr2line process to convert library +offset pairs into
  filepath:line values.
...
public class Addr2Line {
	...
	stderr = new BufferedReader(new InputStreamReader(addr2line.getErrorStream()));
    }

    public String getLine(String address) throws IOException {
	stdin.write(address + "\n"); stdin.flush();
	String symbol = stdout.readLine();
	String source = stdout.readLine();
