...
static NS_DEFINE_IID(kISecureJNI2IID, NS_ISECUREJNI2_IID);
...
{
	CSecureJNI2* secureEnv = NULL;
	jmethodID yieldMethod = NULL;
	jmethodID sleepMethod = NULL;
	
	jclass clazz = env->GetObjectClass(self);
	if (clazz != NULL) {
		// the field fSecureEnv contains a pointer to a CSecureJNI2.
		jfieldID fSecureEnvField = env->GetFieldID(clazz, "fSecureEnv", "I");
		if (fSecureEnvField != NULL) {
			secureEnv = (CSecureJNI2*) env->GetIntField(self, fSecureEnvField);
		}
 ...
 * are processed in.
 */
static void CreateJNIThread(CSecureJNI2* secureEnv)
{
...
class CreateNativeThreadMessage : public NativeMessage {
	nsresult* mResult;
	PRUint32* mThreadID;
	CSecureJNI2* mSecureEnv;
public:
	CreateNativeThreadMessage(nsresult* outResult, PRUint32* outThreadID, CSecureJNI2* secureEnv)
 ...
 */
static void CreateNativeThread(CSecureJNI2* secureEnv)
{
	nsresult result;
	PRUint32 threadID;
	MRJSession* session = secureEnv->getSession();
 ...
 */
void CSecureJNI2::sendMessageToJava(JavaMessage* msg)
{
 ...
 */
void CSecureJNI2::sendMessageFromJava(JNIEnv* javaEnv, JavaMessage* msg, Boolean busyWaiting)
{
...
NS_IMPL_AGGREGATED(CSecureJNI2);

NS_METHOD
CSecureJNI2::AggregatedQueryInterface(const nsIID& aIID, void** aInstancePtr)
{
    ...
    if (aIID.Equals(kISecureJNI2IID)) {
        *aInstancePtr = (nsISecureJNI2*) this;
        AddRef();
        return NS_OK;
    }
...
// notes :
//
CSecureJNI2::CSecureJNI2(nsISupports *aOuter, MRJPlugin* plugin, JNIEnv* proxyEnv, JNIEnv* javaEnv)
...
// CSecureJNI2::~CSecureJNI2
///=--------------------------------------------------------------------------=
// Implements the CSecureJNI2 object for creating object, invoking method, 
// getting/setting field in JNI with security context.
//
// parameters :
//
...
void CSecureJNI2::initialize(JNIEnv* javaEnv, jboolean* isRunning, JavaMessageQueue* javaQueue, JavaMessageQueue* nativeQueue)
{
	mJavaEnv = javaEnv;
	mIsRunning = isRunning;
...
// CSecureJNI2::Create
///=--------------------------------------------------------------------------=
// Create the CSecureJNI2 object for creating object, invoking method, 
// getting/setting field in JNI with security context.
//
// parameters :
//
...
//
NS_METHOD
CSecureJNI2::Create(nsISupports* outer, MRJPlugin* plugin, JNIEnv* proxyEnv, const nsIID& aIID, void* *aInstancePtr)
{
	if (outer && !aIID.Equals(kISupportsIID))
	    return NS_NOINTERFACE;   // XXX right error?
	CSecureJNI2* secureEnv = new CSecureJNI2(outer, plugin, proxyEnv);
	if (secureEnv == NULL)
	    return NS_ERROR_OUT_OF_MEMORY;
	secureEnv->AddRef();
	// *aInstancePtr = jni->GetInner();
	*aInstancePtr = (outer != NULL) ? (void*)secureEnv->GetInner() : (void*)secureEnv;
	return NS_OK;
}
...
NS_IMETHODIMP CSecureJNI2::NewObject(/*[in]*/  jclass clazz, 
...
NS_IMETHODIMP CSecureJNI2::CallMethod(/*[in]*/  jni_type type,
                                      /*[in]*/  jobject obj, 
                                      /*[in]*/  jmethodID methodID, 
                                      /*[in]*/  jvalue *args, 
                                      /*[out]*/ jvalue* result,
...
///=--------------------------------------------------------------------------=
// CSecureJNI2::CallNonvirtualMethod
///=--------------------------------------------------------------------------=
...
NS_IMETHODIMP CSecureJNI2::CallNonvirtualMethod(/*[in]*/  jni_type type,
                                                /*[in]*/  jobject obj, 
                                                /*[in]*/  jclass clazz,
                                                /*[in]*/  jmethodID methodID,
                                                /*[in]*/  jvalue *args, 
...
NS_IMETHODIMP CSecureJNI2::GetField(/*[in]*/  jni_type type,
                                    /*[in]*/  jobject obj, 
                                    /*[in]*/  jfieldID fieldID,
                                    /*[out]*/ jvalue* result,
                                    /*[in]*/  nsISecurityContext* ctx)
...
// @param ctx        -- security context 
//
NS_IMETHODIMP CSecureJNI2::SetField(/*[in]*/ jni_type type,
                                    /*[in]*/ jobject obj, 
                                    /*[in]*/ jfieldID fieldID,
                                    /*[in]*/ jvalue val,
                                    /*[in]*/ nsISecurityContext* ctx)
...
NS_IMETHODIMP CSecureJNI2::CallStaticMethod(/*[in]*/  jni_type type,
                                            /*[in]*/  jclass clazz,
                                            /*[in]*/  jmethodID methodID,
                                            /*[in]*/  jvalue *args, 
                                            /*[out]*/ jvalue* result,
...
NS_IMETHODIMP CSecureJNI2::GetStaticField(/*[in]*/  jni_type type,
                                          /*[in]*/  jclass clazz, 
                                          /*[in]*/  jfieldID fieldID,
                                          /*[out]*/ jvalue* result,
                                          /*[in]*/  nsISecurityContext* ctx)
...
// @param ctx        -- security context 
//
NS_IMETHODIMP CSecureJNI2::SetStaticField(/*[in]*/  jni_type type,
                                          /*[in]*/ jclass clazz, 
                                          /*[in]*/ jfieldID fieldID,
                                          /*[in]*/ jvalue val,
                                          /*[in]*/ nsISecurityContext* ctx)
...
NS_IMETHODIMP CSecureJNI2::GetVersion(/*[out]*/ jint* version) 
{
    if (version == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::DefineClass(/*[in]*/  const char* name,
                                       /*[in]*/  jobject loader,
                                       /*[in]*/  const jbyte *buf,
                                       /*[in]*/  jsize len,
                                       /*[out]*/ jclass* clazz) 
...
NS_IMETHODIMP CSecureJNI2::FindClass(/*[in]*/  const char* name, 
                                     /*[out]*/ jclass* clazz) 
{
    if (clazz == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetSuperclass(/*[in]*/  jclass sub,
                                         /*[out]*/ jclass* super) 
{
...
NS_IMETHODIMP CSecureJNI2::IsAssignableFrom(/*[in]*/  jclass sub,
                                            /*[in]*/  jclass super,
                                            /*[out]*/ jboolean* result) 
{
...
NS_IMETHODIMP CSecureJNI2::Throw(/*[in]*/  jthrowable obj,
                                 /*[out]*/ jint* result) 
{
	if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::ThrowNew(/*[in]*/  jclass clazz,
                                    /*[in]*/  const char *msg,
                                    /*[out]*/ jint* result) 
{
    if (mJavaEnv == NULL || result == NULL)
...
NS_IMETHODIMP CSecureJNI2::ExceptionOccurred(/*[out]*/ jthrowable* result)
{
	if (mJavaEnv == NULL || result == NULL)
		return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::ExceptionDescribe(void)
{
	if (mJavaEnv == NULL)
		return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::ExceptionClear(void)
{
...
NS_IMETHODIMP CSecureJNI2::FatalError(/*[in]*/ const char* msg)
{
 ...
 */
NS_IMETHODIMP CSecureJNI2::NewGlobalRef(/*[in]*/  jobject localRef, 
                                        /*[out]*/ jobject* result)
{
    if (result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::DeleteGlobalRef(/*[in]*/ jobject globalRef) 
{
	JNIEnv* env = mSession->getCurrentEnv();
...
NS_IMETHODIMP CSecureJNI2::IsSameObject(/*[in]*/  jobject obj1,
                                        /*[in]*/  jobject obj2,
                                        /*[out]*/ jboolean* result) 
{
    if (mJavaEnv == NULL || result == NULL)
...
NS_IMETHODIMP CSecureJNI2::AllocObject(/*[in]*/  jclass clazz,
                                       /*[out]*/ jobject* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetObjectClass(/*[in]*/  jobject obj,
                                          /*[out]*/ jclass* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::IsInstanceOf(/*[in]*/  jobject obj,
                                        /*[in]*/  jclass clazz,
                                        /*[out]*/ jboolean* result) 
{
    if (mJavaEnv == NULL || result == NULL)
...
NS_IMETHODIMP CSecureJNI2::GetMethodID(/*[in]*/  jclass clazz, 
                                       /*[in]*/  const char* name,
                                       /*[in]*/  const char* sig,
...
NS_IMETHODIMP CSecureJNI2::GetFieldID(/*[in]*/  jclass clazz, 
                                      /*[in]*/  const char* name,
                                      /*[in]*/  const char* sig,
                                      /*[out]*/ jfieldID* result) 
{
...
NS_IMETHODIMP CSecureJNI2::GetStaticMethodID(/*[in]*/  jclass clazz, 
                                             /*[in]*/  const char* name,
                                             /*[in]*/  const char* sig,
                                             /*[out]*/ jmethodID* result)
{
...
NS_IMETHODIMP CSecureJNI2::GetStaticFieldID(/*[in]*/  jclass clazz, 
                                            /*[in]*/  const char* name,
                                            /*[in]*/  const char* sig,
                                            /*[out]*/ jfieldID* result) 
{
 ...
 * To give proper "local" refs, need to run this in the true thread.
 */
NS_IMETHODIMP CSecureJNI2::NewString(/*[in]*/  const jchar* unicode,
                                     /*[in]*/  jsize len,
                                     /*[out]*/ jstring* result) 
{
    if (result == NULL)
...
NS_IMETHODIMP CSecureJNI2::GetStringLength(/*[in]*/  jstring str,
                                           /*[out]*/ jsize* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetStringChars(/*[in]*/  jstring str,
                                          /*[in]*/  jboolean *isCopy,
...
NS_IMETHODIMP CSecureJNI2::ReleaseStringChars(/*[in]*/  jstring str,
...
NS_IMETHODIMP CSecureJNI2::NewStringUTF(/*[in]*/  const char *utf,
                                        /*[out]*/ jstring* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetStringUTFLength(/*[in]*/  jstring str,
                                              /*[out]*/ jsize* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetStringUTFChars(/*[in]*/  jstring str,
                                             /*[in]*/  jboolean *isCopy,
...
NS_IMETHODIMP CSecureJNI2::ReleaseStringUTFChars(/*[in]*/  jstring str,
                                                 /*[in]*/  const char *chars) 
{
    if (mJavaEnv == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetArrayLength(/*[in]*/  jarray array,
                                          /*[out]*/ jsize* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::NewObjectArray(/*[in]*/  jsize len,
										/*[in]*/  jclass clazz,
					                    /*[in]*/  jobject init,
...
NS_IMETHODIMP CSecureJNI2::GetObjectArrayElement(/*[in]*/  jobjectArray array,
                                                 /*[in]*/  jsize index,
                                                 /*[out]*/ jobject* result)
{
    if (mJavaEnv == NULL || result == NULL)
...
NS_IMETHODIMP CSecureJNI2::SetObjectArrayElement(/*[in]*/  jobjectArray array,
                                                 /*[in]*/  jsize index,
                                                 /*[in]*/  jobject val) 
{
    if (mJavaEnv == NULL)
...
NS_IMETHODIMP CSecureJNI2::NewArray(/*[in]*/ jni_type element_type,
                        			/*[in]*/  jsize len,
                        			/*[out]*/ jarray* result) 
{
    if (mJavaEnv == NULL || result == NULL)
...
NS_IMETHODIMP CSecureJNI2::GetArrayElements(/*[in]*/  jni_type type,
                                            /*[in]*/  jarray array,
                                            /*[in]*/  jboolean *isCopy,
                                            /*[out]*/ void* result)
{
...
NS_IMETHODIMP CSecureJNI2::ReleaseArrayElements(/*[in]*/ jni_type type,
                                                /*[in]*/ jarray array,
                                                /*[in]*/ void *elems,
                                                /*[in]*/ jint mode) 
{
...
NS_IMETHODIMP CSecureJNI2::GetArrayRegion(/*[in]*/  jni_type type,
                                          /*[in]*/  jarray array,
                                          /*[in]*/  jsize start,
                                          /*[in]*/  jsize len,
                                          /*[out]*/ void* buf)
...
NS_IMETHODIMP CSecureJNI2::SetArrayRegion(/*[in]*/  jni_type type,
                                          /*[in]*/  jarray array,
                                          /*[in]*/  jsize start,
                                          /*[in]*/  jsize len,
                                          /*[in]*/  void* buf) 
...
NS_IMETHODIMP CSecureJNI2::RegisterNatives(/*[in]*/  jclass clazz,
...
NS_IMETHODIMP CSecureJNI2::UnregisterNatives(/*[in]*/  jclass clazz,
                                             /*[out]*/ jint* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::MonitorEnter(/*[in]*/  jobject obj,
                                        /*[out]*/ jint* result) 
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::MonitorExit(/*[in]*/  jobject obj,
                                       /*[out]*/ jint* result)
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
NS_IMETHODIMP CSecureJNI2::GetJavaVM(/*[in]*/  JavaVM **vm,
                                     /*[out]*/ jint* result)
{
    if (mJavaEnv == NULL || result == NULL)
        return NS_ERROR_NULL_POINTER;
...
void CSecureJNI2::messageLoop(JNIEnv* env, JavaMessage* msg, JavaMessageQueue* sendQueue, JavaMessageQueue* receiveQueue, Boolean busyWaiting)
{
