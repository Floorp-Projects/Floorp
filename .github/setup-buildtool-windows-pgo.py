...
commands_list = [
    [
        r"wget -O - https://firefox-ci-tc.services.mozilla.com/api/index/v1/task/gecko.cache.level-1.toolchains.v3.linux64-wine.latest/artifacts/public%2Fbuild%2Fwine.tar.zst | tar --zstd -xv -C $RUNNER_USERDIR/win-crosstool"
    ],
    [
        r"wget -O - https://firefox-ci-tc.services.mozilla.com/api/index/v1/task/gecko.cache.level-3.toolchains.v3.linux64-liblowercase.latest/artifacts/public%2Fbuild%2Fliblowercase.tar.zst | tar --zstd -xv -C $RUNNER_USERDIR/win-crosstool"
    ],
    [
    ...
    [
        r"wget -O - https://firefox-ci-tc.services.mozilla.com/api/index/v1/task/gecko.cache.level-3.toolchains.v3.linux64-rust-windows-1.64.latest/artifacts/public%2Fbuild%2Frustc.tar.zst | tar --zstd -xv -C $RUNNER_USERDIR/win-crosstool"
    ],
    [
