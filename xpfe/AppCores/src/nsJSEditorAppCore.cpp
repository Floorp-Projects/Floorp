...
GetEditorAppCoreProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp)
{
  ...
  if (JSVAL_IS_INT(id)) {
    ...
    switch(JSVAL_TO_INT(id)) {
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.contentsastext", &ok);
        if (!ok) {
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.contentsashtml", &ok);
        if (!ok) {
          //Need to throw error here
          return JS_FALSE;
        }
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.editordocument", &ok);
        if (!ok) {
          //Need to throw error here
          return JS_FALSE;
        }
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.editorselection", &ok);
        if (!ok) {
          //Need to throw error here
          return JS_FALSE;
        }
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.paragraphformat", &ok);
        if (!ok) {
          //Need to throw error here
          return JS_FALSE;
        }
      ...
      {
        secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.wrapcolumn", &ok);
        if (!ok) {
          //Need to throw error here
          return JS_FALSE;
        }
...
EditorAppCoreSetEditorType(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.seteditortype", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetTextProperty(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.settextproperty", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreRemoveTextProperty(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.removetextproperty", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreGetTextProperty(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.gettextproperty", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetBodyAttribute(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setbodyattribute", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetBackgroundColor(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setbackgroundcolor", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreGetLocalFileURL(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.getlocalfileurl", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetParagraphFormat(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setparagraphformat", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreLoadUrl(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.loadurl", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreNewWindow(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.newwindow", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreOpen(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.open", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSave(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.save", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSaveAs(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.saveas", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreCloseWindow(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.closewindow", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCorePrint(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.print", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreExit(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.exit", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreUndo(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.undo", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreRedo(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.redo", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreCut(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.cut", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreCopy(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.copy", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCorePaste(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.paste", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSelectAll(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.selectall", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreFind(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.find", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreFindNext(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.findnext", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreBeginBatchChanges(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.beginbatchchanges", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreEndBatchChanges(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.endbatchchanges", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertText(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.inserttext", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertLink(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.insertlink", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertImage(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.insertimage", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertList(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.insertlist", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreIndent(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.indent", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreAlign(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.align", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreGetSelectedElement(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.getselectedelement", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreCreateElementWithDefaults(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.createelementwithdefaults", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertElement(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.insertelement", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreInsertLinkAroundSelection(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.insertlinkaroundselection", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSelectElement(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.selectelement", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetCaretAfterElement(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setcaretafterelement", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetToolbarWindow(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.settoolbarwindow", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetContentWindow(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setcontentwindow", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
EditorAppCoreSetWebShellWindow(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.setwebshellwindow", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
...
//
// Native method StartSpellChecking
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreStartSpellChecking(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString nativeRet;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.startspellchecking", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->StartSpellChecking(nativeRet)) {
      return JS_FALSE;
    }
...
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreGetNextMisspelledWord(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString nativeRet;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.getnextmisspelledword", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->GetNextMisspelledWord(nativeRet)) {
      return JS_FALSE;
    }
    ...
    JS_ReportError(cx, "Function getNextMisspelledWord requires 0 parameters");
    return JS_FALSE;
  }
...
//
// Native method GetSuggestedWord
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreGetSuggestedWord(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString nativeRet;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.getsuggestedword", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->GetSuggestedWord(nativeRet)) {
      return JS_FALSE;
    }
    ...
    JS_ReportError(cx, "Function getSuggestedWord requires 0 parameters");
    return JS_FALSE;
  }
...
//
// Native method CheckCurrentWord
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreCheckCurrentWord(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  PRBool nativeRet;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.checkcurrentword", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 1) {
    ...
    if (NS_OK != nativeThis->CheckCurrentWord(b0, &nativeRet)) {
      return JS_FALSE;
    }
    ...
    *rval = BOOLEAN_TO_JSVAL(nativeRet);
    ...
    JS_ReportError(cx, "Function checkCurrentWord requires 1 parameters");
    return JS_FALSE;
  }
...
//
// Native method ReplaceWord
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreReplaceWord(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString b0;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.replaceword", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 3) {
    ...
    if (NS_OK != nativeThis->ReplaceWord(b0, b1, b2)) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function replaceWord requires 3 parameters");
    return JS_FALSE;
  }
...
//
// Native method IgnoreWordAllOccurrences
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreIgnoreWordAllOccurrences(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString b0;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.ignorewordalloccurrences", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 1) {
    ...
    if (NS_OK != nativeThis->IgnoreWordAllOccurrences(b0)) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function ignoreWordAllOccurrences requires 1 parameters");
    return JS_FALSE;
  }
...
//
// Native method AddWordToDictionary
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreAddWordToDictionary(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString b0;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.addwordtodictionary", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 1) {
    ...
    if (NS_OK != nativeThis->AddWordToDictionary(b0)) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function addWordToDictionary requires 1 parameters");
    return JS_FALSE;
  }
...
//
// Native method RemoveWordFromDictionary
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreRemoveWordFromDictionary(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString b0;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.removewordfromdictionary", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 1) {
    ...
    if (NS_OK != nativeThis->RemoveWordFromDictionary(b0)) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function removeWordFromDictionary requires 1 parameters");
    return JS_FALSE;
  }
...
//
// Native method GetPersonalDictionaryWord
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreGetPersonalDictionaryWord(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  nsAutoString nativeRet;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.getpersonaldictionaryword", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->GetPersonalDictionaryWord(nativeRet)) {
      return JS_FALSE;
    }
    ...
    JS_ReportError(cx, "Function getPersonalDictionaryWord requires 0 parameters");
    return JS_FALSE;
  }
...
//
// Native method CloseSpellChecking
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreCloseSpellChecking(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.closespellchecking", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->CloseSpellChecking()) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function closeSpellChecking requires 0 parameters");
    return JS_FALSE;
  }
...
//
// Native method RunUnitTests
//
PR_STATIC_CALLBACK(JSBool)
EditorAppCoreRunUnitTests(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
  nsIDOMEditorAppCore *nativeThis = (nsIDOMEditorAppCore*)JS_GetPrivate(cx, obj);
  JSBool rBool = JS_FALSE;
  ...
  *rval = JSVAL_NULL;
  ...
  if (NS_OK == scriptCX->GetSecurityManager(&secMan)) {
    PRBool ok;
    secMan->CheckScriptAccess(scriptCX, obj, "editorappcore.rununittests", &ok);
    if (!ok) {
      //Need to throw error here
      return JS_FALSE;
    }
  ...
  if (argc >= 0) {
    ...
    if (NS_OK != nativeThis->RunUnitTests()) {
      return JS_FALSE;
    }
    ...
    *rval = JSVAL_VOID;
    ...
    JS_ReportError(cx, "Function runUnitTests requires 0 parameters");
    return JS_FALSE;
  }
...
static JSFunctionSpec EditorAppCoreMethods[] = 
{
  ...
  {"replaceWord",          EditorAppCoreReplaceWord,     3},
  {"ignoreWordAllOccurrences",          EditorAppCoreIgnoreWordAllOccurrences,     1},
  {"addWordToDictionary",          EditorAppCoreAddWordToDictionary,     1},
  {"removeWordFromDictionary",          EditorAppCoreRemoveWordFromDictionary,     1},
  {"getPersonalDictionaryWord",          EditorAppCoreGetPersonalDictionaryWord,     0},
  {"closeSpellChecking",          EditorAppCoreCloseSpellChecking,     0},
  {"runUnitTests",          EditorAppCoreRunUnitTests,     0},
  {0}
};
