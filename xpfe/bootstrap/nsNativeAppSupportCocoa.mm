...
class nsSplashScreenCocoa : public nsISplashScreen,
                          public nsIObserver
{
public:
...
{
printf("-- nsSplashScreenCocoa::Show()\n");
#if 0
...
NS_IMETHODIMP
nsSplashScreenCocoa::Hide()
{
printf("-- nsSplashScreenCocoa::Hide()\n");
#if 0
  if (mDialog)
  {
...
NS_IMETHODIMP
nsSplashScreenCocoa::Observe(nsISupports *aSubject, const char *aTopic, const PRUnichar *someData)
{
...
{
  if ( aResult ) {  
      *aResult = new nsSplashScreenCocoa;
      if ( *aResult ) {
          NS_ADDREF( *aResult );
          return NS_OK;
      } else {
