...
resource 'STR#' (5000, "English") {
  {
    ...
    "You are about to install Mozilla Sunbird.\n"
    "\n"
...
data 'TEXT' (5000, "English") {
  ...
  "Version 1.1\n"
  "\n"
  "A SOURCE CODE VERSION OF CERTAIN SUNBIRD CALENDAR FUNCTIONALITY THAT YOU MAY USE, MODIFY AND DISTRIBUTE IS AVAILABLE TO YOU FREE-OF-CHARGE FROM WWW.MOZILLA.ORG UNDER THE MOZILLA PUBLIC LICENSE and other open source software licenses.\n"
  "\n"
  "The accompanying executable code version of Mozilla Sunbird and related documentation (the “Product”) is made available to you under the terms of this MOZILLA SUNBIRD END-USER SOFTWARE LICENSE AGREEMENT (THE “AGREEMENT”). BY CLICKING THE “ACCEPT” BUTTON, OR BY INSTALLING OR USING THE MOZILLA SUNBIRD CALENDAR, YOU ARE CONSENTING TO BE BOUND BY THE AGREEMENT. IF YOU DO NOT AGREE TO THE TERMS AND CONDITIONS OF THIS AGREEMENT, DO NOT CLICK THE “ACCEPT” BUTTON, AND DO NOT INSTALL OR USE ANY PART OF THE MOZILLA SUNBIRD CALENDAR.\n"
  "\n"
  "DURING THE MOZILLA SUNBIRD INSTALLATION PROCESS, AND AT LATER TIMES, YOU MAY BE GIVEN THE OPTION OF INSTALLING ADDITIONAL COMPONENTS FROM THIRD-PARTY SOFTWARE PROVIDERS. THE INSTALLATION AND USE OF THOSE THIRD-PARTY COMPONENTS MAY BE GOVERNED BY ADDITIONAL LICENSE AGREEMENTS.\n"
  "\n"
