...
add_task(async function() {
  ...
  const tests = [
    ...
    ["Button menu with no name", "#buttonmenu-3",
    ...
    ["<canvas> with no name", "#canvas-1", { score: FAIL, issue: IMAGE_NO_NAME }],
    ["<canvas> with aria-label", "#canvas-2", null],
    ["<canvas> with aria-labelledby", "#canvas-3", null],
    ["<canvas> with inner content", "#canvas-4", { score: FAIL, issue: IMAGE_NO_NAME }],
    ["Checkbox with no name", "#checkbox-1", { score: FAIL, issue: FORM_NO_NAME }],
    ["Checkbox with unrelated label", "#checkbox-2",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Checkbox nested inside a <label>", "#checkbox-3", null],
    ["Checkbox with a label", "#checkbox-4", null],
    ["Checkbox with aria-label", "#checkbox-5",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Checkbox with aria-labelledby visible label", "#checkbox-6", null],
    ["Empty aria checkbox", "#checkbox-7", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria checkbox with aria-label", "#checkbox-8",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ...
    ["Menuitem checkbox with unlabelled inner content", "#menuitemcheckbox-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Empty menuitem checkbox", "#menuitemcheckbox-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Menuitem checkbox with no textual inner content", "#menuitemcheckbox-4",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Menuitem checkbox with labelled inner content", "#menuitemcheckbox-5", null],
    ["Menuitem checkbox with white space inner content", "#menuitemcheckbox-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Column header with inner content", "#columnheader-1", null],
    ["Empty column header", "#columnheader-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Column header with white space inner content", "#columnheader-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Column header with aria-label", "#columnheader-4", null],
    ["Column header with empty aria-label", "#columnheader-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Column header with white space aria-label", "#columnheader-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Column header with aria-labelledby", "#columnheader-7", null],
    ["Aria column header with inner content", "#columnheader-8", null],
    ["Empty aria column header", "#columnheader-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria column header with white space inner content", "#columnheader-10",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria column header with aria-label", "#columnheader-11", null],
    ["Aria column header with empty aria-label", "#columnheader-12",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria column header with white space aria-label", "#columnheader-13",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria column header with aria-labelledby", "#columnheader-14", null],
    ["Combobox with a <label>", "#combobox-1", null],
    ["Combobox with no label", "#combobox-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["Combobox with unrelated label", "#combobox-3",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Combobox nested inside a label", "#combobox-4", null],
    ["Combobox with aria-label", "#combobox-5",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Combobox with aria-labelledby a visible label", "#combobox-6", null],
    ["Combobox option with inner content", "#combobox-option-1", null],
    ["Combobox option with no inner content", "#combobox-option-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Combobox option with white string inner content", "#combobox-option-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Combobox option with label attribute", "#combobox-option-4", null],
    ["Combobox option with empty label attribute", "#combobox-option-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Combobox option with white string label attribute", "#combobox-option-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Svg diagram with no name", "#diagram-1", { score: FAIL, issue: IMAGE_NO_NAME }],
    ["Svg diagram with empty aria-label", "#diagram-2",
      { score: FAIL, issue: IMAGE_NO_NAME }],
    ["Svg diagram with aria-label", "#diagram-3", null],
    ["Svg diagram with aria-labelledby", "#diagram-4", null],
    ["Svg diagram with aria-labelledby an element with empty content", "#diagram-5",
      { score: FAIL, issue: IMAGE_NO_NAME }],
    ["Dialog with no name", "#dialog-1",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Dialog with empty aria-label", "#dialog-2",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Dialog with aria-label", "#dialog-3", null],
    ["Dialog with aria-labelledby", "#dialog-4", null],
    ["Aria dialog with no name", "#dialog-5",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Aria dialog with empty aria-label", "#dialog-6",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Aria dialog with aria-label", "#dialog-7", null],
    ["Aria dialog with aria-labelledby", "#dialog-8", null],
    ["Dialog with aria-labelledby an element with empty content", "#dialog-9",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Aria dialog with aria-labelledby an element with empty content", "#dialog-10",
      { score: BEST_PRACTICES, issue: DIALOG_NO_NAME }],
    ["Edit combobox with no name", "#editcombobox-1",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Edit combobox with aria-label", "#editcombobox-2",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Edit combobox with aria-labelled a visible label", "#editcombobox-3", null],
    ["Input nested inside a <label>", "#entry-1", null],
    ["Input with no name", "#entry-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["Input with aria-label", "#entry-3", { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Input with unrelated <label>", "#entry-4", { score: FAIL, issue: FORM_NO_NAME }],
    ["Input with <label>", "#entry-5", null],
    ["Input with aria-labelledby", "#entry-6", null],
    ["Aria textbox with no name", "#entry-7", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria textbox with aria-label", "#entry-8",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Aria textbox with aria-labelledby", "#entry-9", null],
    ["Figure with <figcaption>", "#figure-1", null],
    ["Figore with no <figcaption>", "#figure-2",
      { score: BEST_PRACTICES, issue: FIGURE_NO_NAME }],
    ["Aria figure with aria-labelledby", "#figure-3", null],
    ["Aria figure with aria-labelledby an element with empty content", "#figure-4",
      { score: BEST_PRACTICES, issue: FIGURE_NO_NAME }],
    ["Aria figure with no name", "#figure-5",
      { score: BEST_PRACTICES, issue: FIGURE_NO_NAME }],
    ...
    ["Image with aria-labelledby an element with empty content", "#img-6",
      { score: FAIL, issue: IMAGE_NO_NAME }],
    ["Aria image with no name", "#img-7", { score: FAIL, issue: IMAGE_NO_NAME }],
    ...
    ["<iframe> with empty title", "#iframe-2",
      { score: FAIL, issue: IFRAME_NO_NAME_FROM_TITLE }],
    ["<iframe> with no title", "#iframe-3",
      { score: FAIL, issue: IFRAME_NO_NAME_FROM_TITLE }],
    ["<iframe> with aria-label", "#iframe-4",
      { score: FAIL, issue: IFRAME_NO_NAME_FROM_TITLE }],
    ["<iframe> with aria-label and title", "#iframe-5",
      { score: FAIL, issue: IFRAME_NO_NAME_FROM_TITLE }],
    ["<object> with image data type and no name", "#object-1",
      { score: FAIL, issue: IMAGE_NO_NAME }],
    ...
    ["<embed> with image data type and no name", "#embed-1",
      { score: FAIL, issue: IMAGE_NO_NAME }],
    ["<embed> with video data type and no name", "#embed-2",
    ...
    ["Link with no inner content", "#link-1",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Link with inner content", "#link-2", null],
    ["Link with href and no inner content", "#link-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Link with href and inner content", "#link-4", null],
    ["Link with empty href and no inner content", "#link-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Link with empty href and inner content", "#link-6", null],
    ["Link with # href and no inner content", "#link-7",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Link with # href and inner content", "#link-8", null],
    ["Link with non empty href and no inner content", "#link-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ...
    ["Aria link with no inner content", "#link-13",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ...
    ["<select> with no name", "#listbox-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["<select> with unrelated <label>", "#listbox-3",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["<select> nested inside a <label>", "#listbox-4", null],
    ["<select> with aria-label", "#listbox-5",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["<select> with aria-labelledby a visible element", "#listbox-6", null],
    ["MathML glyph with no name", "#mglyph-1",
    ...
    ["MathML glyph with empty alt text", "#mglyph-5",
      { score: FAIL, issue: MATHML_GLYPH_NO_NAME }],
    ["MathML glyph with aria-labelledby an element with no inner content", "#mglyph-6",
      { score: FAIL, issue: MATHML_GLYPH_NO_NAME }],
    ["Aria menu item with no name", "#menuitem-1",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria menu item with empty aria-label", "#menuitem-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ...
    ["Aria menu item with aria-labelledby element with empty inner content",
     "#menuitem-5", { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria menu item with inner content", "#menuitem-6", null],
    ["Option with inner content", "#option-1", null],
    ["Option with no inner content", "#option-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Option with white space inner ", "#option-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Option with a label", "#option-4", null],
    ["Option with an empty label", "#option-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Option with a white space label", "#option-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with inner content", "#option-7", null],
    ["Aria option with no inner content", "#option-8",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with white space inner content", "#option-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with aria-label", "#option-10", null],
    ["Aria option with empty aria-label", "#option-11",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with white space aria-label", "#option-12",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with aria-labelledby", "#option-13", null],
    ["Aria option with aria-labelledby an element with empty content", "#option-14",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria option with aria-labelledby an element with white space content", "#option-15",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Empty aria treeitem", "#treeitem-1", { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria treeitem with empty aria-label", "#treeitem-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria treeitem with aria-label", "#treeitem-3", null],
    ["Aria treeitem with aria-labelledby", "#treeitem-4", null],
    ["Aria treeitem with aria-labelledby an element with empty content", "#treeitem-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria treeitem with inner content", "#treeitem-6", null],
    ["Aria tab with no content", "#tab-1", { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria tab with empty aria-label", "#tab-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria tab with aria-label", "#tab-3", null],
    ["Aria tab with aria-labelledby", "#tab-4", null],
    ["Aria tab with aria-labelledby an element with empty content", "#tab-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ...
    ["Password with aria-label", "#password-3",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Password with unrelated label", "#password-4",
      { score: FAIL, issue: FORM_NO_NAME }],
    ...
    ["<progress> with no name", "#progress-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["<progress> with aria-label", "#progress-3",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["<progress> with unrelated <label>", "#progress-4",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["<progress> with <label>", "#progress-5", null],
    ["<progress> with aria-labelledby a visible element", "#progress-6", null],
    ["Aria progressbar nested inside a <label>", "#progress-7",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria progressbar with aria-labelledby a visible element", "#progress-8", null],
    ["Aria progressbar no name", "#progress-9", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria progressbar with aria-label", "#progress-10",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Aria progressbar with unrelated <label>", "#progress-11",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria progressbar with <label>", "#progress-12",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria progressbar with aria-labelledby a visible <label>", "#progress-13", null],
    ["Button with inner content", "#button-1", null],
    ["Image button with no name", "#button-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Button with no name", "#button-3", { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Image button with empty alt text", "#button-4",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Image button with alt text", "#button-5", null],
    ["Button with white space inner content", "#button-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Button inside a <label>", "#button-7", null],
    ["Button with aria-label", "#button-8", null],
    ["Button with unrelated <label>", "#button-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Button with <label>", "#button-10", null],
    ["Button with aria-labelledby a visile <label>", "#button-11", null],
    ["Aria button inside a label", "#button-12",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria button with aria-labelled by a <label>", "#button-13", null],
    ["Aria button with no content", "#button-14",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria button with aria-label", "#button-15", null],
    ["Aria button with unrelated <label>", "#button-16",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria button with <label>", "#button-17",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria button with aria-labelledby a visible <label>", "#button-18", null],
    ["Radio nested inside a label", "#radiobutton-1", null],
    ["Radio with no name", "#radiobutton-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["Radio with aria-label", "#radiobutton-3",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Radio with unrelated <label>", "#radiobutton-4",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Radio with visible label>", "#radiobutton-5", null],
    ["Radio with aria-labelledby a visible <label>", "#radiobutton-6", null],
    ["Aria radio with no name", "#radiobutton-7", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria radio with aria-label", "#radiobutton-8",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Aria radio with aria-labelledby a visible element", "#radiobutton-9", null],
    ["Aria menuitemradio with inner content", "#menuitemradio-1", null],
    ["Aria menuitemradio with no inner content", "#menuitemradio-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria menuitemradio with white space inner content", "#menuitemradio-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Rowheader with inner content", "#rowheader-1", null],
    ["Rowheader with no inner content", "#rowheader-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Rowheader with white space inner content", "#rowheader-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Rowheader with aria-label", "#rowheader-4", null],
    ["Rowheader with empty aria-label", "#rowheader-5",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Rowheader with white space aria-label", "#rowheader-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Rowheader with aria-labelledby", "#rowheader-7", null],
    ["Aria rowheader with inner content", "#rowheader-8", null],
    ["Aria rowheader with no inner content", "#rowheader-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria rowheader with white space inner content", "#rowheader-10",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria rowheader with aria-label", "#rowheader-11", null],
    ["Aria rowheader with empty aria-label", "#rowheader-12",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria rowheader with white space aria-label", "#rowheader-13",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ...
    ["Slider with aria-label", "#slider-3",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Slider with unrelated <label>", "#slider-4", { score: FAIL, issue: FORM_NO_NAME }],
    ["Slider with a visible <label>", "#slider-5", null],
    ["Slider with aria-labelled by a visible <label>", "#slider-6", null],
    ["Aria slider with no name", "#slider-7", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria slider with aria-label", "#slider-8",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ...
    ["Number input with no label", "#spinbutton-2", { score: FAIL, issue: FORM_NO_NAME }],
    ["Number input with aria-label", "#spinbutton-3",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Number input with unrelated <label>", "#spinbutton-4",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Number input with visible <label>", "#spinbutton-5", null],
    ["Number input with aria-labelled by a visible <label>", "#spinbutton-6", null],
    ["Aria spinbutton with no name", "#spinbutton-7",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria spinbutton with aria-label", "#spinbutton-8",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Aria spinbutton with aria-labelledby a visible element", "#spinbutton-9", null],
    ["Aria switch with no name", "#switch-1", { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria switch wtih aria-label", "#switch-2",
      { score: WARNING, issue: FORM_NO_VISIBLE_NAME}],
    ["Aria switch with aria-labelledby a visible element", "#switch-3", null],
    ["Aria switch with unrelated <label>", "#switch-4",
      { score: FAIL, issue: FORM_NO_NAME }],
    ["Aria switch nested inside a <label>", "#switch-5",
      { score: FAIL, issue: FORM_NO_NAME }],
    ...
    ["Image toggle button with no name", "#togglebutton-2",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Empty toggle button", "#togglebutton-3",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Image toggle button with empty alt text", "#togglebutton-4",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Image toggle button with alt text", "#togglebutton-5", null],
    ["Toggle button with white space inner content", "#togglebutton-6",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Toggle button nested inside a label", "#togglebutton-7", null],
    ["Toggle button with aria-label", "#togglebutton-8", null],
    ["Toggle button with unrelated <label>", "#togglebutton-9",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Toggle button with <label>", "#togglebutton-10", null],
    ["Toggle button with aria-labelled by a visible <label>", "#togglebutton-11", null],
    ["Aria toggle button nested inside a label", "#togglebutton-12",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria toggle button with aria-labelled by and nested inside a label",
     "#togglebutton-13", null],
    ["Aria toggle button with no name", "#togglebutton-14",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria toggle button with aria-label", "#togglebutton-15", null],
    ["Aria toggle button with unrelated <label>", "#togglebutton-16",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria toggle button with <label>", "#togglebutton-17",
      { score: FAIL, issue: INTERACTIVE_NO_NAME }],
    ["Aria toggle button with aria-labelledby a visible <label>", "#togglebutton-18",
     null],
    ["Non-unique aria toolbar with aria-label", "#toolbar-1", null],
    ["Non-unique aria toolbar with no name (", "#toolbar-2",
      { score: FAIL, issue: TOOLBAR_NO_NAME }],
    ["Non-unique aAria toolbar with aria-labelledby an element with empty content",
     "#toolbar-3", { score: FAIL, issue: TOOLBAR_NO_NAME }],
  ...
  Assert.deepEqual(audit[TEXT_LABEL], { score: FAIL, issue: DOCUMENT_NO_TITLE },
  ...
  Assert.deepEqual(audit[TEXT_LABEL], null, "Audit result for document is correct.");
