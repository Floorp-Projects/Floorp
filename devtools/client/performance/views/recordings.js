...
var RecordingsView = {
   ...
   */
  _onRecordingStateChange(_, state, recording) {
   ...
   */
  _onRecordingDeleted(_, recording) {
  ...
  _onRecordingExported(_, recording, file) {
