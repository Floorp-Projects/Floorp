  ...
  await navigateAndCheckForWarningMessage(
    {
      ...
      text:
        "Public-Key-Pins: The site specified a header that did not include " +
        "a \u2018max-age\u2019 directive.",
    },
    hud
  );
  ...
  await navigateAndCheckForWarningMessage(
    {
      ...
      text:
        "Public-Key-Pins: The site specified a header that included an " +
  ...
  await navigateAndCheckForWarningMessage(
    {
      ...
      text:
        "Public-Key-Pins: The site specified a header that included " +
  ...
  await navigateAndCheckForWarningMessage(
    {
      ...
      text:
        "Public-Key-Pins: The certificate used by the site was not issued " +
