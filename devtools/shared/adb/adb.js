    ...
    const runFSM = function runFSM(data) {
      ...
      switch (state) {
        ...
        case "end":
          ...
          break;
        default:
          dumpn("pull Unexpected State: " + state);
    ...
    const runFSM = function runFSM(data) {
      ...
      switch (state) {
        ...
        case "end":
          ...
          break;
        default:
          dumpn("push Unexpected State: " + state);
          deferred.reject("UNEXPECTED_STATE");
      }
    };
    ...
    const runFSM = function runFSM(data) {
      ...
      switch (state) {
        ...
        case "rec-root":
          ...
          break;
        default:
          dumpn("root Unexpected State: " + state);
          deferred.reject("UNEXPECTED_STATE");
      }
    };
