...
floorp-custom-actions-open-new-tab =
  .label = Open a new tab
floorp-custom-actions-close-tab =
  .label = Close the current tab
floorp-custom-actions-open-new-window =
  .label = Open a new window
floorp-custom-actions-open-new-private-window =
  .label = Open a new private window
floorp-custom-actions-close-window =
  .label = Close the current window
floorp-custom-actions-restore-last-session =
  .label = Restore the last session
floorp-custom-actions-restore-last-window =
  .label = Restore the last window
floorp-custom-actions-show-next-tab =
  .label = Show the next tab
floorp-custom-actions-show-previous-tab =
  .label = Show the previous tab
floorp-custom-actions-show-all-tabs-panel =
  .label = Show all tabs panel
floorp-custom-actions-send-with-mail =
  .label = Send with mail
floorp-custom-actions-print-page =
  .label = Print page
floorp-custom-actions-mute-current-tab =
  .label = Toggle mute/unmute current tab
floorp-custom-actions-show-source-of-page =
  .label = Show source of page
floorp-custom-actions-show-page-info =
  .label = Show page info
floorp-custom-actions-zoom-in =
  .label = Zoom in
floorp-custom-actions-zoom-out =
  .label = Zoom out
floorp-custom-actions-reset-zoom =
  .label = Reset zoom
floorp-custom-actions-back = 
  .label = Back
floorp-custom-actions-forward =
  .label = Forward
floorp-custom-actions-reload =
  .label = Reload
floorp-custom-actions-force-reload =
  .label = Force reload
floorp-custom-actions-search-in-this-page =
  .label = Search this page
floorp-custom-actions-show-next-search-result =
  .label = Show next search word in this page result
floorp-custom-actions-show-previous-search-result =
  .label = Show previous search word in this page result
floorp-custom-actions-search-the-web =
  .label = Search the web
floorp-custom-actions-open-migration-wizard =
  .label = Open migration wizard
floorp-custom-actions-quit-from-application =
  .label = Quit { -brand-short-name }
floorp-custom-actions-enter-into-customize-mode =
  .label = Enter in toolbar Customize mode
floorp-custom-actions-enter-into-offline-mode =
  .label = Enter in offline mode
floorp-custom-actions-open-screen-capture =
  .label = Open screen shoot tool
floorp-custom-actions-show-pip =
  .label = Show picture in picture
floorp-custom-actions-bookmark-this-page =
  .label = Bookmark this page
floorp-custom-actions-open-bookmarks-sidebar =
  .label = Open bookmarks sidebar
floorp-custom-actions-open-bookmark-add-toolbar =
  .label = Open bookmark add toolbox
floorp-custom-actions-open-bookmarks-manager = 
  .label = Open bookmarks manager
floorp-custom-actions-toggle-bookmark-toolbar =
  .label = Toggle Show/hidden bookmark toolbar
floorp-custom-actions-open-general-preferences =
  .label = Open general preferences
floorp-custom-actions-open-privacy-preferences =
  .label = Open privacy preferences
floorp-custom-actions-open-workspaces-preferences =
  .label = Open workspaces preferences
floorp-custom-actions-open-containers-preferences =
  .label = Open containers preferences
floorp-custom-actions-open-search-preferences =
  .label = Open search preferences
floorp-custom-actions-open-sync-preferences =
  .label = Open sync preferences
floorp-custom-actions-open-task-manager = 
  .label = Open { -brand-short-name }'s task manager
floorp-custom-actions-open-home-page =
  .label = Open { -brand-short-name }'s home page
floorp-custom-actions-forget-history =
  .label = Forget history
floorp-custom-actions-quick-forget-history =
  .label = Quick forget history
floorp-custom-actions-clear-recent-history =
  .label = Clear recent history
floorp-custom-actions-restore-last-session =
  .label = Restore last session
floorp-custom-actions-search-history =
  .label = Search history
floorp-custom-actions-manage-history =
  .label = Manage history
floorp-custom-actions-open-downloads =
  .label = Open downloads
floorp-custom-actions-show-bsm =
  .label = Show browser manager sidebar
floorp-custom-actions-show-bookmark-sidebar =
  .label = Show bookmark sidebar
floorp-custom-actions-show-history-sidebar =
  .label = Show history sidebar
floorp-custom-actions-show-synced-tabs-sidebar =
  .label = Show synced tabs sidebar
floorp-custom-actions-reverse-sidebar =
  .label = Reverse sidebar position
floorp-custom-actions-hide-sidebar =
  .label = Hide sidebar
floorp-custom-actions-toggle-sidebar =
