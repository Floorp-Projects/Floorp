...
sub MakeResourceAliases()
{
    ...
    my($skins_chrome_dir) = "$chrome_dir" . "skins:";
    ...
    my($aim_packages_chrome_dir) = "$packages_chrome_dir" . "aim:";
     
    my($enUS_locales_chrome_dir) = "$locales_chrome_dir" . "en-US:";

    my($modern_skins_chrome_dir) = "$skins_chrome_dir" . "modern:";

    # Thrid level chrome directories
    ...
    my($globalLocale) = "$global_enUS_locales_chrome_dir" . "locale:";
        ...
        my($global_modern_skins_chrome_dir) = "$modern_skins_chrome_dir" . "global:";
    my($globalSkin) = "$global_modern_skins_chrome_dir" . "skin:";
    ...
    my($communicatorLocale) = "$communicator_enUS_locales_chrome_dir" . "locale:";
        ...
        my($communicator_modern_skins_chrome_dir) = "$modern_skins_chrome_dir" . "communicator:";
    my($communicatorSkin) = "$communicator_modern_skins_chrome_dir" . "skin:";
    ...
    my($messenger_modern_skins_chrome_dir) = "$modern_skins_chrome_dir" . "messenger:";
    my($messengerSkin) = "$messenger_modern_skins_chrome_dir" . "skin:";
    ...
    my($editor_modern_skins_chrome_dir) = "$modern_skins_chrome_dir" . "editor:";
    my($editorSkin) = "$editor_modern_skins_chrome_dir" . "skin:";

    # aim
        my($aim_core_packages_chrome_dir) = "$core_packages_chrome_dir" . "aim:";
    my($aimContent) = "$aim_core_packages_chrome_dir" . "content:";

    my($aim_enUS_locales_chrome_dir) = "$enUS_locales_chrome_dir" . "aim:";
    my($aimLocale) = "$aim_enUS_locales_chrome_dir" . "locale:";

    my($aim_modern_skins_chrome_dir) = "$modern_skins_chrome_dir" . "aim:";
    my($aimSkin) = "$aim_modern_skins_chrome_dir" . "skin:";

    _MakeAlias(":mozilla:intl:uconv:src:charsetTitles.properties","$globalLocale");
    
        # xpinstall lives inside of communicator dist dir
        
    my($xpinstallContent) = "$communicatorContent" . "xpinstall:";
    my($xpinstallLocale) = "$communicatorLocale" . "xpinstall:";
    my($xpinstallSkin) = "$communicatorSkin" . "xpinstall:";
    ...
    my($profileSkin) = "$communicatorSkin" . "profile:";
    ...
    _InstallResources(":mozilla:extensions:psm-glue:res:locale:en-US:MANIFEST_NAV", "$navigatorLocale");
        ...
        my($messengercomposeContent) = "$messengerContent" . "messengercompose:";
                ...
                my($messengercomposeSkin) = "$messengerSkin" . "messengercompose:";
       ...
       my($bookmarksSkin) = "$communicatorSkin"."bookmarks:";
        ...
        my($directorySkin) = "$communicatorSkin"."directory:";
        ...
        my($regviewerSkin) = "$communicatorSkin"."regviewer:";
        ...
        my($historySkin) = "$communicatorSkin"."history:";
        ...
        my($relatedSkin) = "$communicatorSkin"."related:";
        ...
        my($searchSkin) = "$communicatorSkin"."search:";
        ...
        my($sidebarSkin) = "$communicatorSkin"."sidebar:";
        ...
        my($timebombSkin) = "$communicatorSkin"."timebomb:";
        ...
        my($prefSkin) = "$communicatorSkin"."pref:";
    ...
    _InstallResources(":mozilla:xpfe:components:autocomplete:resources:content:MANIFEST",          "$globalContent", 0);
        ...
        my($walletSkin) = "$communicatorSkin"."wallet:";
        ...
        my($securitySkin) = "$communicatorSkin"."security:";
