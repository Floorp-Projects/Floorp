...
class nsXFormsRebuildElement : public nsXFormsActionModuleBase
{
public:
                                     ...
                                     nsIXFormsActionElement *aParentAction)
{
  ...
  if (model) {
    ...
    return nsXFormsUtils::DispatchEvent(model, eEvent_Rebuild);
  }
  return NS_OK;
}

NS_HIDDEN_(nsresult)
NS_NewXFormsRebuildElement(nsIXTFElement **aResult)
{
  *aResult = new nsXFormsRebuildElement();
  if (!*aResult)
