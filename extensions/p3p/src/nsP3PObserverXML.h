...
#ifndef nsP3PObserverXML_h__
#define nsP3PObserverXML_h__
...
class nsP3PObserverXML : public nsIObserver,
...
public:
  ...
  // nsP3PObserverXML methods
  nsP3PObserverXML( );
  virtual ~nsP3PObserverXML( );
...
extern
NS_EXPORT NS_METHOD     NS_NewP3PObserverXML( nsIObserver **aObserverXML );

#endif                                           /* nsP3PObserverXML_h__      */
