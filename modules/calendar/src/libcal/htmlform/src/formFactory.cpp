...
JulianFormFactory::init()
{
    ...
    */
    if (cb && cb->GetString)
    {
        error_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        publish_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		        
        publishFB_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		    	
        replyFB_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));			    
        request_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));			    
        request_FB_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));			    
        request_D_FB_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		    
        eventreply_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	    	
        eventcancel_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));			
        eventrefreshreg_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		
        eventcounterprop_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		
        eventdelinecounter_Header_HTML = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	

        String_What = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		                
        String_When = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		                
        String_Location = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        String_Organizer = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        String_Status = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		                
        String_Priority = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        String_Categories = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        String_Resources = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		            
        String_Attachments = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	            
        String_Alarms = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));		                
        String_Created = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	                
        String_Last_Modified = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	            
        String_Sent = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	    	            
        String_UID = XP_STRDUP((*cb->GetString)(JULIAN_STRING_2));	                    
    }

    /*
    ** JulianStrings
    */
    FBT_Legend_Title.LoadString(JULIAN_STRING_2);		        
    FBT_Legend_Free.LoadString(JULIAN_STRING_2);		        	
    FBT_Legend_Busy.LoadString(JULIAN_STRING_2);		        	
    FBT_Legend_Unknown.LoadString(JULIAN_STRING_2);		        
    FBT_Legend_xparam.LoadString(JULIAN_STRING_2);			        

    FBT_AM.LoadString(JULIAN_STRING_2);					        
    FBT_PM.LoadString(JULIAN_STRING_2);					        

    Buttons_Details_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_Add_Label.LoadString(JULIAN_STRING_2);			        
    Buttons_Close_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_Accept_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_AcceptAll_Label.LoadString(JULIAN_STRING_2);           
    Buttons_Update_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_Decline_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_Tentative_Label.LoadString(JULIAN_STRING_2);	        
    Buttons_SendFB_Label.LoadString(JULIAN_STRING_2);		        
    Buttons_SendRefresh_Label.LoadString(JULIAN_STRING_2);	        
    Buttons_DelTo_Label.LoadString(JULIAN_STRING_2);		        

    /*
    ** Status Messages
    */
    EventInSchedule.LoadString(JULIAN_STRING_2);			        
    EventNotInSchedule.LoadString(JULIAN_STRING_2);			        
    EventConflict.LoadString(JULIAN_STRING_2);				        
    EventNote.LoadString(JULIAN_STRING_2);					        
    EventError.LoadString(JULIAN_STRING_2);					        
    EventTest.LoadString(JULIAN_STRING_2);					        
    Text_To.LoadString(JULIAN_STRING_2);					        
    Text_AllDay.LoadString(JULIAN_STRING_2);				        
    Text_StartOn.LoadString(JULIAN_STRING_2);				        
    Text_Was.LoadString(JULIAN_STRING_2);					        

    /*
    ** Muilt Stuff
    */
    MuiltEvent_Header_HTML.LoadString(JULIAN_STRING_2);	            
    MuiltFB_Header_HTML.LoadString(JULIAN_STRING_2);	            
    MuiltEvent.LoadString(JULIAN_STRING_2);				            
    WhenStr.LoadString(JULIAN_STRING_2);				            
    WhatStr.LoadString(JULIAN_STRING_2);				            
    SubjectSep.LoadString(JULIAN_STRING_2);			            

    /*
    ** Error Strings
    */
    MoreErrors.LoadString(JULIAN_STRING_2);                         
    TooManyEvents.LoadString(JULIAN_STRING_2);                     
    error0.LoadString(JULIAN_STRING_2);                             
    error1.LoadString(JULIAN_STRING_2);                             
    error2.LoadString(JULIAN_STRING_2);                             
    error3.LoadString(JULIAN_STRING_2);                            
    error4.LoadString(JULIAN_STRING_2);
    error5.LoadString(JULIAN_STRING_2);                             
    error6.LoadString(JULIAN_STRING_2);                             
    error7.LoadString(JULIAN_STRING_2);         
}
#endif
