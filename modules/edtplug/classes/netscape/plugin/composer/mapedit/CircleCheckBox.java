...
public class CircleCheckBox extends IconCheckBox {
  public CircleCheckBox(IconCheckBoxGroup grp,boolean state,OkCallback cb) {
    super(grp,state,cb);
  }
  ...
  public void paint(Graphics g) {
    ...
    g.fillOval(r.x + 4, r.y + 4,12,12);
    g.setColor(Area.getOuter(false));
    g.drawOval(r.x + 4, r.y + 4,12,12);
  }
}
