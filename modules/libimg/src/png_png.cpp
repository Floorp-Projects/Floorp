...
static int process_data(png_structp *png_ptr, png_infop *info_ptr,
   png_bytep buffer, png_uint_32 length);

extern void info_callback(png_structp png_ptr, png_infop info);
extern void row_callback( png_structp png_ptr, png_bytep new_row,
   png_uint_32 row_num, int pass /*, il_container *ic*/);
extern void end_callback(png_structp png_ptr, png_infop info);

extern void il_create_alpha_mask( il_container *ic ,/* png_bytep mask, int srcwidth, */int xoffset,
