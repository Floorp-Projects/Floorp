...
JNI_OJIAPITest(JNIEnv_CallNonvirtualIntMethod_17)
{
  GET_JNI_FOR_TEST
  ...
  if(value == 121){
     return TestResult::PASS("CallNonvirtualIntMethodA for public synchronized not inherited method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)I) return correct value");
  }else{
     return TestResult::FAIL("CallNonvirtualIntMethodA for public synchronized not inherited method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)I) return incorrect value");
  }
