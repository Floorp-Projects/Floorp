...
JNI_OJIAPITest(JNIEnv_CallBooleanMethod_3)
{
  GET_JNI_FOR_TEST
  ...
  if(value == JNI_TRUE){
     ...
     return TestResult::FAIL("CallBooleanMethod for public not inherited method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)Z) return incorrect value");
  }
