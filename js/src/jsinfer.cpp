...
{
    // Clear the TypeNewScript from this TypeObject and remove it from the
    // newTypeObjects table, so that it will not be produced by calling 'new'
    // on the associated function anymore. The TypeNewScript is not actually
    // destroyed.
