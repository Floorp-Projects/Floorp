...
( module ( func ( export "i16x8.add_sat_s" ) ( param v128 v128 ) ( result v128 ) ( i16x8.add_sat_s ( local.get 0 ) ( local.get 1 ) ) ) ( func ( export "i16x8.add_sat_u" ) ( param v128 v128 ) ( result v128 ) ( i16x8.add_sat_u ( local.get 0 ) ( local.get 1 ) ) ) ( func ( export "i16x8.sub_sat_s" ) ( param v128 v128 ) ( result v128 ) ( i16x8.sub_sat_s ( local.get 0 ) ( local.get 1 ) ) ) ( func ( export "i16x8.sub_sat_u" ) ( param v128 v128 ) ( result v128 ) ( i16x8.sub_sat_u ( local.get 0 ) ( local.get 1 ) ) ) )
`)));
var run = new WebAssembly.Instance(new WebAssembly.Module(wasmTextToBinary(`

(module
  (import "" "i16x8.add_sat_s" (func $f (param v128 v128) (result v128)))
...
(module
  (import "" "i16x8.add_sat_u" (func $f (param v128 v128) (result v128)))
  (func (export "run") (result i32) 
(local $result v128)
(local $expected v128)
(local $cmpresult v128)
...
(module
  (import "" "i16x8.sub_sat_s" (func $f (param v128 v128) (result v128)))
  (func (export "run") (result i32) 
(local $result v128)
(local $expected v128)
(local $cmpresult v128)
...
(module
  (import "" "i16x8.sub_sat_u" (func $f (param v128 v128) (result v128)))
  (func (export "run") (result i32) 
(local $result v128)
(local $expected v128)
(local $cmpresult v128)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.add_sat_s-1st-arg-empty ( result v128 ) ( i16x8.add_sat_s ( v128.const i16x8 0 0 0 0 0 0 0 0 ) ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.add_sat_s-arg-empty ( result v128 ) ( i16x8.add_sat_s ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.add_sat_u-1st-arg-empty ( result v128 ) ( i16x8.add_sat_u ( v128.const i16x8 0 0 0 0 0 0 0 0 ) ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.add_sat_u-arg-empty ( result v128 ) ( i16x8.add_sat_u ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.sub_sat_s-1st-arg-empty ( result v128 ) ( i16x8.sub_sat_s ( v128.const i16x8 0 0 0 0 0 0 0 0 ) ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.sub_sat_s-arg-empty ( result v128 ) ( i16x8.sub_sat_s ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
...
var saved;
var bin = wasmTextToBinary(`
( module ( func $i16x8.sub_sat_u-1st-arg-empty ( result v128 ) ( i16x8.sub_sat_u ( v128.const i16x8 0 0 0 0 0 0 0 0 ) ) ) )
`);
assertEq(WebAssembly.validate(bin), false);
try { new WebAssembly.Module(bin) } catch (e) { thrown = true; saved = e; }
assertEq(thrown, true)
