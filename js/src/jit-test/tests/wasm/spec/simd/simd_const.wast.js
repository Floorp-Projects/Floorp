...
assert_malformed(
  () =>
    instantiate(
      `(func (v128.const f32x4  340282356779733661637539395458142568448 340282356779733661637539395458142568448                          340282356779733661637539395458142568448 340282356779733661637539395458142568448) drop) `,
    ),
  `constant out of range`,
);
...
assert_malformed(
  () => instantiate(`(func (v128.const) drop) `),
  `unexpected token`,
);
...
assert_return(() => invoke($301, `as-br-retval`, []), [
  i32x4([0x3020100, 0x7060504, 0xb0a0908, 0xf0e0d0c]),
]);

// ./test/core/simd/simd_const.wast:972
assert_return(() => invoke($301, `as-br_if-retval`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:973
assert_return(() => invoke($301, `as-return-retval`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:974
assert_return(() => invoke($301, `as-if-then-retval`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:975
assert_return(() => invoke($301, `as-if-else-retval`, []), [
  i32x4([0x3, 0x2, 0x1, 0x0]),
]);

// ./test/core/simd/simd_const.wast:976
assert_return(() => invoke($301, `as-call-param`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:977
assert_return(() => invoke($301, `as-call_indirect-param`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:978
assert_return(() => invoke($301, `as-block-retval`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);

// ./test/core/simd/simd_const.wast:979
assert_return(() => invoke($301, `as-loop-retval`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);
...
assert_return(() => invoke($301, `as-br-retval2`, []), [
  i64x2([0x302010007060504n, 0xb0a09080f0e0d0cn]),
]);

// ./test/core/simd/simd_const.wast:983
assert_return(() => invoke($301, `as-br_if-retval2`, []), [
  i64x2([0x0n, 0x1n]),
]);

// ./test/core/simd/simd_const.wast:984
assert_return(() => invoke($301, `as-return-retval2`, []), [
  i64x2([0x0n, 0x1n]),
]);

// ./test/core/simd/simd_const.wast:985
assert_return(() => invoke($301, `as-if-then-retval2`, []), [
  i64x2([0x0n, 0x1n]),
]);

// ./test/core/simd/simd_const.wast:986
assert_return(() => invoke($301, `as-if-else-retval2`, []), [
  i64x2([0x1n, 0x0n]),
]);
...
assert_return(() => invoke($301, `as-call_indirect-param2`, []), [
  i64x2([0x0n, 0x1n]),
]);

// ./test/core/simd/simd_const.wast:989
assert_return(() => invoke($301, `as-block-retval2`, []), [
  i64x2([0x0n, 0x1n]),
]);
...
assert_return(() => invoke($302, `as-local.tee-value`, []), [
  i32x4([0x0, 0x1, 0x2, 0x3]),
]);
...
assert_return(() => invoke($303, `global.get_g0`, []), [
  i32x4([0x1, 0x1, 0x1, 0x1]),
]);

// ./test/core/simd/simd_const.wast:1069
assert_return(() => invoke($303, `global.get_g1`, []), [
  i32x4([0x2, 0x2, 0x2, 0x2]),
]);

// ./test/core/simd/simd_const.wast:1070
assert_return(() => invoke($303, `global.get_g2`, []), [
  i32x4([0x3, 0x3, 0x3, 0x3]),
]);

// ./test/core/simd/simd_const.wast:1071
assert_return(() => invoke($303, `global.get_g3`, []), [
  i32x4([0x4, 0x4, 0x4, 0x4]),
]);
...
assert_return(() => invoke($304, `i32x4.test`, []), [
  i32x4([0xbadd00d, 0xbadd00d, 0xbadd00d, 0xbadd00d]),
]);

// ./test/core/simd/simd_const.wast:1105
assert_return(() => invoke($304, `i32x4.smax`, []), [
  i32x4([0x7fffffff, 0x7fffffff, 0x7fffffff, 0x7fffffff]),
]);

// ./test/core/simd/simd_const.wast:1106
assert_return(() => invoke($304, `i32x4.neg_smax`, []), [
  i32x4([0x80000001, 0x80000001, 0x80000001, 0x80000001]),
]);

// ./test/core/simd/simd_const.wast:1107
assert_return(() => invoke($304, `i32x4.inc_smin`, []), [
  i32x4([0x80000001, 0x80000001, 0x80000001, 0x80000001]),
]);

// ./test/core/simd/simd_const.wast:1108
assert_return(() => invoke($304, `i32x4.neg_zero`, []), [
  i32x4([0x0, 0x0, 0x0, 0x0]),
]);

// ./test/core/simd/simd_const.wast:1109
assert_return(() => invoke($304, `i32x4.not_octal`, []), [
  i32x4([0xa, 0xa, 0xa, 0xa]),
]);

// ./test/core/simd/simd_const.wast:1110
assert_return(() => invoke($304, `i32x4.plus_sign`, []), [
  i32x4([0x2a, 0x2a, 0x2a, 0x2a]),
]);

// ./test/core/simd/simd_const.wast:1112
assert_return(() => invoke($304, `i32x4-dec-sep1`, []), [
  i32x4([0xf4240, 0xf4240, 0xf4240, 0xf4240]),
]);

// ./test/core/simd/simd_const.wast:1113
assert_return(() => invoke($304, `i32x4-dec-sep2`, []), [
  i32x4([0x3e8, 0x3e8, 0x3e8, 0x3e8]),
]);

// ./test/core/simd/simd_const.wast:1114
assert_return(() => invoke($304, `i32x4-hex-sep1`, []), [
  i32x4([0xa0f0099, 0xa0f0099, 0xa0f0099, 0xa0f0099]),
]);

// ./test/core/simd/simd_const.wast:1115
assert_return(() => invoke($304, `i32x4-hex-sep2`, []), [
  i32x4([0x1aa0f, 0x1aa0f, 0x1aa0f, 0x1aa0f]),
]);

// ./test/core/simd/simd_const.wast:1117
assert_return(() => invoke($304, `i64x2.test`, []), [
  i64x2([0xbadd00d0badd00dn, 0xbadd00d0badd00dn]),
]);

// ./test/core/simd/simd_const.wast:1118
assert_return(() => invoke($304, `i64x2.smax`, []), [
  i64x2([0x7fffffffffffffffn, 0x7fffffffffffffffn]),
]);

// ./test/core/simd/simd_const.wast:1119
assert_return(() => invoke($304, `i64x2.neg_smax`, []), [
  i64x2([0x8000000000000001n, 0x8000000000000001n]),
]);

// ./test/core/simd/simd_const.wast:1120
assert_return(() => invoke($304, `i64x2.inc_smin`, []), [
  i64x2([0x8000000000000001n, 0x8000000000000001n]),
]);
...
assert_return(() => invoke($304, `i64x2.not_octal`, []), [
  i64x2([0x271an, 0x271an]),
]);

// ./test/core/simd/simd_const.wast:1123
assert_return(() => invoke($304, `i64x2.plus_sign`, []), [
  i64x2([0x2an, 0x2an]),
]);

// ./test/core/simd/simd_const.wast:1125
assert_return(() => invoke($304, `i64x2-dec-sep1`, []), [
  i64x2([0x9184e72a000n, 0x9184e72a000n]),
]);

// ./test/core/simd/simd_const.wast:1126
assert_return(() => invoke($304, `i64x2-dec-sep2`, []), [
  i64x2([0x989680n, 0x989680n]),
]);

// ./test/core/simd/simd_const.wast:1127
assert_return(() => invoke($304, `i64x2-hex-sep1`, []), [
  i64x2([0xa0f00990a0f0099n, 0xa0f00990a0f0099n]),
]);

// ./test/core/simd/simd_const.wast:1128
assert_return(() => invoke($304, `i64x2-hex-sep2`, []), [
  i64x2([0x1aa0f1aa0fn, 0x1aa0f1aa0fn]),
]);
...
assert_return(() => invoke($305, `f32-dec-sep1`, []), [
  new F32x4Pattern(
    value("f32", 1000000),
    value("f32", 1000000),
    value("f32", 1000000),
...
assert_return(() => invoke($305, `f32-dec-sep2`, []), [
  new F32x4Pattern(
    value("f32", 1000),
    value("f32", 1000),
    value("f32", 1000),
...
assert_return(() => invoke($305, `f32-dec-sep3`, []), [
  new F32x4Pattern(
    value("f32", 1003.1416),
    value("f32", 1003.1416),
    value("f32", 1003.1416),
...
assert_return(() => invoke($305, `f32-dec-sep4`, []), [
  new F32x4Pattern(
...
assert_return(() => invoke($305, `f32-dec-sep5`, []), [
  new F32x4Pattern(
...
assert_return(() => invoke($305, `f32-hex-sep1`, []), [
  new F32x4Pattern(
    value("f32", 168755360),
    value("f32", 168755360),
    value("f32", 168755360),
...
assert_return(() => invoke($305, `f32-hex-sep2`, []), [
  new F32x4Pattern(
    value("f32", 109071),
    value("f32", 109071),
    value("f32", 109071),
...
assert_return(() => invoke($305, `f32-hex-sep3`, []), [
  new F32x4Pattern(
    value("f32", 41215.94),
    value("f32", 41215.94),
    value("f32", 41215.94),
...
assert_return(() => invoke($305, `f32-hex-sep4`, []), [
  new F32x4Pattern(
    value("f32", 1966080),
    value("f32", 1966080),
    value("f32", 1966080),
...
assert_return(() => invoke($305, `f32-hex-sep5`, []), [
  new F32x4Pattern(
...
assert_return(() => invoke($306, `parse_i8x16`, []), [
  i8x16([
    0x0,
    0x0,
    0x0,
...
assert_return(() => invoke($307, `parse_i16x8`, []), [
...
assert_return(() => invoke($308, `parse_i32x4`, []), [
...
assert_return(() => invoke($309, `parse_i64x2`, []), [
  i64x2([0x7fffffffffffffffn, 0x7fffffffffffffffn]),
]);
...
assert_return(() => invoke($310, `parse_f32x4`, []), [
  new F32x4Pattern(
...
assert_return(() => invoke($311, `parse_f64x2`, []), [
  new F64x2Pattern(
    value(
      "f64",
      ,
