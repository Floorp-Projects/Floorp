...
assert_return(() => invoke($0, `i8x16.splat`, [0]), [
  i8x16([
    0x0,
    0x0,
    0x0,
...
assert_return(() => invoke($0, `i8x16.splat`, [5]), [
  i8x16([
    0x5,
    0x5,
    0x5,
...
assert_return(() => invoke($0, `i8x16.splat`, [257]), [
  i8x16([
    0x1,
    0x1,
    0x1,
...
assert_return(() => invoke($0, `i8x16.splat`, [255]), [
  i8x16([
    0xff,
    0xff,
    0xff,
...
assert_return(() => invoke($0, `i8x16.splat`, [-128]), [
  i8x16([
    0x80,
    0x80,
    0x80,
...
assert_return(() => invoke($0, `i8x16.splat`, [127]), [
  i8x16([
    0x7f,
    0x7f,
    0x7f,
...
assert_return(() => invoke($0, `i8x16.splat`, [-129]), [
  i8x16([
    0x7f,
    0x7f,
    0x7f,
...
assert_return(() => invoke($0, `i8x16.splat`, [65407]), [
  i8x16([
    0x7f,
    0x7f,
    0x7f,
...
assert_return(() => invoke($0, `i32x4.splat`, [-1]), [
...
assert_return(() => invoke($0, `i32x4.splat`, [-2147483648]), [
  i32x4([0x80000000, 0x80000000, 0x80000000, 0x80000000]),
]);

// ./test/core/simd/simd_splat.wast:46
assert_return(() => invoke($0, `i32x4.splat`, [2147483647]), [
...
assert_return(() => invoke($0, `f32x4.splat`, [value("f32", 1.1)]), [
  new F32x4Pattern(
    value("f32", 1.1),
    value("f32", 1.1),
    value("f32", 1.1),
...
assert_return(() => invoke($0, `f32x4.splat`, [value("f32", Infinity)]), [
  new F32x4Pattern(
    value("f32", Infinity),
    value("f32", Infinity),
    value("f32", Infinity),
...
assert_return(() => invoke($0, `f32x4.splat`, [value("f32", 123456790)]), [
  new F32x4Pattern(
    value("f32", 123456790),
    value("f32", 123456790),
    value("f32", 123456790),
...
assert_return(() => invoke($0, `f32x4.splat`, [value("f32", 156374990000)]), [
  new F32x4Pattern(
...
assert_return(() => invoke($0, `i64x2.splat`, [-1n]), [
  i64x2([0xffffffffffffffffn, 0xffffffffffffffffn]),
]);

// ./test/core/simd/simd_splat.wast:78
assert_return(() => invoke($0, `i64x2.splat`, [-9223372036854775808n]), [
...
assert_return(() => invoke($0, `i64x2.splat`, [9223372036854775807n]), [
...
assert_return(() => invoke($0, `i64x2.splat`, [1234567890123456789n]), [
  i64x2([0x112210f47de98115n, 0x112210f47de98115n]),
]);

// ./test/core/simd/simd_splat.wast:87
assert_return(() => invoke($0, `i64x2.splat`, [1311768467294899695n]), [
  i64x2([0x1234567890abcdefn, 0x1234567890abcdefn]),
]);

// ./test/core/simd/simd_splat.wast:89
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", 0)]), [
...
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", 1.1)]), [
...
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", 0.5)]), [
...
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", 1)]), [
...
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", Infinity)]), [
...
assert_return(() => invoke($0, `f64x2.splat`, [value("f64", 123456789)]), [
...
assert_return(() => invoke($1, `as-v128_store-operand-1`, [1]), [
  i8x16([
    0x1,
    0x1,
    0x1,
...
assert_return(() => invoke($1, `as-v128_store-operand-2`, [256]), [
  i16x8([0x100, 0x100, 0x100, 0x100, 0x100, 0x100, 0x100, 0x100]),
]);

// ./test/core/simd/simd_splat.wast:168
assert_return(() => invoke($1, `as-v128_store-operand-3`, [-1]), [
  i32x4([0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff]),
]);

// ./test/core/simd/simd_splat.wast:169
assert_return(() => invoke($1, `as-v128_store-operand-4`, [1n]), [
  i64x2([0x1n, 0x1n]),
]);

// ./test/core/simd/simd_splat.wast:170
assert_return(() => invoke($1, `as-v128_store-operand-5`, [value("f64", -1)]), [
  new F64x2Pattern(value("f64", -1), value("f64", -1)),
]);
...
assert_return(() => invoke($2, `as-i8x16_extract_lane_s-operand-first`, [42]), [
  value("i32", 42),
]);

// ./test/core/simd/simd_splat.wast:293
assert_return(() => invoke($2, `as-i8x16_extract_lane_s-operand-last`, [-42]), [
  value("i32", -42),
]);
...
assert_return(
  () => invoke($2, `as-i16x8_extract_lane_s-operand-last`, [32768]),
  [value("i32", -32768)],
);
...
assert_return(() => invoke($2, `as-v8x16_swizzle-operands`, [1, -1]), [
  i8x16([
    0x0,
    0x0,
    0x0,
...
assert_return(() => invoke($2, `as-i64x2_extract_lane-operand-last`, [-42n]), [
  value("i64", -42n),
]);

// ./test/core/simd/simd_splat.wast:302
assert_return(() => invoke($2, `as-i64x2_extract_lane-operand-first`, [42n]), [
  value("i64", 42n),
]);
...
assert_return(() => invoke($2, `as-i8x16_add_sub-operands`, [3, 2, 1]), [
  i8x16([
    0x4,
    0x4,
    0x4,
...
assert_return(() => invoke($2, `as-i8x16_add_sat_s-operands`, [127, 1]), [
  i8x16([
    0x7f,
    0x7f,
    0x7f,
...
assert_return(() => invoke($2, `as-i16x8_add_sat_s-operands`, [32767, 1]), [
  i16x8([0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff]),
]);

// ./test/core/simd/simd_splat.wast:314
assert_return(() => invoke($2, `as-i8x16_sub_sat_u-operands`, [127, 255]), [
  i8x16([
    0x0,
    0x0,
    0x0,
...
assert_return(() => invoke($2, `as-i16x8_sub_sat_u-operands`, [32767, 65535]), [
  i16x8([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
]);

// ./test/core/simd/simd_splat.wast:317
assert_return(() => invoke($2, `as-i8x16_shr_s-operand`, [240, 3]), [
  i8x16([
    0xfe,
    0xfe,
    0xfe,
...
assert_return(() => invoke($2, `as-i16x8_shr_s-operand`, [256, 4]), [
  i16x8([0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10]),
]);

// ./test/core/simd/simd_splat.wast:319
assert_return(() => invoke($2, `as-i32x4_shr_s-operand`, [-1, 16]), [
  i32x4([0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff]),
]);

// ./test/core/simd/simd_splat.wast:321
assert_return(() => invoke($2, `as-v128_and-operands`, [17, 255]), [
  i8x16([
    0x11,
    0x11,
    0x11,
...
assert_return(() => invoke($2, `as-v128_or-operands`, [0, 65535]), [
  i16x8([0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff]),
]);

// ./test/core/simd/simd_splat.wast:323
assert_return(() => invoke($2, `as-v128_xor-operands`, [-252645136, -1]), [
  i32x4([0xf0f0f0f, 0xf0f0f0f, 0xf0f0f0f, 0xf0f0f0f]),
]);

// ./test/core/simd/simd_splat.wast:325
assert_return(() => invoke($2, `as-i8x16_all_true-operand`, [0]), [
  value("i32", 0),
]);

// ./test/core/simd/simd_splat.wast:326
assert_return(() => invoke($2, `as-i16x8_all_true-operand`, [65535]), [
  value("i32", 1),
]);

// ./test/core/simd/simd_splat.wast:327
assert_return(() => invoke($2, `as-i32x4_all_true-operand1`, [-252645136]), [
  value("i32", 1),
]);

// ./test/core/simd/simd_splat.wast:328
assert_return(() => invoke($2, `as-i32x4_all_true-operand2`, [-1n]), [
  value("i32", 1),
]);

// ./test/core/simd/simd_splat.wast:330
assert_return(() => invoke($2, `as-i8x16_eq-operands`, [1, 2]), [
  i8x16([
    0x0,
    0x0,
    0x0,
...
assert_return(() => invoke($2, `as-i16x8_eq-operands`, [-1, 65535]), [
  i16x8([0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff]),
]);

// ./test/core/simd/simd_splat.wast:332
assert_return(() => invoke($2, `as-i32x4_eq-operands1`, [-1, -1]), [
  i32x4([0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff]),
]);
...
assert_return(() => invoke($2, `as-i32x4_eq-operands2`, [1n, 2n]), [
...
assert_return(() => invoke($2, `as-f32x4_convert_s_i32x4-operand`, [12345]), [
  new F32x4Pattern(
    value("f32", 12345),
    value("f32", 12345),
    value("f32", 12345),
...
assert_return(() => invoke($3, `as-br-value1`, [171]), [
  i8x16([
    0xab,
    0xab,
    0xab,
...
assert_return(() => invoke($3, `as-return-value1`, [43981]), [
  i16x8([0xabcd, 0xabcd, 0xabcd, 0xabcd, 0xabcd, 0xabcd, 0xabcd, 0xabcd]),
]);

// ./test/core/simd/simd_splat.wast:373
assert_return(() => invoke($3, `as-local_set-value1`, [65536]), [
  i32x4([0x10000, 0x10000, 0x10000, 0x10000]),
]);

// ./test/core/simd/simd_splat.wast:374
assert_return(() => invoke($3, `as-global_set-value1`, [value("f32", 1)]), [
  new F32x4Pattern(
    value("f32", 1),
    value("f32", 1),
    value("f32", 1),
...
assert_return(() => invoke($3, `as-br-value2`, [43981n]), [
  i64x2([0xabcdn, 0xabcdn]),
]);

// ./test/core/simd/simd_splat.wast:376
assert_return(() => invoke($3, `as-return-value2`, [43981n]), [
  i64x2([0xabcdn, 0xabcdn]),
]);

// ./test/core/simd/simd_splat.wast:377
assert_return(() => invoke($3, `as-local_set-value2`, [65536n]), [
  i64x2([0x10000n, 0x10000n]),
]);

// ./test/core/simd/simd_splat.wast:378
assert_return(() => invoke($3, `as-global_set-value2`, [value("f64", 1)]), [
  new F64x2Pattern(value("f64", 1), value("f64", 1)),
]);
