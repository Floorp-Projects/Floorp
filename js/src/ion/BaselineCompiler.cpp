...
void
FrameState::sync(StackValue *val)
{
    switch (val->kind()) {
      case StackValue::Stack:
        break;
...
void
FrameState::syncStack(uint32_t uses)
{
...
void
FrameState::ensureInRegister(StackValue *val, ValueOperand dest, ValueOperand scratch)
{
    switch (val->kind()) {
      case StackValue::Constant:
...
void
FrameState::popRegsAndSync(uint32_t uses)
{
