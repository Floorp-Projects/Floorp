...
new TestCase( "Math.round.length",
	      1,
	      Math.round.length );

new TestCase( "Math.round()",
	      Number.NaN,
	      Math.round() );

new TestCase( "Math.round(null)",
	      0,
	      Math.round(0) );

new TestCase( "Math.round(void 0)",
	      Number.NaN,
	      Math.round(void 0) );

new TestCase( "Math.round(true)",
	      1,
	      Math.round(true) );

new TestCase( "Math.round(false)",
	      0,
	      Math.round(false) );

new TestCase( "Math.round('.99999')",
	      1,
	      Math.round('.99999') );

new TestCase( "Math.round('12345e-2')",
	      123,
	      Math.round('12345e-2') );

new TestCase( "Math.round(NaN)",
	      Number.NaN,
	      Math.round(Number.NaN) );

new TestCase( "Math.round(0)",
	      0,
	      Math.round(0) );
...
new TestCase( "Infinity/Math.round(-0)",
	      -Infinity,
	      Infinity/Math.round(-0) );

new TestCase( "Math.round(Infinity)",
...
new TestCase( "Math.round(0.49)",
	      0,
	      Math.round(0.49));

new TestCase( "Math.round(0.5)",
	      1,
	      Math.round(0.5));

new TestCase( "Math.round(0.51)",
	      1,
	      Math.round(0.51));
...
new TestCase( "Infinity/Math.round(-0.49)",
	      -Infinity,
	      Infinity/Math.round(-0.49));

new TestCase( "Infinity/Math.round(-0.5)",
	      -Infinity,
