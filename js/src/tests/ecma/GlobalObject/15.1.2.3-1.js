...
new TestCase( "parseFloat.length",     1,              parseFloat.length );

new TestCase( "parseFloat.length = null; parseFloat.length",   1,      eval("parseFloat.length = null; parseFloat.length") );
new TestCase( "var MYPROPS=''; for ( var p in parseFloat ) { MYPROPS += p }; MYPROPS", "", eval("var MYPROPS=''; for ( var p in parseFloat ) { MYPROPS += p }; MYPROPS") );

new TestCase( "parseFloat()",          Number.NaN,     parseFloat() );
new TestCase( "parseFloat('')",        Number.NaN,     parseFloat('') );
...
new TestCase( "parseFloat('  Infinity')",    Infinity,    parseFloat("Infinity") );
new TestCase( "parseFloat('  Infinity  ')",      Infinity,    parseFloat('  Infinity  ') );
...
new TestCase( "parseFloat(0x0)",        0,          parseFloat(0x0));
new TestCase( "parseFloat(0x1)",        1,          parseFloat(0x1));
new TestCase( "parseFloat(0x2)",        2,          parseFloat(0x2));
new TestCase( "parseFloat(0x3)",        3,          parseFloat(0x3));
new TestCase( "parseFloat(0x4)",        4,          parseFloat(0x4));
new TestCase( "parseFloat(0x5)",        5,          parseFloat(0x5));
new TestCase( "parseFloat(0x6)",        6,          parseFloat(0x6));
new TestCase( "parseFloat(0x7)",        7,          parseFloat(0x7));
new TestCase( "parseFloat(0x8)",        8,          parseFloat(0x8));
new TestCase( "parseFloat(0x9)",        9,          parseFloat(0x9));
new TestCase( "parseFloat(0xa)",        10,         parseFloat(0xa));
new TestCase( "parseFloat(0xb)",        11,         parseFloat(0xb));
new TestCase( "parseFloat(0xc)",        12,         parseFloat(0xc));
new TestCase( "parseFloat(0xd)",        13,         parseFloat(0xd));
new TestCase( "parseFloat(0xe)",        14,         parseFloat(0xe));
new TestCase( "parseFloat(0xf)",        15,         parseFloat(0xf));
new TestCase( "parseFloat(0xA)",        10,         parseFloat(0xA));
new TestCase( "parseFloat(0xB)",        11,         parseFloat(0xB));
new TestCase( "parseFloat(0xC)",        12,         parseFloat(0xC));
new TestCase( "parseFloat(0xD)",        13,         parseFloat(0xD));
...
new TestCase( "parseFloat(06)",        6,         parseFloat(06));
new TestCase( "parseFloat(07)",        7,         parseFloat(07));
new TestCase( "parseFloat(010)",       8,        parseFloat(010));
new TestCase( "parseFloat(011)",       9,        parseFloat(011));
