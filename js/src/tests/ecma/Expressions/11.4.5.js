...
new TestCase( "var MYVAR=null; --MYVAR",                  -1,                            eval("var MYVAR=null; --MYVAR") );
new TestCase( "var MYVAR=true; --MYVAR",                  0,                            eval("var MYVAR=true; --MYVAR") );
new TestCase( "var MYVAR=false; --MYVAR",                 -1,                            eval("var MYVAR=false; --MYVAR") );
...
// number primitives
new TestCase( "var MYVAR=0;--MYVAR",            -1,         eval("var MYVAR=0;--MYVAR") );
new TestCase( "var MYVAR=0.2345;--MYVAR",      -0.7655,     eval("var MYVAR=0.2345;--MYVAR") );
new TestCase( "var MYVAR=-0.2345;--MYVAR",      -1.2345,    eval("var MYVAR=-0.2345;--MYVAR") );
...
new TestCase( "var MYVAR=new Boolean(true);--MYVAR",         0,     eval("var MYVAR=true;--MYVAR") );
new TestCase( "var MYVAR=new Boolean(false);--MYVAR",        -1,     eval("var MYVAR=false;--MYVAR") );
// verify value of variable
...
new TestCase( "var MYVAR='12345';--MYVAR",          12344,          eval("var MYVAR='12345';--MYVAR") );
new TestCase( "var MYVAR='-12345';--MYVAR",         -12346,         eval("var MYVAR='-12345';--MYVAR") );
new TestCase( "var MYVAR='0Xf';--MYVAR",            14,             eval("var MYVAR='0Xf';--MYVAR") );
new TestCase( "var MYVAR='077';--MYVAR",            76,             eval("var MYVAR='077';--MYVAR") );
new TestCase( "var MYVAR=''; --MYVAR",              -1,              eval("var MYVAR='';--MYVAR") );
...
new TestCase( "var MYVAR=new String('12345');--MYVAR",          12344,          eval("var MYVAR=new String('12345');--MYVAR") );
new TestCase( "var MYVAR=new String('-12345');--MYVAR",         -12346,         eval("var MYVAR=new String('-12345');--MYVAR") );
new TestCase( "var MYVAR=new String('0Xf');--MYVAR",            14,             eval("var MYVAR=new String('0Xf');--MYVAR") );
new TestCase( "var MYVAR=new String('077');--MYVAR",            76,             eval("var MYVAR=new String('077');--MYVAR") );
new TestCase( "var MYVAR=new String(''); --MYVAR",              -1,              eval("var MYVAR=new String('');--MYVAR") );
