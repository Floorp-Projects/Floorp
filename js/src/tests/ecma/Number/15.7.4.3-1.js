...
new TestCase("(new Number(1)).valueOf()",        
	     1,      
...
new TestCase("(new Number(0)).valueOf()",        
	     0,      
	     eval("(new Number(0)).valueOf()") );

new TestCase("(new Number(Number.POSITIVE_INFINITY)).valueOf()",
	     Number.POSITIVE_INFINITY,
	     eval("(new Number(Number.POSITIVE_INFINITY)).valueOf()") );

new TestCase("(new Number(Number.NaN)).valueOf()", 
	     Number.NaN,
	     eval("(new Number(Number.NaN)).valueOf()") );

new TestCase("(new Number()).valueOf()",        
	     0,      
