...
new TestCase( "(new Date(NaN)).getFullYear()",
	      NaN,
	      (new Date(NaN)).getFullYear() );

new TestCase( "Date.prototype.getFullYear.length",
	      0,
	      Date.prototype.getFullYear.length );

test();
function addTestCase( t ) {
  new TestCase( "(new Date("+t+")).getFullYear()",
		YearFromTime(LocalTime(t)),
		(new Date(t)).getFullYear() );

  new TestCase( "(new Date("+(t+1)+")).getFullYear()",
  ...
  new TestCase( "(new Date("+(t-TZ_ADJUST)+")).getFullYear()",
