...
new TestCase ( "'abcdef'.match(new RegExp('cd?e'))",
	       String(["cde"]), String('abcdef'.match(new RegExp('cd?e'))));

// 'abcdef'.match(new RegExp('cdx?e'))
new TestCase ( "'abcdef'.match(new RegExp('cdx?e'))",
...
new TestCase ( "'test'.match(new RegExp('.?.?.?.?.?.?.?'))",
