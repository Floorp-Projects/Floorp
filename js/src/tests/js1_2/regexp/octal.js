...
new TestCase ( "'" + testString + "'.match(new RegExp('" + testPattern + "'))",
...
new TestCase ( "'canthisbeFOUND'.match(new RegExp('[A-\\132]+'))",
	       String(["FOUND"]), String('canthisbeFOUND'.match(new RegExp('[A-\\132]+'))));

new TestCase ( "'canthisbeFOUND'.match(new RegExp('[\\141-\\172]+'))",
	       String(["canthisbe"]), String('canthisbeFOUND'.match(new RegExp('[\\141-\\172]+'))));

new TestCase ( "'canthisbeFOUND'.match(/[\\141-\\172]+/)",
