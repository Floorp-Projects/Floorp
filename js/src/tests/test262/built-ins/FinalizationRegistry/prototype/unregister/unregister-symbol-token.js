// |reftest| shell-option(--enable-symbols-as-weakmap-keys) skip-if(!this.hasOwnProperty('FinalizationRegistry')||!xulRuntime.shell) -- FinalizationRegistry is not enabled unconditionally, requires shell-options
