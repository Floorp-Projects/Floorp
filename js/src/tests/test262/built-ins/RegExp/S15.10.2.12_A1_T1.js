...
var i6 = "";
for (var j = 6144; j < 6158; j++)
  i6 += String.fromCharCode(j);
var o6 = "\u1800\u1801\u1802\u1803\u1804\u1805\u1806\u1807\u1808\u1809\u180A\u180B\u180C\u180D";
if (i6.replace(/\s+/g, "") !== o6) {
  $ERROR("#6: Error matching character class \s between character 1800 and 180D");
}

var i6b = "";
for (var j = 6159; j < 7168; j++)
  i6b += String.fromCharCode(j);
...
if (i6b.replace(/\s+/g, "") !== o6b) {
  $ERROR("#6b: Error matching character class \s between character 180F and 1bff");
}
