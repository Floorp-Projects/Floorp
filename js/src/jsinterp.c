...
/*
 * Threaded interpretation via computed goto is supported by GCC 2.0 and newer,
 * IBM's C compiler when run with the right options (-qlanglvl=extended), and
 * the SunPro C compiler.
 */
#if __GNUC__ >= 2 ||                                                          \
