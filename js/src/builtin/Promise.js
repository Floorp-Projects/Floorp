...
function Promise_finally(onFinally) {
    ...
    // Step 2. (https://github.com/tc39/proposal-promise-finally/issues/41)
    if (!IsObject(promise) || !IsPromiseObject(promise))
        return callFunction(CallPromiseMethodIfWrapped, promise, onFinally, "Promise_finally");
