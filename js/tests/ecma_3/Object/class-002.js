 ...
 */
status = 'Object';
actual = getClass(Object);
expect = 'Function';
addThis();

status = 'Function';
actual = getClass(Function);
expect = 'Function';
addThis();

status = 'Array';
actual = getClass(Array);
expect = 'Function';
addThis();

status = 'String';
actual = getClass(String);
expect = 'Function';
addThis();

status = 'Boolean';
actual = getClass(Boolean);
expect = 'Function';
addThis();

status = 'Number';
actual = getClass(Number);
expect = 'Function';
addThis();

status = 'Date';
actual = getClass(Date);
expect = 'Function';
addThis();

status = 'RegExp';
actual = getClass(RegExp);
expect = 'Function';
addThis();
