...
/*
 *    For gcc/g++, we have reasonable header files to use.
 *    They are not complete, but complete enough to build Mozilla C++ files.
 */
#if !(defined(__cplusplus) && (__GNUC__ >= 2) && (__GNUC_MINOR__ >= 6))
