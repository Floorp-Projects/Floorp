...
function getTestCases() {
    ...
    array[item++] = new TestCase( SECTION, "Date(1970,0,1,0,0,0)",          true, (new Date()).toString() ==    Date(1970,0,1,0,0,0) );
    array[item++] = new TestCase( SECTION, "Date(1969,11,31,15,59,59)",     true, (new Date()).toString() ==    Date(1969,11,31,15,59,59))
    array[item++] = new TestCase( SECTION, "Date(1969,11,31,16,0,0)",       true, (new Date()).toString() ==    Date(1969,11,31,16,0,0))
    array[item++] = new TestCase( SECTION, "Date(1969,11,31,16,0,1)",       true, (new Date()).toString() ==    Date(1969,11,31,16,0,1))
/*
    // Dates around 2000
    array[item++] = new TestCase( SECTION, "Date(1999,11,15,59,59)",        true, (new Date()).toString() ==    Date(1999,11,15,59,59));
    array[item++] = new TestCase( SECTION, "Date(1999,11,16,0,0,0)",        true, (new Date()).toString() ==    Date(1999,11,16,0,0,0));
    array[item++] = new TestCase( SECTION, "Date(1999,11,31,23,59,59)",     true, (new Date()).toString() ==    Date(1999,11,31,23,59,59) );
    array[item++] = new TestCase( SECTION, "Date(2000,0,1,0,0,0)",          true, (new Date()).toString() ==    Date(2000,0,0,0,0,0) );
    array[item++] = new TestCase( SECTION, "Date(2000,0,1,0,0,1)",          true, (new Date()).toString() ==    Date(2000,0,0,0,0,1) );

    // Dates around 1900

    array[item++] = new TestCase( SECTION, "Date(1899,11,31,23,59,59)",     true, (new Date()).toString() ==    Date(1899,11,31,23,59,59));
    array[item++] = new TestCase( SECTION, "Date(1900,0,1,0,0,0)",          true, (new Date()).toString() ==    Date(1900,0,1,0,0,0) );
    array[item++] = new TestCase( SECTION, "Date(1900,0,1,0,0,1)",          true, (new Date()).toString() ==    Date(1900,0,1,0,0,1) );
    array[item++] = new TestCase( SECTION, "Date(1899,11,31,16,0,0,0)",     true, (new Date()).toString() ==    Date(1899,11,31,16,0,0,0));
