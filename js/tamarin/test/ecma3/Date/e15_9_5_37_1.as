...
//    addNewTestCase( "TDATE = new Date(0);(TDATE).setUTCFullYear(1969);TDATE",
    ...
    TDATE = new Date(UTC_FEB_29_1972);
    ...
    addNewTestCase( TDATE,
     ...
     TDATE = new Date(UTC_FEB_29_1972);
    TDATE.setUTCFullYear(2000,1,29);

    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(UTC_FEB_29_1972,2000,1,29)),
                    LocalDateFromTime(SetUTCFullYear(UTC_FEB_29_1972,2000,1,29)) );

    // Dates around 2005

    TDATE = new Date(0); TDATE.setUTCFullYear(2005);
    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(0,2005)),
                    LocalDateFromTime(SetUTCFullYear(0,2005)) );

    TDATE = new Date(0); TDATE.setUTCFullYear(2004);
    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(0,2004)),
                    LocalDateFromTime(SetUTCFullYear(0,2004)) );

    TDATE = new Date(0); TDATE.setUTCFullYear(2006);
    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(0,2006)),
                    LocalDateFromTime(SetUTCFullYear(0,2006)) );


    TDATE = new Date(0); TDATE.setUTCFullYear(1900);
    // Dates around 1900
    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(0,1900)),
                    LocalDateFromTime(SetUTCFullYear(0,1900)) );

    TDATE = new Date(0); TDATE.setUTCFullYear(1899);

    addNewTestCase( TDATE,
                    UTCDateFromTime(SetUTCFullYear(0,1899)),
                    LocalDateFromTime(SetUTCFullYear(0,1899)) );

    TDATE = new Date(0); TDATE.setUTCFullYear(1901);
