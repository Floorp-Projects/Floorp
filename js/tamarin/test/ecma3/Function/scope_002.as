...
function getTestCases() {
     ...
     * it was defined under the with(obj) block - self.hasOwnProperty('f') returns false as
     * f is in internal namespace - see bug 158180
     */
    ...
    /*
     * Explicitly verify that f exists at global level, even though
     * it was defined under the with(obj) block - 'f' in self returns false as
     * f is in internal namespace - see bug 158180
     */
