...
function getTestCases() {
    ...
    // number primitives
    var MYVAR = 0;
    array[item++] = new TestCase( SECTION, "var MYVAR=0;MYVAR--", 0, MYVAR-- );
     var MYVAR = 0.2345;
    array[item++] = new TestCase( SECTION, "var MYVAR=0.2345;MYVAR--", 0.2345, MYVAR-- );
    var MYVAR = -0.2345;
    array[item++] = new TestCase( SECTION, "var MYVAR=-0.2345;MYVAR--", -0.2345, MYVAR-- );
    ...
    array[item++] = new TestCase( SECTION,    "var MYVAR=new Boolean(true);MYVAR--",         1,     MYVAR-- );
    var MYVAR=new Boolean(false);
    array[item++] = new TestCase( SECTION,    "var MYVAR=new Boolean(false);MYVAR--",        0,     MYVAR-- );
    // verify value of variable
    var MYVAR=new Boolean(true);
    MYVAR--;
    ...
    var MYVAR='12345';
    array[item++] = new TestCase( SECTION,    "var MYVAR='12345';MYVAR--",          12345,          MYVAR-- );
    var MYVAR='-12345';
    array[item++] = new TestCase( SECTION,    "var MYVAR='-12345';MYVAR--",         -12345,         MYVAR-- );
    var MYVAR='0Xf';
    array[item++] = new TestCase( SECTION,    "var MYVAR='0Xf';MYVAR--",            15,             MYVAR-- );
    var MYVAR='077';
    array[item++] = new TestCase( SECTION,    "var MYVAR='077';MYVAR--",            77,             MYVAR-- );
    var MYVAR='';
    array[item++] = new TestCase( SECTION,    "var MYVAR=''; MYVAR--",              0,              MYVAR-- );
    ...
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('12345');MYVAR--",          12345,          MYVAR-- );
  
    var MYVAR=new String('-12345');
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('-12345');MYVAR--",         -12345,         MYVAR-- );
    var MYVAR=new String('0Xf');
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('0Xf');MYVAR--",            15,            MYVAR-- );
    var MYVAR=new String('077');
    array[item++] = new TestCase(SECTION,    "var MYVAR=new String('077');MYVAR--",            77,             MYVAR-- );
      var MYVAR=new String('');
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String(''); MYVAR--",              0,              MYVAR-- );
