...
function getTestCases() {
    ...
    array[item++] = new TestCase( SECTION,  "-('34string')",           Number.NaN,      -("34string") );
    array[item++] = new TestCase( SECTION,  "-('string63')",           Number.NaN,      -("string63") );
    array[item++] = new TestCase( SECTION,  "-('e47')",                Number.NaN,      -("e47") );
    array[item++] = new TestCase( SECTION,  "-('1e47')",               -1e47,           -("1e47") );
    array[item++] = new TestCase( SECTION,  "-1e47",                   -1e47,           -1e47 );
