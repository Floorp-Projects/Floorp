...
function getTestCases() {
	...
	VAR1 = 0XFF; VAR2 = 0XA;
    array[item++] = new TestCase( SECTION,    "VAR1 = 0xFF; VAR2 = 0xA, VAR1 /= VAR2", 25.5,      VAR1 /= VAR2);

    // special division cases
	VAR1 = 0; VAR2 = Number.POSITIVE_INFINITY; VAR1 /= VAR2; 
    array[item++] = new TestCase( SECTION,    "VAR1 = 0; VAR2= Infinity; VAR1 /= VAR2",    0,      VAR1);
    VAR1 = -0; VAR2 = Number.POSITIVE_INFINITY; VAR1 /= VAR2;
    array[item++] = new TestCase( SECTION,    "VAR1 = -0; VAR2= Infinity; VAR1 /= VAR2",   0,       VAR1 );
    ...
    array[item++] = new TestCase( SECTION,    "VAR1 = 0; VAR2= Infinity; VAR2 /= VAR1",    Number.POSITIVE_INFINITY,      VAR2);
    VAR1 = -0; VAR2 = Number.POSITIVE_INFINITY; VAR2 /= VAR1;
    array[item++] = new TestCase( SECTION,    "VAR1 = -0; VAR2= Infinity; VAR2 /= VAR1",   Number.NEGATIVE_INFINITY,       VAR2);
    VAR1 = -0; VAR2 = Number.NEGATIVE_INFINITY; VAR2 /= VAR1;
    array[item++] = new TestCase( SECTION,    "VAR1 = -0; VAR2= -Infinity; VAR2 /= VAR1",  Number.POSITIVE_INFINITY,       VAR2);
    VAR1 = 0; VAR2 = Number.NEGATIVE_INFINITY; VAR2 /= VAR1; 
    array[item++] = new TestCase( SECTION,    "VAR1 = 0; VAR2= -Infinity; VAR2 /= VAR1",   Number.NEGATIVE_INFINITY,      VAR2);
	VAR1 = Number.POSITIVE_INFINITY; VAR2 = Number.POSITIVE_INFINITY; VAR1 /= VAR2;
    array[item++] = new TestCase( SECTION,    "VAR1 = Infinity; VAR2= Infinity; VAR1 /= VAR2",   Number.NaN,       VAR1);
    ...
    array[item++] = new TestCase( SECTION,    "VAR1 = 1; VAR2= 0; VAR1 /= VAR2",    Number.POSITIVE_INFINITY,      VAR1 );
    VAR1 = 1; VAR2 = -0; VAR1 /= VAR2;
    array[item++] = new TestCase( SECTION,    "VAR1 = 1; VAR2= -0; VAR1 /= VAR2",   Number.NEGATIVE_INFINITY,       VAR1);
    VAR1 = -1; VAR2 = 0; VAR1 /= VAR2; 
    array[item++] = new TestCase( SECTION,    "VAR1 = -1; VAR2= 0; VAR1 /= VAR2",   Number.NEGATIVE_INFINITY,      VAR1);
    VAR1 = -1; VAR2 = -0; VAR1 /= VAR2; 
    array[item++] = new TestCase( SECTION,    "VAR1 = -1; VAR2= -0; VAR1 /= VAR2",  Number.POSITIVE_INFINITY,      VAR1);
    ...
    array[item++] = new TestCase( SECTION,    "VAR1 = 1000; VAR2 = '10', VAR1 /= VAR2; VAR1", 100,        VAR1);
    VAR1 = '1000'; VAR2 = 10, VAR1 /= VAR2;
    array[item++] = new TestCase( SECTION,    "VAR1 = '1000'; VAR2 = 10, VAR1 /= VAR2; VAR1", 100,        VAR1);
/*  
	VAR1 = 10; VAR2 = '0XFF'; 
