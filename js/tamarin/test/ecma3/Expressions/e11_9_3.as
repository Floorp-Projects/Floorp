...
function getTestCases() {
    ...
    array[item++] = new TestCase( SECTION,    "x = new MyObject(true); y = x; z = x; z == y",   true,  (x = new MyObject(true), y = x, z = x, z == y) );
    array[item++] = new TestCase( SECTION,    "x = new MyObject(false); y = x; z = x; z == y",  true,  (x = new MyObject(false), y = x, z = x, z == y) );
    array[item++] = new TestCase( SECTION,    "x = new Boolean(true); y = x; z = x; z == y",   true,  (x = new Boolean(true), y = x, z = x, z == y) );
    array[item++] = new TestCase( SECTION,    "x = new Boolean(false); y = x; z = x; z == y",   true,  (x = new Boolean(false), y = x, z = x, z == y) );
