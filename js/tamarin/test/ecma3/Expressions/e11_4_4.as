...
function getTestCases() {
    ...
    array[item++] = new TestCase( SECTION,    "var MYVAR=true;++MYVAR;MYVAR",   2,   MYVAR );
    ...
    // verify return value
    var MYVAR=true;
    array[item++] = new TestCase( SECTION,    "var MYVAR=new Boolean(true);++MYVAR",         2,     ++MYVAR );
    var MYVAR=false;
    ...
    var MYVAR='0Xf';
    array[item++] = new TestCase( SECTION,    "var MYVAR='0Xf';++MYVAR",            16,             ++MYVAR );
    var MYVAR='077';
    array[item++] = new TestCase( SECTION,    "var MYVAR='077';++MYVAR",            78,             ++MYVAR );
    var MYVAR='';
    ...
    var MYVAR='0xf';++MYVAR;
    array[item++] = new TestCase( SECTION,    "var MYVAR='0xf';++MYVAR;MYVAR",      16,             MYVAR );
    var MYVAR='077';++MYVAR;
    array[item++] = new TestCase( SECTION,    "var MYVAR='077';++MYVAR;MYVAR",      78,             MYVAR );
    var MYVAR='';++MYVAR;
    ...
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('0Xf');++MYVAR",            16,             ++MYVAR );
    var MYVAR=new String('077');
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('077');++MYVAR",            78,             ++MYVAR );
    ...
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('0xf');++MYVAR;MYVAR",      16,             MYVAR );
    var MYVAR=new String('077');++MYVAR;
    array[item++] = new TestCase( SECTION,    "var MYVAR=new String('077');++MYVAR;MYVAR",      78,             MYVAR );
