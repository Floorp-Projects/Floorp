...
inline bool isUnicodeWhiteSpace(unsigned short x)  { return (((x) == UNICODE_NOBREAK_SPACE) || ((x) == UNICODE_ZEROWIDTH_SPACE) || ((x) == UNICODE_WORDJOINER_SPACE) || ((x) == UNICODE_IDEOGRAPHIC_SPACE) || ((x) == UNICODE_ZEROWIDTH_NOBREAK_SPACE) ); } 
