...
| Feature | Source | Entrypoints | Description |
|---|---|---|---|
| guided-tour | `browser-features/chrome/common/guided-tour/index.ts` | `default class GuidedTour`, `init` | Owns the guided tour feature through the GuidedTour chrome component and wires `controller`, `components/TourOverlay`, `workspace-panel-guard`. |
