...
let __fakeDAVContents = {
  "meta/version" : "3",
  // Note that this private key is encrypted with the passphrase
  // "passhrase", provided by our testing infrastructure.
...
function checkpassphrase_coroutine() {
  ...
  //Uncomment this line to cause things to go amiss.
  //idRSA.setTempPassword("badpassphrase");
