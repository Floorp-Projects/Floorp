...
resource 'CURS' (138, locked, preload) {
	$"0000 0180 0180 0180 0180 1180 3180 7F80"
	$"7F80 3180 1180 0180 0180 0180 0180",
	$"03C0 03C0 03C0 03C0 1BC0 3BC0 7FC0 FFC0"
	$"FFC0 7FC0 3BC0 1BC0 03C0 03C0 03C0 03C0",
	{7, 7}
};
...
resource 'CURS' (140, locked, preload) {
	$"0000 0180 0180 0180 0180 0188 018C 01FE"
	$"01FE 018C 0188 0180 0180 0180 0180",
	$"03C0 03C0 03C0 03C0 03D8 03DC 03FE 03FF"
	$"03FF 03FE 03DC 03D8 03C0 03C0 03C0 03C0",
	{7, 7}
};
...
resource 'CURS' (144, locked, preload) {
	$"0000 4000 6000 7000 7800 7C00 7E00 7F00"
	$"7F80 7C18 6C18 467E 067E 0318 0318",
	$"C000 E000 F000 F800 FC00 FE00 FF00 FF80"
	$"FFFC FFFC FEFF EFFF CFFF 87FF 07BC 033C",
	{1, 1}
};

resource 'CURS' (145, locked, preload) {
	$"0000 4000 6000 7000 7800 7C00 7E00 7F00"
	$"7F80 7C1E 6C0E 461E 061A 0330 0330",
	$"C000 E000 F000 F800 FC00 FE00 FF00 FF80"
	$"FFFF FFBF FE3F EF3F CFFF 87FB 07F8 03F0",
	{1, 1}
};

resource 'CURS' (146, locked, preload) {
	$"0000 4000 6000 7000 7800 7C00 7E00 7F7E"
	$"7FFE 7C42 6C7E 4642 067E 0342 037E",
	$"C000 E000 F000 F800 FC00 FE00 FFFF FFFF"
	$"FFFF FFFF FEFF EFFF CFFF 87FF 07FF 03FF",
	{1, 1}
};

resource 'CURS' (147, locked, preload) {
	$"0180 1A70 2648 264A 124D 1249 6809 9801"
	$"8802 4002 2002 2004 1004 0808 0408 0408",
	$"0180 1BF0 3FF8 3FFA 1FFF 1FFF 6FFF FFFF"
	$"FFFE 7FFE 3FFE 3FFC 1FFC 0FF8 07F8 07F8",
...
resource 'CURS' (148, locked, preload) {
...
resource 'CURS' (149, locked, preload) {
	$"0000 4000 6000 7000 7800 7C00 7E00 7F00"
	$"7FB8 7C74 6CF2 46FE 069E 035C 0338",
