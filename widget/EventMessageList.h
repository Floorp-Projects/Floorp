...
NS_EVENT_MESSAGE(NS_PAGE_UNLOAD,        eStreamEventFirst + 1)
NS_EVENT_MESSAGE(NS_HASHCHANGE,         eStreamEventFirst + 2)
...
NS_EVENT_MESSAGE(NS_READYSTATECHANGE,   eStreamEventFirst + 8)
