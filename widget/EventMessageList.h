...
NS_EVENT_MESSAGE(NS_PAUSE,              eMediaEventFirst + 6)
NS_EVENT_MESSAGE(NS_LOADEDMETADATA,     eMediaEventFirst + 7)
NS_EVENT_MESSAGE(NS_LOADEDDATA,         eMediaEventFirst + 8)
NS_EVENT_MESSAGE(NS_WAITING,            eMediaEventFirst + 9)
...
NS_EVENT_MESSAGE(NS_SEEKED,             eMediaEventFirst + 14)
