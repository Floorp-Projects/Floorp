...
private:
  ...
  DECL_OVERRIDE_PREF(Live, "layers.advanced.background-image", LayersAllowBackgroundImage, gfxPrefs::OverrideBase_WebRenderAll());
  DECL_OVERRIDE_PREF(Live, "layers.advanced.border-layers",    LayersAllowBorderLayers, gfxPrefs::OverrideBase_WebRenderAll());
  ...
  DECL_OVERRIDE_PREF(Live, "layers.advanced.bullet-layers",         LayersAllowBulletLayers, bool, gfxPrefs::OverrideBase_WebRenderAll());
  ...
  DECL_OVERRIDE_PREF(Live, "layers.advanced.canvas-background-color", LayersAllowCanvasBackgroundColorLayers, bool, gfxPrefs::OverrideBase_WebRenderAll());
  DECL_OVERRIDE_PREF(Live, "layers.advanced.caret-layers",     LayersAllowCaretLayers, gfxPrefs::OverrideBase_WebRender());
  DECL_OVERRIDE_PREF(Live, "layers.advanced.columnRule-layers",     LayersAllowColumnRuleLayers, bool, gfxPrefs::OverrideBase_WebRenderAll());
