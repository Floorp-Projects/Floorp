...
bool gfxAlphaRecovery::RecoverAlphaSSE2(gfxImageSurface* blackSurf,
  ...
  static const batch_type greenMask = {0x00, 0x00, 0xff, 0x00, 0x00, 0x00,
                                       0xff, 0x00, 0x00, 0x00, 0xff, 0x00,
                                       0x00, 0x00, 0xff, 0x00};
  static const batch_type alphaMask = {0xff, 0x00, 0x00, 0x00, 0xff, 0x00,
  ...
  for (int32_t i = 0; i < size.height; ++i) {
    ...
    for (; j < size.width - 8; j += 8) {
      ...
      // anyway.
      black1 = xsimd::bitwise_andnot(alphaMask, black1);
      black2 = xsimd::bitwise_andnot(alphaMask, black2);
      white1 = xsimd::slide_left<2>(white1);
      white2 = xsimd::slide_left<2>(white2);
      white1 = alphaMask & white1;
      white2 = alphaMask & white2;
      black1 = white1 | black1;
      black2 = white2 | black2;
    ...
    for (; j < size.width - 4; j += 4) {
      ...
      black = xsimd::bitwise_andnot(alphaMask, black);
      white = xsimd::slide_left<2>(white);
      white = alphaMask & white;
      black = white | black;
