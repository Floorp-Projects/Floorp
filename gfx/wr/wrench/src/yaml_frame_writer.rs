        ...
        loop {
            ...
            match *base.item() {
                ...
                DisplayItem::PushStackingContext(item) => {
                    ...
                    bool_node(&mut v, "backface-visible", item.prim_flags.contains(PrimitiveFlags::IS_BACKFACE_VISIBLE));
                    bool_node(&mut v, "scrollbar-container", item.prim_flags.contains(PrimitiveFlags::IS_SCROLLBAR_CONTAINER));
                    bool_node(&mut v, "scrollbar-thumb", item.prim_flags.contains(PrimitiveFlags::IS_SCROLLBAR_THUMB));
