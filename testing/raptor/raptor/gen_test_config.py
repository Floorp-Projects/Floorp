...
def gen_test_config(browser, test, cs_port, post_startup_delay, host='127.0.0.1', b_port=0):
...
""" % (browser, cs_port, test, host, cs_port, test, post_startup_delay, b_port, host)
