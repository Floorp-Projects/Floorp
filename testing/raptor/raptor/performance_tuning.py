...
class PerformanceTuner(object):
    ...
    def set_cpu_performance_parameters(self, device_name=None):
        ...
        if device_name == 'Pixel 2':
            ...
            self.log.info("CPU for device with ro.product.model '{}' unknown, not scaling_governor"
                          .format(device_name))
    ...
    def set_gpu_performance_parameters(self, device_name=None):
        ...
        if device_name == 'Pixel 2':
            ...
            self.log.info("GPU for device with ro.product.model '{}' unknown, not setting devfreq"
                          .format(device_name))
