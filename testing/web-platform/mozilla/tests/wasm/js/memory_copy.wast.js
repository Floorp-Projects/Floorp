...
// memory_copy.wast:4921
assert_trap(() => call($24, "test", []));

// memory_copy.wast:4923
...
// memory_copy.wast:4927
assert_trap(() => call($25, "test", []));

// memory_copy.wast:4929
...
// memory_copy.wast:4957
run(() => call($27, "test", []));

// memory_copy.wast:4959
...
// memory_copy.wast:4963
run(() => call($28, "test", []));

// memory_copy.wast:4965
...
// memory_copy.wast:4969
run(() => call($29, "test", []));

// memory_copy.wast:4971
...
// memory_copy.wast:4975
run(() => call($30, "test", []));

// memory_copy.wast:4977
...
// memory_copy.wast:4981
run(() => call($31, "test", []));

// memory_copy.wast:4983
