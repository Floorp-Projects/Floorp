# test config['xperf_path'] doens't have double quotes
# test config['webserver'] has free port
...
class Test_get_config(object):
    ...
    def test_perf_reftest_has_expected_attributes(self):
        ...
        assert test_config['base_vs_ref'] is True  # compare the two test pages with eachother and report comparison
