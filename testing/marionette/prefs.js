...
class MarionetteBranch extends Branch {
  ...
  /**
   * Gets the `marionette.enabled` preference.  When it returns true,
  ...
  /**
   * Sets the `marionette.enabled` preference.  Note that setting
   * this to true will start the Marionette server.
   *
  ...
  /**
   * Gets the `marionette.port` preference, detailing which port
  ...
  /**
   * Sets the `marionette.port` preference to `newPort`.  Setting this
   * whilst the server is running will have no effect.
   *
