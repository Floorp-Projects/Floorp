...
#ifndef __FORM_SELECT_ONE_H
#define __FORM_SELECT_ONE_H
...
class CFormSelectOne : public CFormElement	{
//	Construction/destruction.
//	Do not construct directly, use GetFormElement instead.
protected:
	CFormSelectOne();
	virtual ~CFormSelectOne();
	friend CFormElement;
...
//	Our widget representation.
private:
	CMochaComboBox *m_pWidget;
};

#endif // __FORM_SELECT_ONE_H
