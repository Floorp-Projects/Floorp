...
#ifndef __FORM_SELECT_MULT_H
#define __FORM_SELECT_MULT_H
...
class CFormSelectMult : public CFormElement	{
//	Construction/destruction.
//	Do not construct directly, use GetFormElement instead.
protected:
	CFormSelectMult();
	virtual ~CFormSelectMult();
	friend CFormElement;
...
private:
	CMochaListBox *m_pWidget;
};

#endif // __FORM_SELECT_MULT_H
