...
ICONGROUP_VERBOSE(BM_Folder, &BM_Folder, NULL, &BM_FolderO, NULL)
ICONGROUP_VERBOSE(BM_FolderO, &BM_FolderO, NULL, NULL, NULL)
ICONGROUP_VERBOSE(BM_MenuFolder, &BM_MenuFolder, NULL, &BM_MenuFolderO, NULL)
ICONGROUP_VERBOSE(BM_MenuFolderO, &BM_MenuFolderO, NULL, NULL, NULL)
ICONGROUP_VERBOSE(BM_NewAndMenuFolder, &BM_NewAndMenuFolder, NULL, &BM_NewAndMenuFolderO, NULL)
ICONGROUP_VERBOSE(BM_NewAndMenuFolderO, &BM_NewAndMenuFolderO, NULL, NULL, NULL)
ICONGROUP_VERBOSE(BM_NewFolder, &BM_NewFolder, NULL, &BM_NewFolderO, NULL)
