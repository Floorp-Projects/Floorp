...
resource 'STR ' ( MALLOC_HEAP_LOW_RESID,
	...
	, purgeable ) {
#ifdef MOZ_LITE
	"Navigator is running out of memory.  It is recomended that you quit other running applications or close Navigator windows to continue running this program.";
#else
	"Communicator is running out of memory.  It is recomended that you quit other running applications or close Communicator windows to continue running this program.";
#endif
};
