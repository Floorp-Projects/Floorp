...
//classes.title.all.fontWeight="normal";
document.classes.title.all.lineHeight="1";
//classes.title.all.textAlign="left";
document.classes.title.all.marginTop="29";
...
document.classes.buttontext.all.fontSize="11px";
document.classes.buttontext.all.marginLeft="0";
document.classes.tty.all.marginLeft="20";
document.classes.tty.all.width="230";
document.classes.tty.all.fontSize="11px";
document.classes.tty.all.marginTop="-12";
document.classes.clayer.all.fontFamily="PrimaSans BT,Helvetica,Arial";
document.classes.clayer.all.fontSize="10";
document.classes.clayer.all.color="#FFFFFF";
