...
function loadData()
{
	...
	setCheckBox(asFormName, "asktty", parent.parent.globals.GetNameValuePair(acctSetupFile,existingSectionName,"AskTTY"));			
...
function saveData()
{
	...
	if (acctSetupFile != null && acctSetupFile != "")	{
		 parent.parent.globals.SetNameValuePair(acctSetupFile, existingSectionName, "AskTTY", getCheckBox(asFormName, "asktty"));	
	}  // if (acctSetupFile != null && acctSetupFile != "")	
}
