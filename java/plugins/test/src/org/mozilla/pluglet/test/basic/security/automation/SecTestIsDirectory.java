...
public class SecTestIsDirectory implements Test {

private String description = " File.isDirectory()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestIsDirectory.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
