...
public class  PlugletStreamInfo_getContentType_Iterator implements TestListIterator
{
    ...
    *
    */
   public PlugletStreamInfo_getContentType_Iterator()
   {
   ...
   { 
	...
	return false;
      ...
      if (flag == 0) //Only one time we should work
      { 
