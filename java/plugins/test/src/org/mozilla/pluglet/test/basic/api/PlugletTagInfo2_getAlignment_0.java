...
public class PlugletTagInfo2_getAlignment_0  implements Test
{
    ...
    *
    */
   public PlugletTagInfo2_getAlignment_0()
   {
   }
   ...
   {	
	...
	if( context == null ) {
	   TestContext.registerFAILED("ERROR:null context passed in execute(TestContext) of PlugletTagInfo2_getAlignment_0");
	   return;
	}
