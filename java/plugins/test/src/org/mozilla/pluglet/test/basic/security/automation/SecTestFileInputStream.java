...
public class SecTestFileInputStream implements Test {

private String description = " new FileInputStream()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestFileInputStream.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
 String testDir = c.getTestDir();
 fName = testDir + "/" + c.getProperty("SecTestFileInputStream.fName");
