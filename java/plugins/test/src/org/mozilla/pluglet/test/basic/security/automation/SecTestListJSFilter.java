...
public class SecTestListJSFilter implements Test {

private String description = " File.list(s) ";
private boolean mustPass;

public void doAction() {
	File f = new File("foo");
	f.list( new JavaSrcFilter() ); 
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestListJSFilter.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
