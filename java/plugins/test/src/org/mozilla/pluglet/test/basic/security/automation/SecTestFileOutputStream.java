...
public class SecTestFileOutputStream implements Test {

private String description = " new FileOutputStream()";
private boolean mustPass;

public void doAction() throws Exception {
	FileOutputStream fs;
    	fs = new FileOutputStream("foo");
}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestFileOutputStream.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
