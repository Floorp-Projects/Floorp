...
public class SecTestPrintStream implements Test {

private String description = " PrintStream.print()";
...
public void doAction() throws Exception {
	...
	PrintStream ps = new PrintStream(
				new BufferedOutputStream(
				    new FileOutputStream("mrm"),
				    128 ),
			        true );
	ps.println( "writing to mrm" );
}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestPrintStream.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
