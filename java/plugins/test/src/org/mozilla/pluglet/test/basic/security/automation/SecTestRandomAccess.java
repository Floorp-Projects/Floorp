...
public class SecTestRandomAccess implements Test {

private String description = " RandomAccessFile I/O";
private boolean mustPass;

public void doAction() throws Exception {
   String access = "r";
   RandomAccessFile r = new RandomAccessFile( "foo", access );
}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestRandomAccess.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
