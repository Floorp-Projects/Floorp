...
public class SecTestGetAbsolutePath implements Test {

private String description = " File.getAbsolutePath()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetAbsolutePath.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
