...
public class SecTestGetSecMgr implements Test {

private String description = " getSecurityManager";
private boolean mustPass;

public void doAction() {
        SecurityManager x = System.getSecurityManager();
}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetSecMgr.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
