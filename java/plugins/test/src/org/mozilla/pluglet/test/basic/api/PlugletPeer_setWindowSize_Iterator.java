...
public class  PlugletPeer_setWindowSize_Iterator implements TestListIterator
{
    ...
    *
    */
   public PlugletPeer_setWindowSize_Iterator()
   {
   ...
   { 
	...
	paramValue[i] = pstr.substring(last,pstr.length());
       ...
       Object result = null;
        ...
        // Parameter number 1,parameter type is int
        try {
           if (paramValue[1].equals("Integer.MIN_VALUE"))
           {
              result = (Object)(new Integer(Integer.MIN_VALUE));
           } else if (paramValue[1].equals("Integer.MAX_VALUE"))
           {
              result = (Object)(new Integer(Integer.MAX_VALUE));
           } else if (paramValue[1].equals("0"))
           {
              result = (Object)(new Integer(0));
           } else 
           {
              result = (Object)(new Integer(paramValue[1]));
           }
        }catch(NumberFormatException  e)
        {
           System.err.println("NumberFormatException thrown when compiling Integer value. Wrong parameter");
