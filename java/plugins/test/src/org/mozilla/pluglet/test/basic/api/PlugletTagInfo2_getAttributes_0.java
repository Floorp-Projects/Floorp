...
public class PlugletTagInfo2_getAttributes_0  implements Test
{
    ...
    *
    */
   public PlugletTagInfo2_getAttributes_0()
   {
   }
   ...
   {	
	...
	if( context == null ) {
	   TestContext.registerFAILED("ERROR:null context passed in execute(TestContext)" +
				      " of PlugletTagInfo2_getAttributes_0");
	   return;
	}
   ...
   public static void verifyAttributes(String attrString) 
   {
     ...
     if (attrsForVerify == null) {
       TestContext.registerFAILED("null value returned by PlugletTagInfo2_getAttributes");
       return;
     }
     ...
     TestContext.registerPASSED("All attributes transfered from JavaScript exists in attributes, " + 
				" returned by PlugletTagInfo2_getAttributes");
   }
   /**
    *
    ***********************************************************
