...
public class SecTestGetProps implements Test {

private String description = " call getProperties()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetProps.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
