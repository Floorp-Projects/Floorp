...
public class  PlugletStreamInfo_requestRead_Iterator implements TestListIterator
{
    ...
    *
    */
   public PlugletStreamInfo_requestRead_Iterator()
   {
   ...
   { 
	...
	paramValue[i] = paramValue[i].trim();
        ...
        // Parameter number 0,parameter type is ByteRanges
        //result = (Object)(paramValue[0].equals("null") ? null : context.getByteRanges());
        if (paramValue[0].equals("null"))
	{
	  result = (Object)(null);
	} else if (paramValue[0].equals("correct_ranges"))
	{
	  result = (Object)(new ByteRanges());
	} else if (paramValue[0].equals("incorrect_ranges"))
	{
	  ByteRanges br = new ByteRanges();
	  br.addRange(-100,-200);
	  result = (Object)br;
        } else 
	{
	  TestContext.registerFAILED("\nPlugletStreamInfo_requestRead_Iterator doesn't know what's do with \"" + paramValue[0] + "\" value for ByteRanges\n");
	}
