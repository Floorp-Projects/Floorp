...
public class SecTestGetParent implements Test {

private String description = " File.getParent()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetParent.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
