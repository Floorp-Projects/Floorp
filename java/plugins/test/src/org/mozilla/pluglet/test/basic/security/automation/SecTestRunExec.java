...
public class SecTestRunExec implements Test {

private String description = " call Runtime.exec()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestRunExec.mustPass").equals( new String("true") )) {
	mustPass = true;
 };

 fExec = c.getProperty("SecTestRunExec.fExec");
