...
public class SecTestGetCanonicalPath implements Test {

private String description = " File.getCanonicalPath()";
private boolean mustPass;

public void doAction() throws Exception {
	File	f	= new File("foo");
	String	value	= f.getCanonicalPath();
	if (value != null)
	{
		System.out.println("Value of Absolute path is " + value);
	}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetCanonicalPath.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
