...
public class PlugletTagInfo2_getTagText_0  implements Test
{
    ...
    *
    */
   public PlugletTagInfo2_getTagText_0()
   {
   }
   ...
   {	
	...
	if( context == null ) {
	   TestContext.registerFAILED("ERROR:null context passed in execute(TestContext) of PlugletTagInfo2_getTagText_0");
	   return;
	}
	...
	String rt =	PlugletTagInfo2_obj.getTagText();
	System.err.println("PlugletTagInfo2_getTagText returns \"" + rt + "\" value");
   }
