...
public class SecTestRunLoadLib implements Test {

private String description = " call Runtime.loadLib()";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestRunLoadLib.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
 libName = c.getProperty("SecTestRunLoadLib.libName");
