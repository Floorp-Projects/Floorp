...
public class PlugletTagInfo2_getBorderHorizSpace_0  implements Test
{
   private static int HSpace = -1;
    ...
    *
    */
   public PlugletTagInfo2_getBorderHorizSpace_0()
   {
   }
   ...
   {	
	...
	if( context == null ) {
	   TestContext.registerFAILED("ERROR:null context passed in execute(TestContext)" +
				      " of PlugletTagInfo2_getBorderHorizSpace_0");
	   return;
	}
