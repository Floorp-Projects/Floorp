...
public class  PlugletPeer_getValue_Iterator implements TestListIterator
{
    ...
    *
    */
   public PlugletPeer_getValue_Iterator()
   {       
   }
   /**
    *
   ...
   { 
	...
	paramValue[i] = pstr.substring(last,pstr.length());
       ...
       Object result = null;
        ...
        // Parameter number 0,parameter type is int
        try {
           if (paramValue[0].equals("Integer.MIN_VALUE"))
           {
              result = (Object)(new Integer(Integer.MIN_VALUE));
           } else if (paramValue[0].equals("Integer.MAX_VALUE"))
           {
              result = (Object)(new Integer(Integer.MAX_VALUE));
           } else if (paramValue[0].equals("0"))
           {
              result = (Object)(new Integer(0));
           } else 
           {
              result = (Object)(new Integer(paramValue[0]));
           }
