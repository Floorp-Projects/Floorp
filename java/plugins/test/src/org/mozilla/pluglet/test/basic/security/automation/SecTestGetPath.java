...
public class SecTestGetPath implements Test {

private String description = " File.getPath()";
private String fName;
private boolean mustPass;

public void doAction() {
	File	f	= new File( fName );
	String	value	= f.getPath();
}
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestGetPath.mustPass").equals( new String("true") )) {
	mustPass = true;
 };

 fName = c.getProperty("SecTestGetPath.fName");
