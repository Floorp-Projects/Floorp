...
public class SecTestXPropAcc implements Test {

private String description = " Access All Properties";
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestXPropAcc.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
