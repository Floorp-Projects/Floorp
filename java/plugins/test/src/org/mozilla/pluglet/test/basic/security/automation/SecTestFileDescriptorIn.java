...
public class SecTestFileDescriptorIn implements Test {

private String description = " open FileDescriptor()";
boolean mustPass;
...
public void execute( TestContext c ) {
 ...
 if (c.getProperty("SecTestFileDescriptorIn.mustPass").equals( new String("true") )) {
	mustPass = true;
 };
