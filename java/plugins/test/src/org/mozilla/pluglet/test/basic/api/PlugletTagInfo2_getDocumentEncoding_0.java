...
public class PlugletTagInfo2_getDocumentEncoding_0  implements Test
{
    ...
    *
    */
   public PlugletTagInfo2_getDocumentEncoding_0()
   {
   }
   ...
   {	
	...
	if( context == null ) {
	   TestContext.registerFAILED("ERROR:null context passed in execute(TestContext) of PlugletTagInfo2_getDocumentEncoding_0");
	   return;
	}
	...
	String rt =	PlugletTagInfo2_obj.getDocumentEncoding();
	System.err.println("PlugletTagInfo2_getDocumentEncoding returns \"" + rt + "\" value");
   }
