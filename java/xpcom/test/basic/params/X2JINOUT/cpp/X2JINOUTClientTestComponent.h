...
#include "iX2JINOUTClientTestComponent.h"
#include "iX2JINOUTServerTestComponent.h"
...
class X2JINOUTClientTestComponentImpl : public iX2JINOUTClientTestComponent,
					public iClientTestComponent,
					public iExclusionSupport
{
 public:
	X2JINOUTClientTestComponentImpl();
	virtual ~X2JINOUTClientTestComponentImpl();
	void TestByte(void);
	void TestShort(void);
	void TestLong(void);
