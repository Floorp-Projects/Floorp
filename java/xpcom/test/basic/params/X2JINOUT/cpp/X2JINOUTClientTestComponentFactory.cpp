...
NS_GENERIC_FACTORY_CONSTRUCTOR(X2JINOUTClientTestComponentImpl)

static nsModuleComponentInfo components[] =
{
 {"X2JINOUT Client Test Component",
...
NS_IMPL_NSGETMODULE("X2JINOUTClientTestComponentFactory", components)
