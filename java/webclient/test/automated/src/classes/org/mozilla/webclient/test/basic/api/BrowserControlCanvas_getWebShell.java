...
/*
 * BrowserControlCanvas_getWebShell.java
 */
...
public class BrowserControlCanvas_getWebShell implements Test
{
    ...
    public void execute() {      
       ...
       try{
            BrowserControl brControl = (BrowserControl)browserCanvas.getWebShell();
            if(brControl.equals(browserControl)){
              TestContext.registerPASSED("getWebShell return correct BrowserControl");
              return;
            }else{
              TestContext.registerFAILED("getWebShell return incorrect BrowserControl");
              return;
            }
       }catch(Exception e) {
