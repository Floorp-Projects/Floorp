...
public class BookmarkEntry_remove_1 implements Test
{
...
int index=java.lang.Integer.parseInt(st.nextToken());
	...
	context.setDefaultComment("We are trying to remove child at index="+index);
   try {
	...
	node.remove(index);
// Will be done after remove(int) implementation;
