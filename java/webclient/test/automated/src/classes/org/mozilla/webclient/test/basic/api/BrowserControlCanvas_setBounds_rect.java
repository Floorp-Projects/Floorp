...
/*
 * BrowserControlCanvas_setBounds_rect.java
 */
...
public class BrowserControlCanvas_setBounds_rect implements Test
{
    ...
    public void execute() {      
       ...
       try{
            rect = new Rectangle(currentArg1, currentArg2, currentArg3, currentArg4);
            if(currentArg1==0&&currentArg2==0&&currentArg3==0&&currentArg4==0){
                rect = null;
            }
            browserCanvas.setBounds(rect);
            if(getResult()){
            ...
            if((e instanceof java.lang.NullPointerException)&&(rect == null)){
                TestContext.registerPASSED("NullPointerException catched, but the Rectangle is NULL!Exception is: " + e.toString());
                return;
