...
public class BookmarkEntry_remove_2 implements Test
{
...
int num=java.lang.Integer.parseInt(st.nextToken());
	...
	context.setDefaultComment("We are trying to remove node");
   try {
	...
	node.remove(node);
// Will be done after remove(MutableTreeNode) implementation;
