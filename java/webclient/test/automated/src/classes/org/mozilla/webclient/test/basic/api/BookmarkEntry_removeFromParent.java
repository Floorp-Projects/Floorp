...
/*
 * BookmarkEntry_removeFromParent.java
 */
...
public class BookmarkEntry_removeFromParent implements Test
{
...
public void execute() {      
  ...
  if (bookmarks==null) return;
	...
	context.setDefaultComment("We are trying to remove node from its parent");
    try {
...
// Will be done after removeFromParent() implementation;
