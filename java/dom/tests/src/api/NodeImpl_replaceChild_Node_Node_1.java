...
public class NodeImpl_replaceChild_Node_Node_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_replaceChild_Node_Node_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
                ...
                Node iNode = n.replaceChild(null, oldChild);
		if (iNode != null)
                {
                   TestLoader.logErrPrint("Cannot Replace NULL node");
                   return BWBaseTest.FAILED;
                }
