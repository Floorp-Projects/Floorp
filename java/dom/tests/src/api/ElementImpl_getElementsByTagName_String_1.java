...
public class ElementImpl_getElementsByTagName_String_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public ElementImpl_getElementsByTagName_String_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
		...
		if (n == null) {
                  TestLoader.logErrPrint("Element 'getElementsByTagName(*)' FAILED... ");
                  return BWBaseTest.FAILED;
                }
             }
      } else {
