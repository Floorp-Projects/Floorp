...
public class NodeImpl_getParentNode extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
		     ...
		     if (pNode == null)
                     {
                       TestLoader.logErrPrint("Could not getParentNode for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
