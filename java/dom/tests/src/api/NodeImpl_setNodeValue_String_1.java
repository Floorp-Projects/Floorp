...
public class NodeImpl_setNodeValue_String_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_setNodeValue_String_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         String newval = "mybody";
         a.setNodeValue(newval);
         if ((a.getNodeValue()).compareTo(newval) != 0)
         {
