...
public class NodeImpl_getNodeValue extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     String retstr = n.getNodeValue();
		     if (retstr == null)
                     {
                       TestLoader.logErrPrint("Could not getNodeValue for Node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
