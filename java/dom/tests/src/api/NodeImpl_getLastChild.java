...
public class NodeImpl_getLastChild extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node cNode = n.getLastChild();
		     if (cNode == null)
                     {
                       TestLoader.logErrPrint("Could not getLastChild for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
