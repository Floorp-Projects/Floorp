 ...
 *  TESTID 
 * 
 *  Tests out the ElementImpl->removeAttributeNode(null) method.
 *
 */
...
public class ElementImpl_removeAttributeNode_Attr_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public ElementImpl_removeAttributeNode_Attr_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	     ...
	     if (e == null) {
                ...
                Attr rattr = e.removeAttributeNode(null);
		if (rattr != null) {
                  TestLoader.logErrPrint("Element 'removeAttributeNode(null) FAILED... ");
                  return BWBaseTest.FAILED;
                } 
             }
      } else {
