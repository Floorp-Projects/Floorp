...
public class NodeImpl_cloneNode_boolean_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_cloneNode_boolean_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
		     ...
		     if (nNode == null)
                     {
                       TestLoader.logErrPrint("Could not clone Node " +nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
