...
public class NamedNodeMapImpl_getNamedItem_String_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_getNamedItem_String_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             Node n  = map.getNamedItem(null);
             if (n != null)
             {
                TestLoader.logErrPrint(" Could not find namedItem for NULL attribute ");
                return BWBaseTest.FAILED;
             }
         } else {
