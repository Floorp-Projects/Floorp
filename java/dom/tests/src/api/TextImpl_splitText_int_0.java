...
public class TextImpl_splitText_int_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public TextImpl_splitText_int_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
		...
		TextImpl t = (TextImpl)tn.splitText(offset);
		if (t == null) {
                  TestLoader.logErrPrint("Text 'spliteText(minval)' is NULL ...");
                  return BWBaseTest.FAILED;
                }
             }
      } else {
