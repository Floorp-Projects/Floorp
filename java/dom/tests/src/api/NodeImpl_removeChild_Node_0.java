...
public class NodeImpl_removeChild_Node_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_removeChild_Node_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         Element newel = d.createElement(newelname);
         if (newel == null)
         {
	    ...
	    {
                Node rNode = n.removeChild(null);
		if (rNode != null)
                {
                   TestLoader.logErrPrint("NULL node cannot be  removed...");
                   return BWBaseTest.FAILED;
                }
            }
         } else {
