...
public class NodeImpl_getAttributes extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node addedNode = n.appendChild(e);
                     NamedNodeMap map = n.getAttributes();
		     if (map == null)
                     {
                       TestLoader.logErrPrint("Could not getAttributes for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
