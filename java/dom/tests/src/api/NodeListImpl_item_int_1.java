...
public class NodeListImpl_item_int_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeListImpl_item_int_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
             ...
             if (nl == null)
             {
                ...
                Node n = nl.item(Integer.MAX_VALUE);
                if (n != null)
                {
                   TestLoader.logErrPrint("NodeList Item is not null for item " + Integer.MAX_VALUE);
                   return BWBaseTest.FAILED;
                }
             }
      } else {
