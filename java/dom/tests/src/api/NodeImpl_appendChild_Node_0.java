...
public class NodeImpl_appendChild_Node_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_appendChild_Node_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node scriptNode = n.appendChild(null);
		     if (scriptNode != null)
                     {
                       TestLoader.logErrPrint("Could append NULL Child Node under node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
