...
public class NodeImpl_insertBefore_Node_Node_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_insertBefore_Node_Node_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
                ...
                Node iNode = n.insertBefore(null, refChild);
		if (iNode != null)
                {
