...
public class NamedNodeMapImpl_getNamedItem_String_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_getNamedItem_String_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             ...
             if (n == null)
             {
                TestLoader.logErrPrint(" Could not find namedItem for attribute " + attrName);
                return BWBaseTest.FAILED;
             }
         } else {
