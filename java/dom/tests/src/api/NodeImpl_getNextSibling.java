...
public class NodeImpl_getNextSibling extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_getNextSibling()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node sNode = n.getNextSibling();
		     if (sNode == null)
                     {
                       TestLoader.logErrPrint("Could inot getNextSibling for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
