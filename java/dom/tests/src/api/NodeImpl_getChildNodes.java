...
public class NodeImpl_getChildNodes extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
		     ...
		     if (childList == null)
                     {
                       TestLoader.logErrPrint("Could not get childNodes for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
