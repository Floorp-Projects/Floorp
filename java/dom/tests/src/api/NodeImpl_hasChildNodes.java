...
public class NodeImpl_hasChildNodes extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
                     if (!(n.hasChildNodes()))
                     {
                       TestLoader.logErrPrint("Node " + nodename + "  has Child Nodes...");
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
