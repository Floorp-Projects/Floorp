...
public class NodeImpl_cloneNode_boolean_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_cloneNode_boolean_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node nNode = n.cloneNode(true);
		     if (nNode == null)
                     {
                       TestLoader.logErrPrint("Could not cloneNode " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
