...
public class NodeImpl_getPreviousSibling extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_getPreviousSibling()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node pNode = n.getPreviousSibling();
		     if (pNode == null)
                     {
                       TestLoader.logErrPrint("Could not getPreviousSibling for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
