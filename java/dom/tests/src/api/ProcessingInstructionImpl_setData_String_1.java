...
public class ProcessingInstructionImpl_setData_String_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public ProcessingInstructionImpl_setData_String_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	     ...
	     if (pi == null) {
                ...
                String newData = "version=\"1.0\" standalone=\"yes\"";
		pi.setData(newData);
		if ((pi.getData()).compareTo(newData) != 0)
                {
                  TestLoader.logErrPrint("Processing Instruction setData with value " + newData + "  failed for target " + target);
                  return BWBaseTest.FAILED;
                }
             }
      } else {
