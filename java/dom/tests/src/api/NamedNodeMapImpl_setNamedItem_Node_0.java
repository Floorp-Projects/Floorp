...
public class NamedNodeMapImpl_setNamedItem_Node_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_setNamedItem_Node_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             Node n  = map.setNamedItem(null);
             if (n != null)
             {
                TestLoader.logErrPrint(" Could set namedItem with NULL Node ");
                return BWBaseTest.FAILED;
             }
         } else {
