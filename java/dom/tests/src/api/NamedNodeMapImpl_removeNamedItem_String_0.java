...
public class NamedNodeMapImpl_removeNamedItem_String_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_removeNamedItem_String_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             Node n  = map.removeNamedItem(null);
             if (n != null)
             {
                TestLoader.logErrPrint(" Found an NULL entry item....");
                return BWBaseTest.FAILED;
             }
         } else {
