...
public class NamedNodeMapImpl_item_int_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_item_int_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             Node n  = map.item(Integer.MIN_VALUE);
             if (n != null)
             {
                TestLoader.logErrPrint(" Could find node for item " + Integer.MIN_VALUE);
                return BWBaseTest.FAILED;
             }
         } else {
