...
public class NamedNodeMapImpl_item_int_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_item_int_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             Node n  = map.item(Integer.MAX_VALUE);
             if (n != null)
             {
                TestLoader.logErrPrint(" Could find node for item " + Integer.MAX_VALUE);
                return BWBaseTest.FAILED;
             }
         } else {
