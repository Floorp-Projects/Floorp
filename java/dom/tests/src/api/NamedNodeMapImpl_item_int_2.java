...
public class NamedNodeMapImpl_item_int_2 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NamedNodeMapImpl_item_int_2()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         if (map != null) 
         {
             ...
             if (n == null)
             {
                TestLoader.logErrPrint(" Could find node for item 0...");
                return BWBaseTest.FAILED;
             }
         } else {
