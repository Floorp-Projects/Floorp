...
public class TextImpl_splitText_int_2 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public TextImpl_splitText_int_2()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
		...
		if (t == null) {
                  TestLoader.logErrPrint("Text 'spliteText(9)' is NULL ...");
                  return BWBaseTest.FAILED;
                }
             }
      } else {
