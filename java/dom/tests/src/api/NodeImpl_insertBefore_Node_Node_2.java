...
public class NodeImpl_insertBefore_Node_Node_2 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_insertBefore_Node_Node_2()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
         ...
         Element newChild = d.createElement(newelname);
         if (newChild == null)
         {
