...
public class NodeImpl_equals_Object_2 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_equals_Object_2()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node nNode = n.cloneNode(false);
		     if (nNode == null)
                     {
                       TestLoader.logErrPrint("Could not clone Child " +elname);
                       return BWBaseTest.FAILED;
                     }
		     ...
		     if (nNode.equals(n))
                     {
                       ...
                       TestLoader.logErrPrint("Nodes are equal " );
                     }
            }
         } else {
