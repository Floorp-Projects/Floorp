...
public class NodeImpl_getNodeType extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     int type = (int)n.getNodeType();
		     if ( type != Node.ELEMENT_NODE)
                     {
                       TestLoader.logErrPrint("Unknown NodeType found for node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
