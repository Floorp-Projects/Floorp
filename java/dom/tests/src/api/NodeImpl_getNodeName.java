...
public class NodeImpl_getNodeName extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (str == null || (str.compareTo(nodename) != 0))
	    {
                 TestLoader.logErrPrint("Could not getNodeName for Node " + nodename);
                 return BWBaseTest.FAILED;
            } 
         } else {
