...
public class NodeImpl_replaceChild_Node_Node_0 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_replaceChild_Node_Node_0()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                Node rNode = n.replaceChild(null, null);
		if (rNode != null)
                {
                   TestLoader.logErrPrint("NULL node cannot be replaced...");
                   return BWBaseTest.FAILED;
                }
            }
         } else {
