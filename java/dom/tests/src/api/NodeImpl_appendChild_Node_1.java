...
public class NodeImpl_appendChild_Node_1 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_appendChild_Node_1()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    {
                     Node scriptNode = n.appendChild(e);
		     if (scriptNode == null)
                     {
                       TestLoader.logErrPrint("Could not appendChild Node " +  elname +" under node " + nodename);
                       return BWBaseTest.FAILED;
                     }
            }
         } else {
