...
public class NodeImpl_insertBefore_Node_Node_3 extends BWBaseTest implements Execution
{
    ...
    *
    */
   public NodeImpl_insertBefore_Node_Node_3()
   {
   }
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
	    ...
	    if (n.getNodeName().compareTo(nodename) == 0)
	    {
                ...
                Node iNode = n.insertBefore(newChild, refChild);
		if (iNode == null)
                {
                   TestLoader.logErrPrint("Could not insert Node " + newelname + " before node " + elname);
                   return BWBaseTest.FAILED;
                }
            }
         } else {
