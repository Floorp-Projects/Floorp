 ...
 *  TESTID 
 * 
 *  Tests out the ElementImpl->getTagName() method.
 *
 */
...
public class ElementImpl_getTagName extends BWBaseTest implements Execution
{
   ...
   public boolean execute(Object tobj)
   {
      ...
      if (d != null)
      {
		...
		if (str == null) {
                  TestLoader.logErrPrint("Element 'getTagName() FAILED... ");
                  return BWBaseTest.FAILED;
                } else 
