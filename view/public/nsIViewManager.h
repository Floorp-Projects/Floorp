...
public:
  ...
  /**
   * Set a clip region for a view.
   * The view manager generates the appropriate dirty regions.
   * @param aView view to set clipping for
   * @param aRegion
   *     if non-null, then we will clip everything painted in this view and its children
   *     to the region. The child views need not be within the bounds of this view, but the
   ...
   */
  NS_IMETHOD  SetViewClipRegion(nsIView *aView, nsIRegion *aRegion) = 0;
